...
<head>
  ...
  <title>kedro.io.data_catalog &mdash; Kedro 0.17.7 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <h1>Source code for kedro.io.data_catalog</h1><div class="highlight"><pre>
<span></span><span class="sd">&quot;&quot;&quot;``DataCatalog`` stores instances of ``AbstractDataSet`` implementations to</span>
<span class="sd">provide ``load`` and ``save`` capabilities from anywhere in the program. To</span>
<span class="sd">use a ``DataCatalog``, you need to instantiate it with a dictionary of data</span>
<span class="sd">sets. Then it will act as a single point of reference for your calls,</span>
<span class="sd">relaying load and save functions to the underlying data sets.</span>
<span class="sd">&quot;&quot;&quot;</span>
...
<span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">Callable</span><span class="p">,</span> <span class="n">Dict</span><span class="p">,</span> <span class="n">Iterable</span><span class="p">,</span> <span class="n">List</span><span class="p">,</span> <span class="n">Optional</span><span class="p">,</span> <span class="n">Set</span><span class="p">,</span> <span class="n">Type</span><span class="p">,</span> <span class="n">Union</span>

<span class="kn">from</span> <span class="nn">kedro.io.core</span> <span class="kn">import</span> <span class="p">(</span>
    <span class="n">AbstractDataSet</span><span class="p">,</span>
    <span class="n">AbstractVersionedDataSet</span><span class="p">,</span>
    <span class="n">DataSetAlreadyExistsError</span><span class="p">,</span>
    <span class="n">DataSetError</span><span class="p">,</span>
    <span class="n">DataSetNotFoundError</span><span class="p">,</span>
    <span class="n">Version</span><span class="p">,</span>
    <span class="n">generate_timestamp</span><span class="p">,</span>
<span class="p">)</span>
<span class="kn">from</span> <span class="nn">kedro.io.memory_data_set</span> <span class="kn">import</span> <span class="n">MemoryDataSet</span>
<span class="kn">from</span> <span class="nn">kedro.io.transformers</span> <span class="kn">import</span> <span class="n">AbstractTransformer</span>
<span class="kn">from</span> <span class="nn">kedro.versioning</span> <span class="kn">import</span> <span class="n">Journal</span>

<span class="n">CATALOG_KEY</span> <span class="o">=</span> <span class="s2">&quot;catalog&quot;</span>
<span class="n">CREDENTIALS_KEY</span> <span class="o">=</span> <span class="s2">&quot;credentials&quot;</span>
<span class="n">WORDS_REGEX_PATTERN</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;\W+&quot;</span><span class="p">)</span>


<span class="k">def</span> <span class="nf">_get_credentials</span><span class="p">(</span>
    <span class="n">credentials_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">credentials</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]</span>
<span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
    <span class="sd">&quot;&quot;&quot;Return a set of credentials from the provided credentials dict.</span>

<span class="sd">    Args:</span>
<span class="sd">        credentials_name: Credentials name.</span>
<span class="sd">        credentials: A dictionary with all credentials.</span>

<span class="sd">    Returns:</span>
<span class="sd">        The set of requested credentials.</span>

<span class="sd">    Raises:</span>
<span class="sd">        KeyError: When a data set with the given name has not yet been</span>
<span class="sd">            registered.</span>

<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">try</span><span class="p">:</span>
        <span class="k">return</span> <span class="n">credentials</span><span class="p">[</span><span class="n">credentials_name</span><span class="p">]</span>
    <span class="k">except</span> <span class="ne">KeyError</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
        <span class="k">raise</span> <span class="ne">KeyError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;Unable to find credentials &#39;</span><span class="si">{</span><span class="n">credentials_name</span><span class="si">}</span><span class="s2">&#39;: check your data &quot;</span>
            <span class="s2">&quot;catalog and credentials configuration. See &quot;</span>
            <span class="s2">&quot;https://kedro.readthedocs.io/en/stable/kedro.io.DataCatalog.html &quot;</span>
            <span class="s2">&quot;for an example.&quot;</span>
        <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>


<span class="k">def</span> <span class="nf">_resolve_credentials</span><span class="p">(</span>
    <span class="n">config</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">],</span> <span class="n">credentials</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]</span>
<span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
    <span class="sd">&quot;&quot;&quot;Return the dataset configuration where credentials are resolved using</span>
<span class="sd">    credentials dictionary provided.</span>

<span class="sd">    Args:</span>
<span class="sd">        config: Original dataset config, which may contain unresolved credentials.</span>
<span class="sd">        credentials: A dictionary with all credentials.</span>

<span class="sd">    Returns:</span>
<span class="sd">        The dataset config, where all the credentials are successfully resolved.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">_map_value</span><span class="p">(</span><span class="n">key</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">value</span><span class="p">:</span> <span class="n">Any</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Any</span><span class="p">:</span>
        <span class="k">if</span> <span class="n">key</span> <span class="o">==</span> <span class="n">CREDENTIALS_KEY</span> <span class="ow">and</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">value</span><span class="p">,</span> <span class="nb">str</span><span class="p">):</span>
            <span class="k">return</span> <span class="n">_get_credentials</span><span class="p">(</span><span class="n">value</span><span class="p">,</span> <span class="n">credentials</span><span class="p">)</span>
        <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">value</span><span class="p">,</span> <span class="nb">dict</span><span class="p">):</span>
            <span class="k">return</span> <span class="p">{</span><span class="n">k</span><span class="p">:</span> <span class="n">_map_value</span><span class="p">(</span><span class="n">k</span><span class="p">,</span> <span class="n">v</span><span class="p">)</span> <span class="k">for</span> <span class="n">k</span><span class="p">,</span> <span class="n">v</span> <span class="ow">in</span> <span class="n">value</span><span class="o">.</span><span class="n">items</span><span class="p">()}</span>
        <span class="k">return</span> <span class="n">value</span>

    <span class="k">return</span> <span class="p">{</span><span class="n">k</span><span class="p">:</span> <span class="n">_map_value</span><span class="p">(</span><span class="n">k</span><span class="p">,</span> <span class="n">v</span><span class="p">)</span> <span class="k">for</span> <span class="n">k</span><span class="p">,</span> <span class="n">v</span> <span class="ow">in</span> <span class="n">config</span><span class="o">.</span><span class="n">items</span><span class="p">()}</span>


<span class="k">def</span> <span class="nf">_sub_nonword_chars</span><span class="p">(</span><span class="n">data_set_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Replace non-word characters in data set names since Kedro 0.16.2.</span>

<span class="sd">    Args:</span>
<span class="sd">        data_set_name: The data set name registered in the data catalog.</span>

<span class="sd">    Returns:</span>
<span class="sd">        The name used in `DataCatalog.datasets`.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">return</span> <span class="n">re</span><span class="o">.</span><span class="n">sub</span><span class="p">(</span><span class="n">WORDS_REGEX_PATTERN</span><span class="p">,</span> <span class="s2">&quot;__&quot;</span><span class="p">,</span> <span class="n">data_set_name</span><span class="p">)</span>


<span class="k">class</span> <span class="nc">_FrozenDatasets</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Helper class to access underlying loaded datasets&quot;&quot;&quot;</span>

    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="o">*</span><span class="n">datasets_collections</span><span class="p">:</span> <span class="n">Union</span><span class="p">[</span><span class="s2">&quot;_FrozenDatasets&quot;</span><span class="p">,</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">AbstractDataSet</span><span class="p">]],</span>
    <span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Return a _FrozenDatasets instance from some datasets collections.</span>
<span class="sd">        Each collection could either be another _FrozenDatasets or a dictionary.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">for</span> <span class="n">collection</span> <span class="ow">in</span> <span class="n">datasets_collections</span><span class="p">:</span>
            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">collection</span><span class="p">,</span> <span class="n">_FrozenDatasets</span><span class="p">):</span>
                <span class="bp">self</span><span class="o">.</span><span class="vm">__dict__</span><span class="o">.</span><span class="n">update</span><span class="p">(</span><span class="n">collection</span><span class="o">.</span><span class="vm">__dict__</span><span class="p">)</span>
            <span class="k">else</span><span class="p">:</span>
                <span class="c1"># Non-word characters in dataset names are replaced with `__`</span>
                <span class="c1"># for easy access to transcoded/prefixed datasets.</span>
                <span class="bp">self</span><span class="o">.</span><span class="vm">__dict__</span><span class="o">.</span><span class="n">update</span><span class="p">(</span>
                    <span class="p">{</span>
                        <span class="n">_sub_nonword_chars</span><span class="p">(</span><span class="n">dataset_name</span><span class="p">):</span> <span class="n">dataset</span>
                        <span class="k">for</span> <span class="n">dataset_name</span><span class="p">,</span> <span class="n">dataset</span> <span class="ow">in</span> <span class="n">collection</span><span class="o">.</span><span class="n">items</span><span class="p">()</span>
                    <span class="p">}</span>
                <span class="p">)</span>

    <span class="c1"># Don&#39;t allow users to add/change attributes on the fly</span>
    <span class="k">def</span> <span class="fm">__setattr__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">key</span><span class="p">,</span> <span class="n">value</span><span class="p">):</span>
        <span class="n">msg</span> <span class="o">=</span> <span class="s2">&quot;Operation not allowed! &quot;</span>
        <span class="k">if</span> <span class="n">key</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="vm">__dict__</span><span class="p">:</span>
            <span class="n">msg</span> <span class="o">+=</span> <span class="s2">&quot;Please change datasets through configuration.&quot;</span>
        <span class="k">else</span><span class="p">:</span>
            <span class="n">msg</span> <span class="o">+=</span> <span class="s2">&quot;Please use DataCatalog.add() instead.&quot;</span>
        <span class="k">raise</span> <span class="ne">AttributeError</span><span class="p">(</span><span class="n">msg</span><span class="p">)</span>


<div class="viewcode-block" id="DataCatalog"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog">[docs]</a><span class="k">class</span> <span class="nc">DataCatalog</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;``DataCatalog`` stores instances of ``AbstractDataSet`` implementations</span>
<span class="sd">    to provide ``load`` and ``save`` capabilities from anywhere in the</span>
<span class="sd">    program. To use a ``DataCatalog``, you need to instantiate it with</span>
<span class="sd">    a dictionary of data sets. Then it will act as a single point of reference</span>
<span class="sd">    for your calls, relaying load and save functions</span>
<span class="sd">    to the underlying data sets.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="c1"># pylint: disable=too-many-arguments</span>
<div class="viewcode-block" id="DataCatalog.__init__"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.__init__">[docs]</a>    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="n">data_sets</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">AbstractDataSet</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">feed_dict</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">transformers</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">List</span><span class="p">[</span><span class="n">AbstractTransformer</span><span class="p">]]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">default_transformers</span><span class="p">:</span> <span class="n">List</span><span class="p">[</span><span class="n">AbstractTransformer</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">journal</span><span class="p">:</span> <span class="n">Journal</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">layers</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Set</span><span class="p">[</span><span class="nb">str</span><span class="p">]]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;``DataCatalog`` stores instances of ``AbstractDataSet``</span>
<span class="sd">        implementations to provide ``load`` and ``save`` capabilities from</span>
<span class="sd">        anywhere in the program. To use a ``DataCatalog``, you need to</span>
<span class="sd">        instantiate it with a dictionary of data sets. Then it will act as a</span>
<span class="sd">        single point of reference for your calls, relaying load and save</span>
<span class="sd">        functions to the underlying data sets.</span>

<span class="sd">        Args:</span>
<span class="sd">            data_sets: A dictionary of data set names and data set instances.</span>
<span class="sd">            feed_dict: A feed dict with data to be added in memory.</span>
<span class="sd">            transformers: A dictionary of lists of transformers to be applied</span>
<span class="sd">                to the data sets.</span>
<span class="sd">            default_transformers: A list of transformers to be applied to any</span>
<span class="sd">                new data sets.</span>
<span class="sd">            journal: Instance of Journal.</span>
<span class="sd">            layers: A dictionary of data set layers. It maps a layer name</span>
<span class="sd">                to a set of data set names, according to the</span>
<span class="sd">                data engineering convention. For more details, see</span>
<span class="sd">                https://kedro.readthedocs.io/en/stable/12_faq/01_faq.html#what-is-data-engineering-convention</span>
<span class="sd">        Raises:</span>
<span class="sd">            DataSetNotFoundError: When transformers are passed for a non</span>
<span class="sd">                existent data set.</span>

<span class="sd">        Example:</span>
<span class="sd">        ::</span>

<span class="sd">            &gt;&gt;&gt; from kedro.extras.datasets.pandas import CSVDataSet</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; cars = CSVDataSet(filepath=&quot;cars.csv&quot;,</span>
<span class="sd">            &gt;&gt;&gt;                   load_args=None,</span>
<span class="sd">            &gt;&gt;&gt;                   save_args={&quot;index&quot;: False})</span>
<span class="sd">            &gt;&gt;&gt; io = DataCatalog(data_sets={&#39;cars&#39;: cars})</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span> <span class="o">=</span> <span class="nb">dict</span><span class="p">(</span><span class="n">data_sets</span> <span class="ow">or</span> <span class="p">{})</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">datasets</span> <span class="o">=</span> <span class="n">_FrozenDatasets</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">layers</span> <span class="o">=</span> <span class="n">layers</span>

        <span class="k">if</span> <span class="n">transformers</span> <span class="ow">or</span> <span class="n">default_transformers</span><span class="p">:</span>
            <span class="n">warnings</span><span class="o">.</span><span class="n">warn</span><span class="p">(</span>
                <span class="s2">&quot;The transformer API will be deprecated in Kedro 0.18.0.&quot;</span>
                <span class="s2">&quot;Please use Dataset Hooks to customise the load and save methods.&quot;</span>
            ...
            <span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span> <span class="o">=</span> <span class="p">{</span><span class="n">k</span><span class="p">:</span> <span class="nb">list</span><span class="p">(</span><span class="n">v</span><span class="p">)</span> <span class="k">for</span> <span class="n">k</span><span class="p">,</span> <span class="n">v</span> <span class="ow">in</span> <span class="p">(</span><span class="n">transformers</span> <span class="ow">or</span> <span class="p">{})</span><span class="o">.</span><span class="n">items</span><span class="p">()}</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_default_transformers</span> <span class="o">=</span> <span class="nb">list</span><span class="p">(</span><span class="n">default_transformers</span> <span class="ow">or</span> <span class="p">[])</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_check_and_normalize_transformers</span><span class="p">()</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_journal</span> <span class="o">=</span> <span class="n">journal</span>
        <span class="c1"># import the feed dict</span>
        <span class="k">if</span> <span class="n">feed_dict</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">add_feed_dict</span><span class="p">(</span><span class="n">feed_dict</span><span class="p">)</span></div>
    ...
    <span class="k">def</span> <span class="nf">_check_and_normalize_transformers</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="n">data_sets</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="o">.</span><span class="n">keys</span><span class="p">()</span>
        <span class="n">transformers</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="o">.</span><span class="n">keys</span><span class="p">()</span>
        <span class="n">excess_transformers</span> <span class="o">=</span> <span class="n">transformers</span> <span class="o">-</span> <span class="n">data_sets</span>
        <span class="n">missing_transformers</span> <span class="o">=</span> <span class="n">data_sets</span> <span class="o">-</span> <span class="n">transformers</span>

        <span class="k">if</span> <span class="n">excess_transformers</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetNotFoundError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Unexpected transformers for missing data_sets </span><span class="si">{</span><span class="s1">&#39;, &#39;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">excess_transformers</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="p">)</span>

        <span class="k">for</span> <span class="n">data_set_name</span> <span class="ow">in</span> <span class="n">missing_transformers</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_default_transformers</span><span class="p">)</span>

    <span class="c1"># pylint: disable=too-many-arguments</span>
<div class="viewcode-block" id="DataCatalog.from_config"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.from_config">[docs]</a>    <span class="nd">@classmethod</span>
    <span class="k">def</span> <span class="nf">from_config</span><span class="p">(</span>
        ...
        <span class="n">catalog</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]]],</span>
        <span class="n">credentials</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">load_versions</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        ...
        <span class="n">journal</span><span class="p">:</span> <span class="n">Journal</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="s2">&quot;DataCatalog&quot;</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Create a ``DataCatalog`` instance from configuration. This is a</span>
<span class="sd">        factory method used to provide developers with a way to instantiate</span>
<span class="sd">        ``DataCatalog`` with configuration parsed from configuration files.</span>

<span class="sd">        Args:</span>
<span class="sd">            catalog: A dictionary whose keys are the data set names and</span>
<span class="sd">                the values are dictionaries with the constructor arguments</span>
<span class="sd">                for classes implementing ``AbstractDataSet``. The data set</span>
<span class="sd">                class to be loaded is specified with the key ``type`` and their</span>
<span class="sd">                fully qualified class name. All ``kedro.io`` data set can be</span>
<span class="sd">                specified by their class name only, i.e. their module name</span>
<span class="sd">                can be omitted.</span>
<span class="sd">            credentials: A dictionary containing credentials for different</span>
<span class="sd">                data sets. Use the ``credentials`` key in a ``AbstractDataSet``</span>
<span class="sd">                to refer to the appropriate credentials as shown in the example</span>
<span class="sd">                below.</span>
<span class="sd">            load_versions: A mapping between dataset names and versions</span>
<span class="sd">                to load. Has no effect on data sets without enabled versioning.</span>
<span class="sd">            save_version: Version string to be used for ``save`` operations</span>
<span class="sd">                by all data sets with enabled versioning. It must: a) be a</span>
<span class="sd">                case-insensitive string that conforms with operating system</span>
<span class="sd">                filename limitations, b) always return the latest version when</span>
<span class="sd">                sorted in lexicographical order.</span>
<span class="sd">            journal: Instance of Journal.</span>

<span class="sd">        Returns:</span>
<span class="sd">            An instantiated ``DataCatalog`` containing all specified</span>
<span class="sd">            data sets, created and ready to use.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: When the method fails to create any of the data</span>
<span class="sd">                sets from their config.</span>
<span class="sd">            DataSetNotFoundError: When `load_versions` refers to a dataset that doesn&#39;t</span>
<span class="sd">                exist in the catalog.</span>
...
<span class="sd">            &gt;&gt;&gt;         &quot;type&quot;: &quot;pandas.CSVDataSet&quot;,</span>
<span class="sd">            &gt;&gt;&gt;         &quot;filepath&quot;: &quot;cars.csv&quot;,</span>
<span class="sd">            &gt;&gt;&gt;         &quot;save_args&quot;: {</span>
<span class="sd">            &gt;&gt;&gt;             &quot;index&quot;: False</span>
<span class="sd">            &gt;&gt;&gt;         }</span>
<span class="sd">            &gt;&gt;&gt;     },</span>
<span class="sd">            &gt;&gt;&gt;     &quot;boats&quot;: {</span>
<span class="sd">            &gt;&gt;&gt;         &quot;type&quot;: &quot;pandas.CSVDataSet&quot;,</span>
<span class="sd">            &gt;&gt;&gt;         &quot;filepath&quot;: &quot;s3://aws-bucket-name/boats.csv&quot;,</span>
<span class="sd">            &gt;&gt;&gt;         &quot;credentials&quot;: &quot;boats_credentials&quot;</span>
<span class="sd">            &gt;&gt;&gt;         &quot;save_args&quot;: {</span>
<span class="sd">            &gt;&gt;&gt;             &quot;index&quot;: False</span>
<span class="sd">            &gt;&gt;&gt;         }</span>
<span class="sd">            &gt;&gt;&gt;     }</span>
...
<span class="sd">            &gt;&gt;&gt;     &quot;boats_credentials&quot;: {</span>
<span class="sd">            &gt;&gt;&gt;         &quot;client_kwargs&quot;: {</span>
<span class="sd">            &gt;&gt;&gt;             &quot;aws_access_key_id&quot;: &quot;&lt;your key id&gt;&quot;,</span>
<span class="sd">            &gt;&gt;&gt;             &quot;aws_secret_access_key&quot;: &quot;&lt;your secret&gt;&quot;</span>
<span class="sd">            &gt;&gt;&gt;         }</span>
<span class="sd">            &gt;&gt;&gt;      }</span>
<span class="sd">            &gt;&gt;&gt; }</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; catalog = DataCatalog.from_config(config, credentials)</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; df = catalog.load(&quot;cars&quot;)</span>
<span class="sd">            &gt;&gt;&gt; catalog.save(&quot;boats&quot;, df)</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">data_sets</span> <span class="o">=</span> <span class="p">{}</span>
        <span class="n">catalog</span> <span class="o">=</span> <span class="n">copy</span><span class="o">.</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">catalog</span><span class="p">)</span> <span class="ow">or</span> <span class="p">{}</span>
        <span class="n">credentials</span> <span class="o">=</span> <span class="n">copy</span><span class="o">.</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">credentials</span><span class="p">)</span> <span class="ow">or</span> <span class="p">{}</span>
        <span class="n">run_id</span> <span class="o">=</span> <span class="n">journal</span><span class="o">.</span><span class="n">run_id</span> <span class="k">if</span> <span class="n">journal</span> <span class="k">else</span> <span class="kc">None</span>
        <span class="n">save_version</span> <span class="o">=</span> <span class="n">save_version</span> <span class="ow">or</span> <span class="n">run_id</span> <span class="ow">or</span> <span class="n">generate_timestamp</span><span class="p">()</span>
        <span class="n">load_versions</span> <span class="o">=</span> <span class="n">copy</span><span class="o">.</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">load_versions</span><span class="p">)</span> <span class="ow">or</span> <span class="p">{}</span>

        <span class="n">missing_keys</span> <span class="o">=</span> <span class="n">load_versions</span><span class="o">.</span><span class="n">keys</span><span class="p">()</span> <span class="o">-</span> <span class="n">catalog</span><span class="o">.</span><span class="n">keys</span><span class="p">()</span>
        <span class="k">if</span> <span class="n">missing_keys</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetNotFoundError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;`load_versions` keys [</span><span class="si">{</span><span class="s1">&#39;, &#39;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="nb">sorted</span><span class="p">(</span><span class="n">missing_keys</span><span class="p">))</span><span class="si">}</span><span class="s2">] &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;are not found in the catalog.&quot;</span>
            <span class="p">)</span>

        <span class="n">layers</span> <span class="o">=</span> <span class="n">defaultdict</span><span class="p">(</span><span class="nb">set</span><span class="p">)</span>  <span class="c1"># type: Dict[str, Set[str]]</span>
        <span class="k">for</span> <span class="n">ds_name</span><span class="p">,</span> <span class="n">ds_config</span> <span class="ow">in</span> <span class="n">catalog</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
            <span class="n">ds_layer</span> <span class="o">=</span> <span class="n">ds_config</span><span class="o">.</span><span class="n">pop</span><span class="p">(</span><span class="s2">&quot;layer&quot;</span><span class="p">,</span> <span class="kc">None</span><span class="p">)</span>
            <span class="k">if</span> <span class="n">ds_layer</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">:</span>
                <span class="n">layers</span><span class="p">[</span><span class="n">ds_layer</span><span class="p">]</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="n">ds_name</span><span class="p">)</span>

            <span class="n">ds_config</span> <span class="o">=</span> <span class="n">_resolve_credentials</span><span class="p">(</span><span class="n">ds_config</span><span class="p">,</span> <span class="n">credentials</span><span class="p">)</span>
            <span class="n">data_sets</span><span class="p">[</span><span class="n">ds_name</span><span class="p">]</span> <span class="o">=</span> <span class="n">AbstractDataSet</span><span class="o">.</span><span class="n">from_config</span><span class="p">(</span>
                <span class="n">ds_name</span><span class="p">,</span> <span class="n">ds_config</span><span class="p">,</span> <span class="n">load_versions</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="n">ds_name</span><span class="p">),</span> <span class="n">save_version</span>
            <span class="p">)</span>

        <span class="n">dataset_layers</span> <span class="o">=</span> <span class="n">layers</span> <span class="ow">or</span> <span class="kc">None</span>
        <span class="k">return</span> <span class="bp">cls</span><span class="p">(</span><span class="n">data_sets</span><span class="o">=</span><span class="n">data_sets</span><span class="p">,</span> <span class="n">journal</span><span class="o">=</span><span class="n">journal</span><span class="p">,</span> <span class="n">layers</span><span class="o">=</span><span class="n">dataset_layers</span><span class="p">)</span></div>

    <span class="k">def</span> <span class="nf">_get_dataset</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span> <span class="n">data_set_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">version</span><span class="p">:</span> <span class="n">Version</span> <span class="o">=</span> <span class="kc">None</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">AbstractDataSet</span><span class="p">:</span>
        <span class="k">if</span> <span class="n">data_set_name</span> <span class="ow">not</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">:</span>
            <span class="n">error_msg</span> <span class="o">=</span> <span class="sa">f</span><span class="s2">&quot;DataSet &#39;</span><span class="si">{</span><span class="n">data_set_name</span><span class="si">}</span><span class="s2">&#39; not found in the catalog&quot;</span>

            <span class="n">matches</span> <span class="o">=</span> <span class="n">difflib</span><span class="o">.</span><span class="n">get_close_matches</span><span class="p">(</span><span class="n">data_set_name</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="o">.</span><span class="n">keys</span><span class="p">())</span>
            <span class="k">if</span> <span class="n">matches</span><span class="p">:</span>
                <span class="n">suggestions</span> <span class="o">=</span> <span class="s2">&quot;, &quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">matches</span><span class="p">)</span>  <span class="c1"># type: ignore</span>
                <span class="n">error_msg</span> <span class="o">+=</span> <span class="sa">f</span><span class="s2">&quot; - did you mean one of these instead: </span><span class="si">{</span><span class="n">suggestions</span><span class="si">}</span><span class="s2">&quot;</span>

            <span class="k">raise</span> <span class="n">DataSetNotFoundError</span><span class="p">(</span><span class="n">error_msg</span><span class="p">)</span>

        <span class="n">data_set</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]</span>
        <span class="k">if</span> <span class="n">version</span> <span class="ow">and</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">data_set</span><span class="p">,</span> <span class="n">AbstractVersionedDataSet</span><span class="p">):</span>
            <span class="c1"># we only want to return a similar-looking dataset,</span>
            <span class="c1"># not modify the one stored in the current catalog</span>
            <span class="n">data_set</span> <span class="o">=</span> <span class="n">data_set</span><span class="o">.</span><span class="n">_copy</span><span class="p">(</span>  <span class="c1"># pylint: disable=protected-access</span>
                <span class="n">_version</span><span class="o">=</span><span class="n">version</span>
            <span class="p">)</span>

        <span class="k">return</span> <span class="n">data_set</span>

    <span class="k">def</span> <span class="nf">_get_transformed_dataset_function</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span> <span class="n">data_set_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">operation</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">data_set</span><span class="p">:</span> <span class="n">AbstractDataSet</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Callable</span><span class="p">:</span>
        <span class="n">func</span> <span class="o">=</span> <span class="nb">getattr</span><span class="p">(</span><span class="n">data_set</span><span class="p">,</span> <span class="n">operation</span><span class="p">)</span>
        <span class="k">for</span> <span class="n">transformer</span> <span class="ow">in</span> <span class="nb">reversed</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]):</span>
            <span class="n">func</span> <span class="o">=</span> <span class="n">partial</span><span class="p">(</span><span class="nb">getattr</span><span class="p">(</span><span class="n">transformer</span><span class="p">,</span> <span class="n">operation</span><span class="p">),</span> <span class="n">data_set_name</span><span class="p">,</span> <span class="n">func</span><span class="p">)</span>
        <span class="k">return</span> <span class="n">func</span>

<div class="viewcode-block" id="DataCatalog.load"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.load">[docs]</a>    <span class="k">def</span> <span class="nf">load</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">version</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="kc">None</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Any</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Loads a registered data set.</span>

<span class="sd">        Args:</span>
<span class="sd">            name: A data set to be loaded.</span>
<span class="sd">            version: Optional argument for concrete data version to be loaded.</span>
<span class="sd">                Works only with versioned datasets.</span>

<span class="sd">        Returns:</span>
<span class="sd">            The loaded data as configured.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetNotFoundError: When a data set with the given name</span>
<span class="sd">                has not yet been registered.</span>

<span class="sd">        Example:</span>
<span class="sd">        ::</span>

<span class="sd">            &gt;&gt;&gt; from kedro.io import DataCatalog</span>
<span class="sd">            &gt;&gt;&gt; from kedro.extras.datasets.pandas import CSVDataSet</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; cars = CSVDataSet(filepath=&quot;cars.csv&quot;,</span>
<span class="sd">            &gt;&gt;&gt;                   load_args=None,</span>
...
<span class="sd">            &gt;&gt;&gt; io = DataCatalog(data_sets={&#39;cars&#39;: cars})</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; df = io.load(&quot;cars&quot;)</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">load_version</span> <span class="o">=</span> <span class="n">Version</span><span class="p">(</span><span class="n">version</span><span class="p">,</span> <span class="kc">None</span><span class="p">)</span> <span class="k">if</span> <span class="n">version</span> <span class="k">else</span> <span class="kc">None</span>
        <span class="n">dataset</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_dataset</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="n">version</span><span class="o">=</span><span class="n">load_version</span><span class="p">)</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">info</span><span class="p">(</span>
            <span class="s2">&quot;Loading data from `</span><span class="si">%s</span><span class="s2">` (</span><span class="si">%s</span><span class="s2">)...&quot;</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="nb">type</span><span class="p">(</span><span class="n">dataset</span><span class="p">)</span><span class="o">.</span><span class="vm">__name__</span>
        <span class="p">)</span>

        <span class="n">func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_transformed_dataset_function</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="s2">&quot;load&quot;</span><span class="p">,</span> <span class="n">dataset</span><span class="p">)</span>
        ...
        <span class="n">version</span> <span class="o">=</span> <span class="p">(</span>
            <span class="n">dataset</span><span class="o">.</span><span class="n">resolve_load_version</span><span class="p">()</span>
            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">dataset</span><span class="p">,</span> <span class="n">AbstractVersionedDataSet</span><span class="p">)</span>
            <span class="k">else</span> <span class="kc">None</span>
        <span class="p">)</span>

        <span class="c1"># Log only if versioning is enabled for the data set</span>
        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_journal</span> <span class="ow">and</span> <span class="n">version</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_journal</span><span class="o">.</span><span class="n">log_catalog</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="s2">&quot;load&quot;</span><span class="p">,</span> <span class="n">version</span><span class="p">)</span>
        <span class="k">return</span> <span class="n">result</span></div>

<div class="viewcode-block" id="DataCatalog.save"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.save">[docs]</a>    <span class="k">def</span> <span class="nf">save</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">data</span><span class="p">:</span> <span class="n">Any</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Save data to a registered data set.</span>

<span class="sd">        Args:</span>
<span class="sd">            name: A data set to be saved to.</span>
<span class="sd">            data: A data object to be saved as configured in the registered</span>
...
<span class="sd">            &gt;&gt;&gt;                    &#39;col2&#39;: [4, 5],</span>
<span class="sd">            &gt;&gt;&gt;                    &#39;col3&#39;: [5, 6]})</span>
<span class="sd">            &gt;&gt;&gt; io.save(&quot;cars&quot;, df)</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">dataset</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_dataset</span><span class="p">(</span><span class="n">name</span><span class="p">)</span>

        <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">info</span><span class="p">(</span><span class="s2">&quot;Saving data to `</span><span class="si">%s</span><span class="s2">` (</span><span class="si">%s</span><span class="s2">)...&quot;</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="nb">type</span><span class="p">(</span><span class="n">dataset</span><span class="p">)</span><span class="o">.</span><span class="vm">__name__</span><span class="p">)</span>

        <span class="n">func</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_transformed_dataset_function</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="s2">&quot;save&quot;</span><span class="p">,</span> <span class="n">dataset</span><span class="p">)</span>
        <span class="n">func</span><span class="p">(</span><span class="n">data</span><span class="p">)</span>

        <span class="n">version</span> <span class="o">=</span> <span class="p">(</span>
            <span class="n">dataset</span><span class="o">.</span><span class="n">resolve_save_version</span><span class="p">()</span>
            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">dataset</span><span class="p">,</span> <span class="n">AbstractVersionedDataSet</span><span class="p">)</span>
            <span class="k">else</span> <span class="kc">None</span>
        <span class="p">)</span>
        ...
        <span class="c1"># Log only if versioning is enabled for the data set</span>
        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_journal</span> <span class="ow">and</span> <span class="n">version</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_journal</span><span class="o">.</span><span class="n">log_catalog</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="s2">&quot;save&quot;</span><span class="p">,</span> <span class="n">version</span><span class="p">)</span></div>

<div class="viewcode-block" id="DataCatalog.exists"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.exists">[docs]</a>    <span class="k">def</span> <span class="nf">exists</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Checks whether registered data set exists by calling its `exists()`</span>
<span class="sd">        method. Raises a warning and returns False if `exists()` is not</span>
<span class="sd">        implemented.</span>

<span class="sd">        Args:</span>
<span class="sd">            name: A data set to be checked.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Whether the data set output exists.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="n">dataset</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_dataset</span><span class="p">(</span><span class="n">name</span><span class="p">)</span>
        <span class="k">except</span> <span class="n">DataSetNotFoundError</span><span class="p">:</span>
            <span class="k">return</span> <span class="kc">False</span>
        <span class="k">return</span> <span class="n">dataset</span><span class="o">.</span><span class="n">exists</span><span class="p">()</span></div>

<div class="viewcode-block" id="DataCatalog.release"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.release">[docs]</a>    <span class="k">def</span> <span class="nf">release</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Release any cached data associated with a data set</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">dataset</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_dataset</span><span class="p">(</span><span class="n">name</span><span class="p">)</span>
        <span class="n">dataset</span><span class="o">.</span><span class="n">release</span><span class="p">()</span></div>

<div class="viewcode-block" id="DataCatalog.add"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.add">[docs]</a>    <span class="k">def</span> <span class="nf">add</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span> <span class="n">data_set_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">data_set</span><span class="p">:</span> <span class="n">AbstractDataSet</span><span class="p">,</span> <span class="n">replace</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Adds a new ``AbstractDataSet`` object to the ``DataCatalog``.</span>

<span class="sd">        Args:</span>
<span class="sd">            data_set_name: A unique data set name which has not been</span>
<span class="sd">                registered yet.</span>
<span class="sd">            data_set: A data set object to be associated with the given data</span>
<span class="sd">                set name.</span>
<span class="sd">            replace: Specifies whether to replace an existing ``DataSet``</span>
<span class="sd">                with the same name is allowed.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetAlreadyExistsError: When a data set with the same name</span>
<span class="sd">                has already been registered.</span>
...
<span class="sd">            &gt;&gt;&gt; from kedro.extras.datasets.pandas import CSVDataSet</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; io = DataCatalog(data_sets={</span>
<span class="sd">            &gt;&gt;&gt;                   &#39;cars&#39;: CSVDataSet(filepath=&quot;cars.csv&quot;)</span>
<span class="sd">            &gt;&gt;&gt;                  })</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; io.add(&quot;boats&quot;, CSVDataSet(filepath=&quot;boats.csv&quot;))</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">if</span> <span class="n">data_set_name</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">:</span>
            <span class="k">if</span> <span class="n">replace</span><span class="p">:</span>
                <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">warning</span><span class="p">(</span><span class="s2">&quot;Replacing DataSet &#39;</span><span class="si">%s</span><span class="s2">&#39;&quot;</span><span class="p">,</span> <span class="n">data_set_name</span><span class="p">)</span>
            <span class="k">else</span><span class="p">:</span>
                <span class="k">raise</span> <span class="n">DataSetAlreadyExistsError</span><span class="p">(</span>
                    <span class="sa">f</span><span class="s2">&quot;DataSet &#39;</span><span class="si">{</span><span class="n">data_set_name</span><span class="si">}</span><span class="s2">&#39; has already been registered&quot;</span>
                <span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]</span> <span class="o">=</span> <span class="n">data_set</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]</span> <span class="o">=</span> <span class="nb">list</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_default_transformers</span><span class="p">)</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">datasets</span> <span class="o">=</span> <span class="n">_FrozenDatasets</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">datasets</span><span class="p">,</span> <span class="p">{</span><span class="n">data_set_name</span><span class="p">:</span> <span class="n">data_set</span><span class="p">})</span></div>

<div class="viewcode-block" id="DataCatalog.add_all"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.add_all">[docs]</a>    <span class="k">def</span> <span class="nf">add_all</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span> <span class="n">data_sets</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">AbstractDataSet</span><span class="p">],</span> <span class="n">replace</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Adds a group of new data sets to the ``DataCatalog``.</span>

<span class="sd">        Args:</span>
<span class="sd">            data_sets: A dictionary of ``DataSet`` names and data set</span>
...
<span class="sd">            &gt;&gt;&gt; from kedro.extras.datasets.pandas import CSVDataSet, ParquetDataSet</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; io = DataCatalog(data_sets={</span>
<span class="sd">            &gt;&gt;&gt;                   &quot;cars&quot;: CSVDataSet(filepath=&quot;cars.csv&quot;)</span>
<span class="sd">            &gt;&gt;&gt;                  })</span>
<span class="sd">            &gt;&gt;&gt; additional = {</span>
<span class="sd">            &gt;&gt;&gt;     &quot;planes&quot;: ParquetDataSet(&quot;planes.parq&quot;),</span>
<span class="sd">            &gt;&gt;&gt;     &quot;boats&quot;: CSVDataSet(filepath=&quot;boats.csv&quot;)</span>
<span class="sd">            &gt;&gt;&gt; }</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; io.add_all(additional)</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; assert io.list() == [&quot;cars&quot;, &quot;planes&quot;, &quot;boats&quot;]</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">for</span> <span class="n">name</span><span class="p">,</span> <span class="n">data_set</span> <span class="ow">in</span> <span class="n">data_sets</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="n">name</span><span class="p">,</span> <span class="n">data_set</span><span class="p">,</span> <span class="n">replace</span><span class="p">)</span></div>

<div class="viewcode-block" id="DataCatalog.add_feed_dict"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.add_feed_dict">[docs]</a>    <span class="k">def</span> <span class="nf">add_feed_dict</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">feed_dict</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">],</span> <span class="n">replace</span><span class="p">:</span> <span class="nb">bool</span> <span class="o">=</span> <span class="kc">False</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Adds instances of ``MemoryDataSet``, containing the data provided</span>
<span class="sd">        through feed_dict.</span>
...
<span class="sd">            &gt;&gt;&gt;                    &#39;col3&#39;: [5, 6]})</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; io = DataCatalog()</span>
<span class="sd">            &gt;&gt;&gt; io.add_feed_dict({</span>
<span class="sd">            &gt;&gt;&gt;     &#39;data&#39;: df</span>
<span class="sd">            &gt;&gt;&gt; }, replace=True)</span>
<span class="sd">            &gt;&gt;&gt;</span>
<span class="sd">            &gt;&gt;&gt; assert io.load(&quot;data&quot;).equals(df)</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">for</span> <span class="n">data_set_name</span> <span class="ow">in</span> <span class="n">feed_dict</span><span class="p">:</span>
            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">feed_dict</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">],</span> <span class="n">AbstractDataSet</span><span class="p">):</span>
                <span class="n">data_set</span> <span class="o">=</span> <span class="n">feed_dict</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]</span>
            <span class="k">else</span><span class="p">:</span>
                <span class="n">data_set</span> <span class="o">=</span> <span class="n">MemoryDataSet</span><span class="p">(</span><span class="n">data</span><span class="o">=</span><span class="n">feed_dict</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">])</span>

            <span class="bp">self</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="n">data_set_name</span><span class="p">,</span> <span class="n">data_set</span><span class="p">,</span> <span class="n">replace</span><span class="p">)</span></div>

<div class="viewcode-block" id="DataCatalog.add_transformer"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.add_transformer">[docs]</a>    <span class="k">def</span> <span class="nf">add_transformer</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="n">transformer</span><span class="p">:</span> <span class="n">AbstractTransformer</span><span class="p">,</span>
        <span class="n">data_set_names</span><span class="p">:</span> <span class="n">Union</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Add a ``DataSet`` Transformer to the``DataCatalog``.</span>
<span class="sd">        Transformers can modify the way Data Sets are loaded and saved.</span>

<span class="sd">        Args:</span>
<span class="sd">            transformer: The transformer instance to add.</span>
<span class="sd">            data_set_names: The Data Sets to add the transformer to.</span>
<span class="sd">                Or None to add the transformer to all Data Sets.</span>
<span class="sd">        Raises:</span>
<span class="sd">            DataSetNotFoundError: When a transformer is being added to a non</span>
<span class="sd">                existent data set.</span>
<span class="sd">            TypeError: When transformer isn&#39;t an instance of ``AbstractTransformer``</span>
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">if</span> <span class="ow">not</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">transformer</span><span class="p">,</span> <span class="n">AbstractTransformer</span><span class="p">):</span>
            <span class="k">raise</span> <span class="ne">TypeError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Object of type </span><span class="si">{</span><span class="nb">type</span><span class="p">(</span><span class="n">transformer</span><span class="p">)</span><span class="si">}</span><span class="s2"> is not an instance of AbstractTransformer&quot;</span>
            <span class="p">)</span>
        <span class="k">if</span> <span class="n">data_set_names</span> <span class="ow">is</span> <span class="kc">None</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_default_transformers</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">transformer</span><span class="p">)</span>
            <span class="n">data_set_names</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="o">.</span><span class="n">keys</span><span class="p">()</span>
        <span class="k">elif</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">data_set_names</span><span class="p">,</span> <span class="nb">str</span><span class="p">):</span>
            <span class="n">data_set_names</span> <span class="o">=</span> <span class="p">[</span><span class="n">data_set_names</span><span class="p">]</span>
        <span class="k">for</span> <span class="n">data_set_name</span> <span class="ow">in</span> <span class="n">data_set_names</span><span class="p">:</span>
            <span class="k">if</span> <span class="n">data_set_name</span> <span class="ow">not</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">:</span>
                <span class="k">raise</span> <span class="n">DataSetNotFoundError</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;No data set called </span><span class="si">{</span><span class="n">data_set_name</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="p">[</span><span class="n">data_set_name</span><span class="p">]</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">transformer</span><span class="p">)</span></div>

<div class="viewcode-block" id="DataCatalog.list"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.list">[docs]</a>    <span class="k">def</span> <span class="nf">list</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">regex_search</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">List</span><span class="p">[</span><span class="nb">str</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">        List of all ``DataSet`` names registered in the catalog.</span>
<span class="sd">        This can be filtered by providing an optional regular expression</span>
<span class="sd">        which will only return matching keys.</span>

<span class="sd">        Args:</span>
<span class="sd">            regex_search: An optional regular expression which can be provided</span>
<span class="sd">                to limit the data sets returned by a particular pattern.</span>
<span class="sd">        Returns:</span>
<span class="sd">            A list of ``DataSet`` names available which match the</span>
<span class="sd">            `regex_search` criteria (if provided). All data set names are returned</span>
<span class="sd">            by default.</span>

<span class="sd">        Raises:</span>
<span class="sd">            SyntaxError: When an invalid regex filter is provided.</span>

<span class="sd">        Example:</span>
<span class="sd">        ::</span>

<span class="sd">            &gt;&gt;&gt; io = DataCatalog()</span>
<span class="sd">            &gt;&gt;&gt; # get data sets where the substring &#39;raw&#39; is present</span>
<span class="sd">            &gt;&gt;&gt; raw_data = io.list(regex_search=&#39;raw&#39;)</span>
<span class="sd">            &gt;&gt;&gt; # get data sets which start with &#39;prm&#39; or &#39;feat&#39;</span>
<span class="sd">            &gt;&gt;&gt; feat_eng_data = io.list(regex_search=&#39;^(prm|feat)&#39;)</span>
<span class="sd">            &gt;&gt;&gt; # get data sets which end with &#39;time_series&#39;</span>
<span class="sd">            &gt;&gt;&gt; models = io.list(regex_search=&#39;.+time_series$&#39;)</span>
<span class="sd">        &quot;&quot;&quot;</span>

        <span class="k">if</span> <span class="n">regex_search</span> <span class="ow">is</span> <span class="kc">None</span><span class="p">:</span>
            <span class="k">return</span> <span class="nb">list</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="o">.</span><span class="n">keys</span><span class="p">())</span>

        <span class="k">if</span> <span class="ow">not</span> <span class="n">regex_search</span><span class="o">.</span><span class="n">strip</span><span class="p">():</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">warning</span><span class="p">(</span><span class="s2">&quot;The empty string will not match any data sets&quot;</span><span class="p">)</span>
            <span class="k">return</span> <span class="p">[]</span>

        <span class="k">try</span><span class="p">:</span>
            <span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="n">regex_search</span><span class="p">,</span> <span class="n">flags</span><span class="o">=</span><span class="n">re</span><span class="o">.</span><span class="n">IGNORECASE</span><span class="p">)</span>
        ...
        <span class="k">except</span> <span class="n">re</span><span class="o">.</span><span class="n">error</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="k">raise</span> <span class="ne">SyntaxError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Invalid regular expression provided: `</span><span class="si">{</span><span class="n">regex_search</span><span class="si">}</span><span class="s2">`&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>
        <span class="k">return</span> <span class="p">[</span><span class="n">dset_name</span> <span class="k">for</span> <span class="n">dset_name</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span> <span class="k">if</span> <span class="n">pattern</span><span class="o">.</span><span class="n">search</span><span class="p">(</span><span class="n">dset_name</span><span class="p">)]</span></div>

<div class="viewcode-block" id="DataCatalog.shallow_copy"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.shallow_copy">[docs]</a>    <span class="k">def</span> <span class="nf">shallow_copy</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="s2">&quot;DataCatalog&quot;</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Returns a shallow copy of the current object.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Copy of the current object.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="n">DataCatalog</span><span class="p">(</span>
            <span class="n">data_sets</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">,</span>
            <span class="n">transformers</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="p">,</span>
            <span class="n">default_transformers</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">_default_transformers</span><span class="p">,</span>
            <span class="n">journal</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">_journal</span><span class="p">,</span>
    ...
    <span class="k">def</span> <span class="fm">__eq__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">other</span><span class="p">):</span>
        <span class="k">return</span> <span class="p">(</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">,</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_transformers</span><span class="p">,</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_default_transformers</span><span class="p">,</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_journal</span><span class="p">,</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">layers</span><span class="p">,</span>
        <span class="p">)</span> <span class="o">==</span> <span class="p">(</span>
            <span class="n">other</span><span class="o">.</span><span class="n">_data_sets</span><span class="p">,</span>
            <span class="n">other</span><span class="o">.</span><span class="n">_transformers</span><span class="p">,</span>
            <span class="n">other</span><span class="o">.</span><span class="n">_default_transformers</span><span class="p">,</span>
            <span class="n">other</span><span class="o">.</span><span class="n">_journal</span><span class="p">,</span>
            <span class="n">other</span><span class="o">.</span><span class="n">layers</span><span class="p">,</span>
        <span class="p">)</span>

<div class="viewcode-block" id="DataCatalog.confirm"><a class="viewcode-back" href="../../../kedro.io.DataCatalog.html#kedro.io.DataCatalog.confirm">[docs]</a>    <span class="k">def</span> <span class="nf">confirm</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">name</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Confirm a dataset by its name.</span>

<span class="sd">        Args:</span>
<span class="sd">            name: Name of the dataset.</span>
<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: When the dataset does not have `confirm` method.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">info</span><span class="p">(</span><span class="s2">&quot;Confirming DataSet &#39;</span><span class="si">%s</span><span class="s2">&#39;&quot;</span><span class="p">,</span> <span class="n">name</span><span class="p">)</span>
        <span class="n">data_set</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_dataset</span><span class="p">(</span><span class="n">name</span><span class="p">)</span>

        <span class="k">if</span> <span class="nb">hasattr</span><span class="p">(</span><span class="n">data_set</span><span class="p">,</span> <span class="s2">&quot;confirm&quot;</span><span class="p">):</span>
            <span class="n">data_set</span><span class="o">.</span><span class="n">confirm</span><span class="p">()</span>  <span class="c1"># type: ignore</span>
        <span class="k">else</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;DataSet &#39;</span><span class="si">{</span><span class="n">name</span><span class="si">}</span><span class="s2">&#39; does not have &#39;confirm&#39; method&quot;</span><span class="p">)</span></div></div>
</pre></div>
