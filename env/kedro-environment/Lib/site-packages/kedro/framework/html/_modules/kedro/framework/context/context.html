...
<head>
  ...
  <title>kedro.framework.context.context &mdash; Kedro 0.17.7 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>kedro.framework.context.context</li>
  ...
  <h1>Source code for kedro.framework.context.context</h1><div class="highlight"><pre>
<span></span><span class="sd">&quot;&quot;&quot;This module provides context for Kedro project.&quot;&quot;&quot;</span>

<span class="kn">import</span> <span class="nn">functools</span>
<span class="kn">import</span> <span class="nn">logging</span>
<span class="kn">import</span> <span class="nn">os</span>
<span class="kn">from</span> <span class="nn">copy</span> <span class="kn">import</span> <span class="n">deepcopy</span>
<span class="kn">from</span> <span class="nn">pathlib</span> <span class="kn">import</span> <span class="n">Path</span><span class="p">,</span> <span class="n">PurePosixPath</span><span class="p">,</span> <span class="n">PureWindowsPath</span>
<span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">Dict</span><span class="p">,</span> <span class="n">Iterable</span><span class="p">,</span> <span class="n">Union</span>
<span class="kn">from</span> <span class="nn">urllib.parse</span> <span class="kn">import</span> <span class="n">urlparse</span>
<span class="kn">from</span> <span class="nn">warnings</span> <span class="kn">import</span> <span class="n">warn</span>

<span class="kn">from</span> <span class="nn">kedro.config</span> <span class="kn">import</span> <span class="n">ConfigLoader</span><span class="p">,</span> <span class="n">MissingConfigException</span>
...
<span class="kn">from</span> <span class="nn">kedro.framework.startup</span> <span class="kn">import</span> <span class="n">_get_project_metadata</span>
<span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">DataCatalog</span>
<span class="kn">from</span> <span class="nn">kedro.io.core</span> <span class="kn">import</span> <span class="n">generate_timestamp</span>
<span class="kn">from</span> <span class="nn">kedro.pipeline</span> <span class="kn">import</span> <span class="n">Pipeline</span>
<span class="kn">from</span> <span class="nn">kedro.pipeline.pipeline</span> <span class="kn">import</span> <span class="n">_transcode_split</span>
<span class="kn">from</span> <span class="nn">kedro.runner.runner</span> <span class="kn">import</span> <span class="n">AbstractRunner</span>
...
<span class="k">def</span> <span class="nf">_deprecate</span><span class="p">(</span><span class="n">version</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;Decorator to deprecate a few of the context&#39;s properties.&quot;&quot;&quot;</span>

    <span class="k">def</span> <span class="nf">decorator</span><span class="p">(</span><span class="n">func</span><span class="p">):</span>
        <span class="nd">@functools</span><span class="o">.</span><span class="n">wraps</span><span class="p">(</span><span class="n">func</span><span class="p">)</span>
        <span class="k">def</span> <span class="nf">wrapper</span><span class="p">(</span><span class="o">*</span><span class="n">args</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span><span class="p">):</span>
            <span class="n">property_name</span> <span class="o">=</span> <span class="n">func</span><span class="o">.</span><span class="vm">__name__</span>
            <span class="n">warn</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Accessing </span><span class="si">{</span><span class="n">property_name</span><span class="si">}</span><span class="s2"> via the context will be deprecated in Kedro </span><span class="si">{</span><span class="n">version</span><span class="si">}</span><span class="s2">.&quot;</span><span class="p">,</span>
...
<span class="k">def</span> <span class="nf">_is_relative_path</span><span class="p">(</span><span class="n">path_string</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Checks whether a path string is a relative path.</span>

<span class="sd">    Example:</span>
<span class="sd">    ::</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(&quot;data/01_raw&quot;) == True</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(&quot;logs/info.log&quot;) == True</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(&quot;/tmp/data/01_raw&quot;) == False</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(r&quot;C:\\logs\\info.log&quot;) == False</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(r&quot;\\logs\\&#39;info.log&quot;) == False</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(&quot;c:/logs/info.log&quot;) == False</span>
<span class="sd">        &gt;&gt;&gt; _is_relative_path(&quot;s3://logs/info.log&quot;) == False</span>

<span class="sd">    Args:</span>
<span class="sd">        path_string: The path string to check.</span>
<span class="sd">    Returns:</span>
<span class="sd">        Whether the string is a relative path.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="c1"># os.path.splitdrive does not reliably work on non-Windows systems</span>
    <span class="c1"># breaking the coverage, using PureWindowsPath instead</span>
    <span class="n">is_full_windows_path_with_drive</span> <span class="o">=</span> <span class="nb">bool</span><span class="p">(</span><span class="n">PureWindowsPath</span><span class="p">(</span><span class="n">path_string</span><span class="p">)</span><span class="o">.</span><span class="n">drive</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">is_full_windows_path_with_drive</span><span class="p">:</span>
        <span class="k">return</span> <span class="kc">False</span>

    <span class="n">is_remote_path</span> <span class="o">=</span> <span class="nb">bool</span><span class="p">(</span><span class="n">urlparse</span><span class="p">(</span><span class="n">path_string</span><span class="p">)</span><span class="o">.</span><span class="n">scheme</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">is_remote_path</span><span class="p">:</span>
        <span class="k">return</span> <span class="kc">False</span>

    <span class="n">is_absolute_path</span> <span class="o">=</span> <span class="n">PurePosixPath</span><span class="p">(</span><span class="n">path_string</span><span class="p">)</span><span class="o">.</span><span class="n">is_absolute</span><span class="p">()</span>
    <span class="k">if</span> <span class="n">is_absolute_path</span><span class="p">:</span>
        <span class="k">return</span> <span class="kc">False</span>

    <span class="k">return</span> <span class="kc">True</span>


<span class="k">def</span> <span class="nf">_convert_paths_to_absolute_posix</span><span class="p">(</span>
    <span class="n">project_path</span><span class="p">:</span> <span class="n">Path</span><span class="p">,</span> <span class="n">conf_dictionary</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]</span>
<span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
    <span class="sd">&quot;&quot;&quot;Turn all relative paths inside ``conf_dictionary`` into absolute paths by appending them</span>
<span class="sd">    to ``project_path`` and convert absolute Windows paths to POSIX format. This is a hack to</span>
<span class="sd">    make sure that we don&#39;t have to change user&#39;s working directory for logging and datasets to</span>
<span class="sd">    work. It is important for non-standard workflows such as IPython notebook where users don&#39;t go</span>
<span class="sd">    through `kedro run` or `__main__.py` entrypoints.</span>

<span class="sd">    Example:</span>
<span class="sd">    ::</span>
<span class="sd">        &gt;&gt;&gt; conf = _convert_paths_to_absolute_posix(</span>
<span class="sd">        &gt;&gt;&gt;     project_path=Path(&quot;/path/to/my/project&quot;),</span>
<span class="sd">        &gt;&gt;&gt;     conf_dictionary={</span>
<span class="sd">        &gt;&gt;&gt;         &quot;handlers&quot;: {</span>
<span class="sd">        &gt;&gt;&gt;             &quot;info_file_handler&quot;: {</span>
<span class="sd">        &gt;&gt;&gt;                 &quot;filename&quot;: &quot;logs/info.log&quot;</span>
<span class="sd">        &gt;&gt;&gt;             }</span>
<span class="sd">        &gt;&gt;&gt;         }</span>
<span class="sd">        &gt;&gt;&gt;     }</span>
<span class="sd">        &gt;&gt;&gt; )</span>
<span class="sd">        &gt;&gt;&gt; print(conf[&#39;handlers&#39;][&#39;info_file_handler&#39;][&#39;filename&#39;])</span>
<span class="sd">        &quot;/path/to/my/project/logs/info.log&quot;</span>

<span class="sd">    Args:</span>
<span class="sd">        project_path: The root directory to prepend to relative path to make absolute path.</span>
<span class="sd">        conf_dictionary: The configuration containing paths to expand.</span>
<span class="sd">    Returns:</span>
<span class="sd">        A dictionary containing only absolute paths.</span>
<span class="sd">    Raises:</span>
<span class="sd">        ValueError: If the provided ``project_path`` is not an absolute path.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">if</span> <span class="ow">not</span> <span class="n">project_path</span><span class="o">.</span><span class="n">is_absolute</span><span class="p">():</span>
        <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;project_path must be an absolute path. Received: </span><span class="si">{</span><span class="n">project_path</span><span class="si">}</span><span class="s2">&quot;</span>
        <span class="p">)</span>

    <span class="c1"># only check a few conf keys that are known to specify a path string as value</span>
    <span class="n">conf_keys_with_filepath</span> <span class="o">=</span> <span class="p">(</span><span class="s2">&quot;filename&quot;</span><span class="p">,</span> <span class="s2">&quot;filepath&quot;</span><span class="p">,</span> <span class="s2">&quot;path&quot;</span><span class="p">)</span>

    <span class="k">for</span> <span class="n">conf_key</span><span class="p">,</span> <span class="n">conf_value</span> <span class="ow">in</span> <span class="n">conf_dictionary</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>

        <span class="c1"># if the conf_value is another dictionary, absolutify its paths first.</span>
        <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">conf_value</span><span class="p">,</span> <span class="nb">dict</span><span class="p">):</span>
            <span class="n">conf_dictionary</span><span class="p">[</span><span class="n">conf_key</span><span class="p">]</span> <span class="o">=</span> <span class="n">_convert_paths_to_absolute_posix</span><span class="p">(</span>
                <span class="n">project_path</span><span class="p">,</span> <span class="n">conf_value</span>
            <span class="p">)</span>
            <span class="k">continue</span>

        <span class="c1"># if the conf_value is not a dictionary nor a string, skip</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">conf_value</span><span class="p">,</span> <span class="nb">str</span><span class="p">):</span>
            <span class="k">continue</span>

        <span class="c1"># if the conf_value is a string but the conf_key isn&#39;t one associated with filepath, skip</span>
        <span class="k">if</span> <span class="n">conf_key</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">conf_keys_with_filepath</span><span class="p">:</span>
            <span class="k">continue</span>

        <span class="k">if</span> <span class="n">_is_relative_path</span><span class="p">(</span><span class="n">conf_value</span><span class="p">):</span>
            <span class="c1"># Absolute local path should be in POSIX format</span>
            <span class="n">conf_value_absolute_path</span> <span class="o">=</span> <span class="p">(</span><span class="n">project_path</span> <span class="o">/</span> <span class="n">conf_value</span><span class="p">)</span><span class="o">.</span><span class="n">as_posix</span><span class="p">()</span>
            <span class="n">conf_dictionary</span><span class="p">[</span><span class="n">conf_key</span><span class="p">]</span> <span class="o">=</span> <span class="n">conf_value_absolute_path</span>
        <span class="k">elif</span> <span class="n">PureWindowsPath</span><span class="p">(</span><span class="n">conf_value</span><span class="p">)</span><span class="o">.</span><span class="n">drive</span><span class="p">:</span>
            <span class="c1"># Convert absolute Windows path to POSIX format</span>
            <span class="n">conf_dictionary</span><span class="p">[</span><span class="n">conf_key</span><span class="p">]</span> <span class="o">=</span> <span class="n">PureWindowsPath</span><span class="p">(</span><span class="n">conf_value</span><span class="p">)</span><span class="o">.</span><span class="n">as_posix</span><span class="p">()</span>

    <span class="k">return</span> <span class="n">conf_dictionary</span>


<span class="k">def</span> <span class="nf">_validate_layers_for_transcoding</span><span class="p">(</span><span class="n">catalog</span><span class="p">:</span> <span class="n">DataCatalog</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Check that transcoded names that correspond to</span>
<span class="sd">    the same dataset also belong to the same layer.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="k">def</span> <span class="nf">_find_conflicts</span><span class="p">():</span>
        <span class="n">base_names_to_layer</span> <span class="o">=</span> <span class="p">{}</span>
        <span class="k">for</span> <span class="n">current_layer</span><span class="p">,</span> <span class="n">dataset_names</span> <span class="ow">in</span> <span class="n">catalog</span><span class="o">.</span><span class="n">layers</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
            <span class="k">for</span> <span class="n">name</span> <span class="ow">in</span> <span class="n">dataset_names</span><span class="p">:</span>
                <span class="n">base_name</span><span class="p">,</span> <span class="n">_</span> <span class="o">=</span> <span class="n">_transcode_split</span><span class="p">(</span><span class="n">name</span><span class="p">)</span>
                <span class="n">known_layer</span> <span class="o">=</span> <span class="n">base_names_to_layer</span><span class="o">.</span><span class="n">setdefault</span><span class="p">(</span><span class="n">base_name</span><span class="p">,</span> <span class="n">current_layer</span><span class="p">)</span>
                <span class="k">if</span> <span class="n">current_layer</span> <span class="o">!=</span> <span class="n">known_layer</span><span class="p">:</span>
                    <span class="k">yield</span> <span class="n">name</span>
                <span class="k">else</span><span class="p">:</span>
                    <span class="n">base_names_to_layer</span><span class="p">[</span><span class="n">base_name</span><span class="p">]</span> <span class="o">=</span> <span class="n">current_layer</span>

    <span class="n">conflicting_datasets</span> <span class="o">=</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">_find_conflicts</span><span class="p">())</span>
    <span class="k">if</span> <span class="n">conflicting_datasets</span><span class="p">:</span>
        <span class="n">error_str</span> <span class="o">=</span> <span class="s2">&quot;, &quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">conflicting_datasets</span><span class="p">)</span>
        <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;Transcoded datasets should have the same layer. Mismatch found for: </span><span class="si">{</span><span class="n">error_str</span><span class="si">}</span><span class="s2">&quot;</span>
        <span class="p">)</span>


<span class="k">def</span> <span class="nf">_update_nested_dict</span><span class="p">(</span><span class="n">old_dict</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="n">Any</span><span class="p">,</span> <span class="n">Any</span><span class="p">],</span> <span class="n">new_dict</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="n">Any</span><span class="p">,</span> <span class="n">Any</span><span class="p">])</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Update a nested dict with values of new_dict.</span>

<span class="sd">    Args:</span>
<span class="sd">        old_dict: dict to be updated</span>
<span class="sd">        new_dict: dict to use for updating old_dict</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">for</span> <span class="n">key</span><span class="p">,</span> <span class="n">value</span> <span class="ow">in</span> <span class="n">new_dict</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
        <span class="k">if</span> <span class="n">key</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">old_dict</span><span class="p">:</span>
            <span class="n">old_dict</span><span class="p">[</span><span class="n">key</span><span class="p">]</span> <span class="o">=</span> <span class="n">value</span>
        <span class="k">else</span><span class="p">:</span>
            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">old_dict</span><span class="p">[</span><span class="n">key</span><span class="p">],</span> <span class="nb">dict</span><span class="p">)</span> <span class="ow">and</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">value</span><span class="p">,</span> <span class="nb">dict</span><span class="p">):</span>
                <span class="n">_update_nested_dict</span><span class="p">(</span><span class="n">old_dict</span><span class="p">[</span><span class="n">key</span><span class="p">],</span> <span class="n">value</span><span class="p">)</span>
            <span class="k">else</span><span class="p">:</span>
                <span class="n">old_dict</span><span class="p">[</span><span class="n">key</span><span class="p">]</span> <span class="o">=</span> <span class="n">value</span>


<div class="viewcode-block" id="KedroContext"><a class="viewcode-back" href="../../../../kedro.framework.context.KedroContext.html#kedro.framework.context.KedroContext">[docs]</a><span class="k">class</span> <span class="nc">KedroContext</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;``KedroContext`` is the base class which holds the configuration and</span>
<span class="sd">    Kedro&#39;s main functionality.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="n">_CONF_ROOT</span> <span class="o">=</span> <span class="s2">&quot;conf&quot;</span>
    <span class="sd">&quot;&quot;&quot;CONF_ROOT: Name of root directory containing project configuration.</span>
<span class="sd">    Default name is &quot;conf&quot;.&quot;&quot;&quot;</span>

<div class="viewcode-block" id="KedroContext.__init__"><a class="viewcode-back" href="../../../../kedro.framework.context.KedroContext.html#kedro.framework.context.KedroContext.__init__">[docs]</a>    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="n">package_name</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span>
        <span class="n">project_path</span><span class="p">:</span> <span class="n">Union</span><span class="p">[</span><span class="n">Path</span><span class="p">,</span> <span class="nb">str</span><span class="p">],</span>
    ...
    <span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Create a context object by providing the root of a Kedro project and</span>
<span class="sd">        the environment configuration subfolders (see ``kedro.config.ConfigLoader``)</span>

<span class="sd">        Raises:</span>
<span class="sd">            KedroContextError: If there is a mismatch</span>
<span class="sd">                between Kedro project version and package version.</span>

<span class="sd">        Args:</span>
<span class="sd">            package_name: Package name for the Kedro project the context is</span>
<span class="sd">                created for.</span>
<span class="sd">            project_path: Project path to define the context for.</span>
<span class="sd">            env: Optional argument for configuration default environment to be used</span>
<span class="sd">                for running the pipeline. If not specified, it defaults to &quot;local&quot;.</span>
<span class="sd">            extra_params: Optional dictionary containing extra project parameters.</span>
<span class="sd">                If specified, will update (and therefore take precedence over)</span>
<span class="sd">                the parameters retrieved from the project configuration.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_project_path</span> <span class="o">=</span> <span class="n">Path</span><span class="p">(</span><span class="n">project_path</span><span class="p">)</span><span class="o">.</span><span class="n">expanduser</span><span class="p">()</span><span class="o">.</span><span class="n">resolve</span><span class="p">()</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">_env</span> <span class="o">=</span> <span class="n">env</span> <span class="ow">or</span> <span class="s2">&quot;local&quot;</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_extra_params</span> <span class="o">=</span> <span class="n">deepcopy</span><span class="p">(</span><span class="n">extra_params</span><span class="p">)</span></div>

    <span class="nd">@property</span>  <span class="c1"># type: ignore</span>
    <span class="nd">@_deprecate</span><span class="p">(</span><span class="n">version</span><span class="o">=</span><span class="s2">&quot;0.18.0&quot;</span><span class="p">)</span>
    <span class="k">def</span> <span class="nf">CONF_ROOT</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>  <span class="c1"># pylint: disable=invalid-name</span>
        <span class="sd">&quot;&quot;&quot;Deprecated in favour of settings.CONF_ROOT</span>

<span class="sd">        Returns:</span>
<span class="sd">            The root directory of the configuration directory of the project.</span>
<span class="sd">        Raises:</span>
<span class="sd">            DeprecationWarning</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_CONF_ROOT</span>

    <span class="nd">@CONF_ROOT</span><span class="o">.</span><span class="n">setter</span>  <span class="c1"># type: ignore</span>
    <span class="nd">@_deprecate</span><span class="p">(</span><span class="n">version</span><span class="o">=</span><span class="s2">&quot;0.18.0&quot;</span><span class="p">)</span>
    <span class="k">def</span> <span class="nf">CONF_ROOT</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">value</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>  <span class="c1"># pylint: disable=invalid-name</span>
        <span class="sd">&quot;&quot;&quot;Deprecated in favour of settings.CONF_ROOT</span>
<span class="sd">        Raises:</span>
<span class="sd">            DeprecationWarning</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_CONF_ROOT</span> <span class="o">=</span> <span class="n">value</span>  <span class="c1"># pylint: disable=invalid-name</span>

    <span class="nd">@property</span>  <span class="c1"># type: ignore</span>
    <span class="k">def</span> <span class="nf">env</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Property for the current Kedro environment.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Name of the current Kedro environment.</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">package_name</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Property for Kedro project package name.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Name of Kedro project package.</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">pipeline</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Pipeline</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Read-only property for an instance of Pipeline.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Default pipeline.</span>
<span class="sd">        Raises:</span>
<span class="sd">            KedroContextError: If the `__default__` pipeline is not</span>
<span class="sd">                defined by `register_pipelines`.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="k">return</span> <span class="n">pipelines</span><span class="p">[</span><span class="s2">&quot;__default__&quot;</span><span class="p">]</span>
        <span class="k">except</span> <span class="ne">KeyError</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>  <span class="c1"># pragma: no cover</span>
            <span class="k">raise</span> <span class="n">KedroContextError</span><span class="p">(</span>
                <span class="s2">&quot;Failed to find the pipeline named &#39;__default__&#39;. &quot;</span>
                <span class="s2">&quot;It needs to be generated and returned &quot;</span>
                <span class="s2">&quot;by the &#39;register_pipelines&#39; function.&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>

    <span class="nd">@property</span>  <span class="c1"># type: ignore</span>
    <span class="nd">@_deprecate</span><span class="p">(</span><span class="n">version</span><span class="o">=</span><span class="s2">&quot;0.18.0&quot;</span><span class="p">)</span>
    <span class="k">def</span> <span class="nf">pipelines</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Pipeline</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Read-only property for an instance of Pipeline.</span>

<span class="sd">        Returns:</span>
<span class="sd">            A dictionary of defined pipelines.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="nb">dict</span><span class="p">(</span><span class="n">pipelines</span><span class="p">)</span>

    <span class="nd">@property</span>
    <span class="k">def</span> <span class="nf">project_path</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Path</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Read-only property containing Kedro&#39;s root project directory.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Project directory.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_project_path</span>

    <span class="nd">@property</span>
    <span class="k">def</span> <span class="nf">catalog</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">DataCatalog</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Read-only property referring to Kedro&#39;s ``DataCatalog`` for this context.</span>

<span class="sd">        Returns:</span>
<span class="sd">            DataCatalog defined in `catalog.yml`.</span>
<span class="sd">        Raises:</span>
<span class="sd">            KedroContextError: Incorrect ``DataCatalog`` registered for the project.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_catalog</span><span class="p">()</span>
    ...
    <span class="k">def</span> <span class="nf">params</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Read-only property referring to Kedro&#39;s parameters for this context.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Parameters defined in `parameters.yml` with the addition of any</span>
<span class="sd">                extra parameters passed at initialization.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="c1"># &#39;**/parameters*&#39; reads modular pipeline configs</span>
            <span class="n">params</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">config_loader</span><span class="o">.</span><span class="n">get</span><span class="p">(</span>
                <span class="s2">&quot;parameters*&quot;</span><span class="p">,</span> <span class="s2">&quot;parameters*/**&quot;</span><span class="p">,</span> <span class="s2">&quot;**/parameters*&quot;</span>
            <span class="p">)</span>
        <span class="k">except</span> <span class="n">MissingConfigException</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="n">warn</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Parameters not found in your Kedro project config.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
            <span class="n">params</span> <span class="o">=</span> <span class="p">{}</span>
        <span class="n">_update_nested_dict</span><span class="p">(</span><span class="n">params</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">_extra_params</span> <span class="ow">or</span> <span class="p">{})</span>
        <span class="k">return</span> <span class="n">params</span>

    <span class="k">def</span> <span class="nf">_get_catalog</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
    ...
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">DataCatalog</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;A hook for changing the creation of a DataCatalog instance.</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="c1"># &#39;**/catalog*&#39; reads modular pipeline configs</span>
        <span class="n">conf_catalog</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">config_loader</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="s2">&quot;catalog*&quot;</span><span class="p">,</span> <span class="s2">&quot;catalog*/**&quot;</span><span class="p">,</span> <span class="s2">&quot;**/catalog*&quot;</span><span class="p">)</span>
        <span class="c1"># turn relative paths in conf_catalog into absolute paths</span>
        <span class="c1"># before initializing the catalog</span>
        <span class="n">conf_catalog</span> <span class="o">=</span> <span class="n">_convert_paths_to_absolute_posix</span><span class="p">(</span>
            <span class="n">project_path</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">project_path</span><span class="p">,</span> <span class="n">conf_dictionary</span><span class="o">=</span><span class="n">conf_catalog</span>
        <span class="p">)</span>
        <span class="n">conf_creds</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_config_credentials</span><span class="p">()</span>

        <span class="n">hook_manager</span> <span class="o">=</span> <span class="n">get_hook_manager</span><span class="p">()</span>
        <span class="n">catalog</span> <span class="o">=</span> <span class="n">hook_manager</span><span class="o">.</span><span class="n">hook</span><span class="o">.</span><span class="n">register_catalog</span><span class="p">(</span>  <span class="c1"># pylint: disable=no-member</span>
            <span class="n">catalog</span><span class="o">=</span><span class="n">conf_catalog</span><span class="p">,</span>
            <span class="n">credentials</span><span class="o">=</span><span class="n">conf_creds</span><span class="p">,</span>
            <span class="n">load_versions</span><span class="o">=</span><span class="n">load_versions</span><span class="p">,</span>
            <span class="n">save_version</span><span class="o">=</span><span class="n">save_version</span><span class="p">,</span>
            <span class="n">journal</span><span class="o">=</span><span class="n">journal</span><span class="p">,</span>
        <span class="p">)</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">catalog</span><span class="p">,</span> <span class="n">DataCatalog</span><span class="p">):</span>
            <span class="k">raise</span> <span class="n">KedroContextError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Expected an instance of `DataCatalog`, &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;got `</span><span class="si">{</span><span class="nb">type</span><span class="p">(</span><span class="n">catalog</span><span class="p">)</span><span class="o">.</span><span class="vm">__name__</span><span class="si">}</span><span class="s2">` instead.&quot;</span>
            <span class="p">)</span>

        <span class="n">feed_dict</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_feed_dict</span><span class="p">()</span>
        <span class="n">catalog</span><span class="o">.</span><span class="n">add_feed_dict</span><span class="p">(</span><span class="n">feed_dict</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">catalog</span><span class="o">.</span><span class="n">layers</span><span class="p">:</span>
            <span class="n">_validate_layers_for_transcoding</span><span class="p">(</span><span class="n">catalog</span><span class="p">)</span>
        <span class="n">hook_manager</span> <span class="o">=</span> <span class="n">get_hook_manager</span><span class="p">()</span>
        <span class="n">hook_manager</span><span class="o">.</span><span class="n">hook</span><span class="o">.</span><span class="n">after_catalog_created</span><span class="p">(</span>  <span class="c1"># pylint: disable=no-member</span>
            <span class="n">catalog</span><span class="o">=</span><span class="n">catalog</span><span class="p">,</span>
            <span class="n">conf_catalog</span><span class="o">=</span><span class="n">conf_catalog</span><span class="p">,</span>
            <span class="n">conf_creds</span><span class="o">=</span><span class="n">conf_creds</span><span class="p">,</span>
            <span class="n">feed_dict</span><span class="o">=</span><span class="n">feed_dict</span><span class="p">,</span>
            <span class="n">save_version</span><span class="o">=</span><span class="n">save_version</span><span class="p">,</span>
            <span class="n">load_versions</span><span class="o">=</span><span class="n">load_versions</span><span class="p">,</span>
            <span class="n">run_id</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">run_id</span> <span class="ow">or</span> <span class="n">save_version</span><span class="p">,</span>
        <span class="p">)</span>
        <span class="k">return</span> <span class="n">catalog</span>

    <span class="nd">@property</span>  <span class="c1"># type: ignore</span>
    <span class="nd">@_deprecate</span><span class="p">(</span><span class="n">version</span><span class="o">=</span><span class="s2">&quot;0.18.0&quot;</span><span class="p">)</span>
    <span class="k">def</span> <span class="nf">io</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">DataCatalog</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Read-only alias property referring to Kedro&#39;s ``DataCatalog`` for this</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">_get_config_loader</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">ConfigLoader</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;A hook for changing the creation of a ConfigLoader instance.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Instance of `ConfigLoader` created by `register_config_loader` hook.</span>
<span class="sd">        Raises:</span>
<span class="sd">            KedroContextError: Incorrect ``ConfigLoader`` registered for the project.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">conf_root</span> <span class="o">=</span> <span class="n">settings</span><span class="o">.</span><span class="n">CONF_ROOT</span>
        <span class="n">conf_paths</span> <span class="o">=</span> <span class="p">[</span>
            <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">project_path</span> <span class="o">/</span> <span class="n">conf_root</span> <span class="o">/</span> <span class="s2">&quot;base&quot;</span><span class="p">),</span>
            <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">project_path</span> <span class="o">/</span> <span class="n">conf_root</span> <span class="o">/</span> <span class="bp">self</span><span class="o">.</span><span class="n">env</span><span class="p">),</span>
        <span class="p">]</span>
        <span class="n">hook_manager</span> <span class="o">=</span> <span class="n">get_hook_manager</span><span class="p">()</span>
        <span class="n">config_loader</span> <span class="o">=</span> <span class="p">(</span>
            <span class="n">hook_manager</span><span class="o">.</span><span class="n">hook</span><span class="o">.</span><span class="n">register_config_loader</span><span class="p">(</span>  <span class="c1"># pylint: disable=no-member</span>
                <span class="n">conf_paths</span><span class="o">=</span><span class="n">conf_paths</span><span class="p">,</span>
                ...
                <span class="n">extra_params</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">_extra_params</span><span class="p">,</span>
            <span class="p">)</span>
        <span class="p">)</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">config_loader</span><span class="p">,</span> <span class="n">ConfigLoader</span><span class="p">):</span>
            <span class="k">raise</span> <span class="n">KedroContextError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Expected an instance of `ConfigLoader`, &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;got `</span><span class="si">{</span><span class="nb">type</span><span class="p">(</span><span class="n">config_loader</span><span class="p">)</span><span class="o">.</span><span class="vm">__name__</span><span class="si">}</span><span class="s2">` instead.&quot;</span>
            <span class="p">)</span>
        <span class="k">return</span> <span class="n">config_loader</span>

    <span class="nd">@property</span>
    <span class="k">def</span> <span class="nf">config_loader</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">ConfigLoader</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Read-only property referring to Kedro&#39;s ``ConfigLoader`` for this</span>
<span class="sd">        context.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Instance of `ConfigLoader`.</span>
<span class="sd">        Raises:</span>
<span class="sd">            KedroContextError: Incorrect ``ConfigLoader`` registered for the project.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_config_loader</span><span class="p">()</span>

    <span class="k">def</span> <span class="nf">_get_feed_dict</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Get parameters and return the feed dictionary.&quot;&quot;&quot;</span>
        <span class="n">params</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">params</span>
        <span class="n">feed_dict</span> <span class="o">=</span> <span class="p">{</span><span class="s2">&quot;parameters&quot;</span><span class="p">:</span> <span class="n">params</span><span class="p">}</span>

        <span class="k">def</span> <span class="nf">_add_param_to_feed_dict</span><span class="p">(</span><span class="n">param_name</span><span class="p">,</span> <span class="n">param_value</span><span class="p">):</span>
            <span class="sd">&quot;&quot;&quot;This recursively adds parameter paths to the `feed_dict`,</span>
<span class="sd">            whenever `param_value` is a dictionary itself, so that users can</span>
<span class="sd">            specify specific nested parameters in their node inputs.</span>

<span class="sd">            Example:</span>

<span class="sd">                &gt;&gt;&gt; param_name = &quot;a&quot;</span>
<span class="sd">                &gt;&gt;&gt; param_value = {&quot;b&quot;: 1}</span>
<span class="sd">                &gt;&gt;&gt; _add_param_to_feed_dict(param_name, param_value)</span>
<span class="sd">                &gt;&gt;&gt; assert feed_dict[&quot;params:a&quot;] == {&quot;b&quot;: 1}</span>
<span class="sd">                &gt;&gt;&gt; assert feed_dict[&quot;params:a.b&quot;] == 1</span>
<span class="sd">            &quot;&quot;&quot;</span>
            <span class="n">key</span> <span class="o">=</span> <span class="sa">f</span><span class="s2">&quot;params:</span><span class="si">{</span><span class="n">param_name</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="n">feed_dict</span><span class="p">[</span><span class="n">key</span><span class="p">]</span> <span class="o">=</span> <span class="n">param_value</span>

            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">param_value</span><span class="p">,</span> <span class="nb">dict</span><span class="p">):</span>
                <span class="k">for</span> <span class="n">key</span><span class="p">,</span> <span class="n">val</span> <span class="ow">in</span> <span class="n">param_value</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
                    <span class="n">_add_param_to_feed_dict</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;</span><span class="si">{</span><span class="n">param_name</span><span class="si">}</span><span class="s2">.</span><span class="si">{</span><span class="n">key</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">,</span> <span class="n">val</span><span class="p">)</span>
        ...
        <span class="k">for</span> <span class="n">param_name</span><span class="p">,</span> <span class="n">param_value</span> <span class="ow">in</span> <span class="n">params</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
            <span class="n">_add_param_to_feed_dict</span><span class="p">(</span><span class="n">param_name</span><span class="p">,</span> <span class="n">param_value</span><span class="p">)</span>

        <span class="k">return</span> <span class="n">feed_dict</span>

    <span class="k">def</span> <span class="nf">_get_config_credentials</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Getter for credentials specified in credentials directory.&quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="n">conf_creds</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">config_loader</span><span class="o">.</span><span class="n">get</span><span class="p">(</span>
                <span class="s2">&quot;credentials*&quot;</span><span class="p">,</span> <span class="s2">&quot;credentials*/**&quot;</span><span class="p">,</span> <span class="s2">&quot;**/credentials*&quot;</span>
            <span class="p">)</span>
        <span class="k">except</span> <span class="n">MissingConfigException</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="n">warn</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Credentials not found in your Kedro project config.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>
            <span class="n">conf_creds</span> <span class="o">=</span> <span class="p">{}</span>
        <span class="k">return</span> <span class="n">conf_creds</span>

    <span class="c1"># pylint: disable=too-many-arguments, no-self-use</span>
    <span class="k">def</span> <span class="nf">_filter_pipeline</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="n">pipeline</span><span class="p">:</span> <span class="n">Pipeline</span><span class="p">,</span>
        <span class="n">tags</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">from_nodes</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">to_nodes</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">node_names</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">from_inputs</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">to_outputs</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Pipeline</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Filter the pipeline as the intersection of all conditions.&quot;&quot;&quot;</span>
        <span class="n">new_pipeline</span> <span class="o">=</span> <span class="n">pipeline</span>
        <span class="c1"># We need to intersect with the pipeline because the order</span>
        <span class="c1"># of operations matters, so we don&#39;t want to do it incrementally.</span>
        <span class="c1"># As an example, with a pipeline of nodes 1,2,3, think of</span>
        <span class="c1"># &quot;from 1&quot;, and &quot;only 1 and 3&quot; - the order you do them in results in</span>
        <span class="c1"># either 1 &amp; 3, or just 1.</span>
        <span class="k">if</span> <span class="n">tags</span><span class="p">:</span>
            <span class="n">new_pipeline</span> <span class="o">&amp;=</span> <span class="n">pipeline</span><span class="o">.</span><span class="n">only_nodes_with_tags</span><span class="p">(</span><span class="o">*</span><span class="n">tags</span><span class="p">)</span>
            <span class="k">if</span> <span class="ow">not</span> <span class="n">new_pipeline</span><span class="o">.</span><span class="n">nodes</span><span class="p">:</span>
                <span class="k">raise</span> <span class="n">KedroContextError</span><span class="p">(</span>
                    <span class="sa">f</span><span class="s2">&quot;Pipeline contains no nodes with tags: </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">tags</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
                <span class="p">)</span>
        <span class="k">if</span> <span class="n">from_nodes</span><span class="p">:</span>
            <span class="n">new_pipeline</span> <span class="o">&amp;=</span> <span class="n">pipeline</span><span class="o">.</span><span class="n">from_nodes</span><span class="p">(</span><span class="o">*</span><span class="n">from_nodes</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">to_nodes</span><span class="p">:</span>
            <span class="n">new_pipeline</span> <span class="o">&amp;=</span> <span class="n">pipeline</span><span class="o">.</span><span class="n">to_nodes</span><span class="p">(</span><span class="o">*</span><span class="n">to_nodes</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">node_names</span><span class="p">:</span>
            <span class="n">new_pipeline</span> <span class="o">&amp;=</span> <span class="n">pipeline</span><span class="o">.</span><span class="n">only_nodes</span><span class="p">(</span><span class="o">*</span><span class="n">node_names</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">from_inputs</span><span class="p">:</span>
            <span class="n">new_pipeline</span> <span class="o">&amp;=</span> <span class="n">pipeline</span><span class="o">.</span><span class="n">from_inputs</span><span class="p">(</span><span class="o">*</span><span class="n">from_inputs</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">to_outputs</span><span class="p">:</span>
            <span class="n">new_pipeline</span> <span class="o">&amp;=</span> <span class="n">pipeline</span><span class="o">.</span><span class="n">to_outputs</span><span class="p">(</span><span class="o">*</span><span class="n">to_outputs</span><span class="p">)</span>

        <span class="k">if</span> <span class="ow">not</span> <span class="n">new_pipeline</span><span class="o">.</span><span class="n">nodes</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">KedroContextError</span><span class="p">(</span><span class="s2">&quot;Pipeline contains no nodes&quot;</span><span class="p">)</span>
        <span class="k">return</span> <span class="n">new_pipeline</span>

    <span class="nd">@property</span>
    <span class="k">def</span> <span class="nf">run_id</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Union</span><span class="p">[</span><span class="kc">None</span><span class="p">,</span> <span class="nb">str</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Unique identifier for a run / journal record, defaults to None.</span>
<span class="sd">        If `run_id` is None, `save_version` will be used instead.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_run_id</span><span class="p">()</span>

<div class="viewcode-block" id="KedroContext.run"><a class="viewcode-back" href="../../../../kedro.framework.context.KedroContext.html#kedro.framework.context.KedroContext.run">[docs]</a>    <span class="k">def</span> <span class="nf">run</span><span class="p">(</span>  <span class="c1"># pylint: disable=too-many-arguments,too-many-locals</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="n">tags</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">runner</span><span class="p">:</span> <span class="n">AbstractRunner</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">node_names</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">from_nodes</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">to_nodes</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">from_inputs</span><span class="p">:</span> <span class="n">Iterable</span><span class="p">[</span><span class="nb">str</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    ...
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Runs the pipeline with a specified runner.</span>

<span class="sd">        Args:</span>
<span class="sd">            tags: An optional list of node tags which should be used to</span>
<span class="sd">                filter the nodes of the ``Pipeline``. If specified, only the nodes</span>
<span class="sd">                containing *any* of these tags will be run.</span>
<span class="sd">            runner: An optional parameter specifying the runner that you want to run</span>
<span class="sd">                the pipeline with.</span>
<span class="sd">            node_names: An optional list of node names which should be used to</span>
<span class="sd">                filter the nodes of the ``Pipeline``. If specified, only the nodes</span>
<span class="sd">                with these names will be run.</span>
<span class="sd">            from_nodes: An optional list of node names which should be used as a</span>
<span class="sd">                starting point of the new ``Pipeline``.</span>
<span class="sd">            to_nodes: An optional list of node names which should be used as an</span>
<span class="sd">                end point of the new ``Pipeline``.</span>
<span class="sd">            from_inputs: An optional list of input datasets which should be used as a</span>
<span class="sd">                starting point of the new ``Pipeline``.</span>
<span class="sd">            to_outputs: An optional list of output datasets which should be used as an</span>
<span class="sd">                end point of the new ``Pipeline``.</span>
<span class="sd">            load_versions: An optional flag to specify a particular dataset version timestamp</span>
<span class="sd">                to load.</span>
<span class="sd">            pipeline_name: Name of the ``Pipeline`` to execute.</span>
<span class="sd">                Defaults to &quot;__default__&quot;.</span>
<span class="sd">        Raises:</span>
<span class="sd">            KedroContextError: If the resulting ``Pipeline`` is empty</span>
<span class="sd">                or incorrect tags are provided.</span>
<span class="sd">            Exception: Any uncaught exception will be re-raised</span>
<span class="sd">                after being passed to``on_pipeline_error``.</span>
<span class="sd">        Returns:</span>
<span class="sd">            Any node outputs that cannot be processed by the ``DataCatalog``.</span>
<span class="sd">            These are returned in a dictionary, where the keys are defined</span>
<span class="sd">            by the node outputs.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="n">warn</span><span class="p">(</span>
            <span class="s2">&quot;`kedro.framework.context.KedroContext.run` is now deprecated in favour of &quot;</span>
            <span class="s2">&quot;`KedroSession.run` and will be removed in Kedro 0.18.0.&quot;</span><span class="p">,</span>
            <span class="ne">DeprecationWarning</span><span class="p">,</span>
        <span class="p">)</span>
        <span class="c1"># Report project name</span>
        <span class="n">logging</span><span class="o">.</span><span class="n">info</span><span class="p">(</span><span class="s2">&quot;** Kedro project </span><span class="si">%s</span><span class="s2">&quot;</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">project_path</span><span class="o">.</span><span class="n">name</span><span class="p">)</span>

        <span class="n">name</span> <span class="o">=</span> <span class="n">pipeline_name</span> <span class="ow">or</span> <span class="s2">&quot;__default__&quot;</span>

        <span class="k">try</span><span class="p">:</span>
            <span class="n">pipeline</span> <span class="o">=</span> <span class="n">pipelines</span><span class="p">[</span><span class="n">name</span><span class="p">]</span>
        <span class="k">except</span> <span class="ne">KeyError</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">KedroContextError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Failed to find the pipeline named &#39;</span><span class="si">{</span><span class="n">name</span><span class="si">}</span><span class="s2">&#39;. &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;It needs to be generated and returned &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;by the &#39;register_pipelines&#39; function.&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>

        <span class="n">filtered_pipeline</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_filter_pipeline</span><span class="p">(</span>
            <span class="n">pipeline</span><span class="o">=</span><span class="n">pipeline</span><span class="p">,</span>
            <span class="n">tags</span><span class="o">=</span><span class="n">tags</span><span class="p">,</span>
            <span class="n">from_nodes</span><span class="o">=</span><span class="n">from_nodes</span><span class="p">,</span>
            <span class="n">to_nodes</span><span class="o">=</span><span class="n">to_nodes</span><span class="p">,</span>
            <span class="n">node_names</span><span class="o">=</span><span class="n">node_names</span><span class="p">,</span>
            <span class="n">from_inputs</span><span class="o">=</span><span class="n">from_inputs</span><span class="p">,</span>
            <span class="n">to_outputs</span><span class="o">=</span><span class="n">to_outputs</span><span class="p">,</span>
        <span class="p">)</span>

        <span class="n">save_version</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_save_version</span><span class="p">()</span>
        <span class="n">run_id</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">run_id</span> <span class="ow">or</span> <span class="n">save_version</span>
        ...
        <span class="n">record_data</span> <span class="o">=</span> <span class="p">{</span>
            ...
            <span class="s2">&quot;project_path&quot;</span><span class="p">:</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">project_path</span><span class="p">),</span>
            ...
            <span class="s2">&quot;from_nodes&quot;</span><span class="p">:</span> <span class="n">from_nodes</span><span class="p">,</span>
            <span class="s2">&quot;to_nodes&quot;</span><span class="p">:</span> <span class="n">to_nodes</span><span class="p">,</span>
            <span class="s2">&quot;node_names&quot;</span><span class="p">:</span> <span class="n">node_names</span><span class="p">,</span>
            <span class="s2">&quot;from_inputs&quot;</span><span class="p">:</span> <span class="n">from_inputs</span><span class="p">,</span>
            <span class="s2">&quot;to_outputs&quot;</span><span class="p">:</span> <span class="n">to_outputs</span><span class="p">,</span>
            <span class="s2">&quot;load_versions&quot;</span><span class="p">:</span> <span class="n">load_versions</span><span class="p">,</span>
            <span class="s2">&quot;pipeline_name&quot;</span><span class="p">:</span> <span class="n">pipeline_name</span><span class="p">,</span>
            <span class="s2">&quot;extra_params&quot;</span><span class="p">:</span> <span class="bp">self</span><span class="o">.</span><span class="n">_extra_params</span><span class="p">,</span>
        <span class="p">}</span>
        <span class="n">journal</span> <span class="o">=</span> <span class="n">Journal</span><span class="p">(</span><span class="n">record_data</span><span class="p">)</span>

        <span class="n">catalog</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_catalog</span><span class="p">(</span>
            <span class="n">save_version</span><span class="o">=</span><span class="n">save_version</span><span class="p">,</span> <span class="n">journal</span><span class="o">=</span><span class="n">journal</span><span class="p">,</span> <span class="n">load_versions</span><span class="o">=</span><span class="n">load_versions</span>
        <span class="p">)</span>

        <span class="c1"># Run the runner</span>
        <span class="n">runner</span> <span class="o">=</span> <span class="n">runner</span> <span class="ow">or</span> <span class="n">SequentialRunner</span><span class="p">()</span>
        <span class="n">hook_manager</span> <span class="o">=</span> <span class="n">get_hook_manager</span><span class="p">()</span>
        <span class="n">hook_manager</span><span class="o">.</span><span class="n">hook</span><span class="o">.</span><span class="n">before_pipeline_run</span><span class="p">(</span>  <span class="c1"># pylint: disable=no-member</span>
            <span class="n">run_params</span><span class="o">=</span><span class="n">record_data</span><span class="p">,</span> <span class="n">pipeline</span><span class="o">=</span><span class="n">filtered_pipeline</span><span class="p">,</span> <span class="n">catalog</span><span class="o">=</span><span class="n">catalog</span>
        <span class="p">)</span>

        <span class="k">try</span><span class="p">:</span>
            <span class="n">run_result</span> <span class="o">=</span> <span class="n">runner</span><span class="o">.</span><span class="n">run</span><span class="p">(</span><span class="n">filtered_pipeline</span><span class="p">,</span> <span class="n">catalog</span><span class="p">,</span> <span class="n">run_id</span><span class="p">)</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="n">hook_manager</span><span class="o">.</span><span class="n">hook</span><span class="o">.</span><span class="n">on_pipeline_error</span><span class="p">(</span>  <span class="c1"># pylint: disable=no-member</span>
                <span class="n">error</span><span class="o">=</span><span class="n">exc</span><span class="p">,</span>
                <span class="n">run_params</span><span class="o">=</span><span class="n">record_data</span><span class="p">,</span>
                <span class="n">pipeline</span><span class="o">=</span><span class="n">filtered_pipeline</span><span class="p">,</span>
                <span class="n">catalog</span><span class="o">=</span><span class="n">catalog</span><span class="p">,</span>
            <span class="p">)</span>
            <span class="k">raise</span> <span class="n">exc</span>

        <span class="n">hook_manager</span><span class="o">.</span><span class="n">hook</span><span class="o">.</span><span class="n">after_pipeline_run</span><span class="p">(</span>  <span class="c1"># pylint: disable=no-member</span>
            <span class="n">run_params</span><span class="o">=</span><span class="n">record_data</span><span class="p">,</span>
            <span class="n">run_result</span><span class="o">=</span><span class="n">run_result</span><span class="p">,</span>
            <span class="n">pipeline</span><span class="o">=</span><span class="n">filtered_pipeline</span><span class="p">,</span>
            <span class="n">catalog</span><span class="o">=</span><span class="n">catalog</span><span class="p">,</span>
        <span class="p">)</span>
        <span class="k">return</span> <span class="n">run_result</span></div>

    <span class="k">def</span> <span class="nf">_get_run_id</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span> <span class="o">*</span><span class="n">args</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span>  <span class="c1"># pylint: disable=unused-argument</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Union</span><span class="p">[</span><span class="kc">None</span><span class="p">,</span> <span class="nb">str</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;A hook for generating a unique identifier for a</span>
<span class="sd">        run / journal record, defaults to None.</span>
<span class="sd">        If None, `save_version` will be used instead.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="kc">None</span>

    <span class="k">def</span> <span class="nf">_get_save_version</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span> <span class="o">*</span><span class="n">args</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span>  <span class="c1"># pylint: disable=unused-argument</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Generate unique ID for dataset versioning, defaults to timestamp.</span>
<span class="sd">        `save_version` MUST be something that can be ordered, in order to</span>
<span class="sd">        easily determine the latest version.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="n">generate_timestamp</span><span class="p">()</span></div>


<span class="k">def</span> <span class="nf">load_context</span><span class="p">(</span><span class="n">project_path</span><span class="p">:</span> <span class="n">Union</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Path</span><span class="p">],</span> <span class="o">**</span><span class="n">kwargs</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">KedroContext</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Loads the KedroContext object of a Kedro Project.</span>
<span class="sd">    This is the default way to load the KedroContext object for normal workflows such as</span>
<span class="sd">    CLI, Jupyter Notebook, Plugins, etc. It assumes the following project structure</span>
<span class="sd">    under the given project_path::</span>

<span class="sd">       &lt;project_path&gt;</span>
<span class="sd">           |__ &lt;src_dir&gt;</span>
<span class="sd">           |__ pyproject.toml</span>

<span class="sd">    The name of the &lt;scr_dir&gt; is `src` by default. The `pyproject.toml` file is used</span>
<span class="sd">    for project metadata. Kedro configuration should be under `[tool.kedro]` section.</span>

<span class="sd">    Args:</span>
<span class="sd">        project_path: Path to the Kedro project.</span>
<span class="sd">        **kwargs: Optional kwargs for ``KedroContext`` class.</span>

<span class="sd">    Returns:</span>
<span class="sd">        Instance of ``KedroContext`` class defined in Kedro project.</span>

<span class="sd">    Raises:</span>
<span class="sd">        KedroContextError: `pyproject.toml` was not found or the `[tool.kedro]` section</span>
<span class="sd">            is missing, or loaded context has package conflict.</span>

<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">warn</span><span class="p">(</span>
        <span class="s2">&quot;`kedro.framework.context.load_context` is now deprecated in favour of &quot;</span>
        <span class="s2">&quot;`KedroSession.load_context` and will be removed in Kedro 0.18.0.&quot;</span><span class="p">,</span>
        <span class="ne">DeprecationWarning</span><span class="p">,</span>
    <span class="p">)</span>
    <span class="n">project_path</span> <span class="o">=</span> <span class="n">Path</span><span class="p">(</span><span class="n">project_path</span><span class="p">)</span><span class="o">.</span><span class="n">expanduser</span><span class="p">()</span><span class="o">.</span><span class="n">resolve</span><span class="p">()</span>
    <span class="n">metadata</span> <span class="o">=</span> <span class="n">_get_project_metadata</span><span class="p">(</span><span class="n">project_path</span><span class="p">)</span>

    <span class="n">context_class</span> <span class="o">=</span> <span class="n">settings</span><span class="o">.</span><span class="n">CONTEXT_CLASS</span>
    <span class="c1"># update kwargs with env from the environment variable</span>
    <span class="c1"># (defaults to None if not set)</span>
    <span class="c1"># need to do this because some CLI command (e.g `kedro run`) defaults to</span>
    <span class="c1"># passing in `env=None`</span>
    <span class="n">kwargs</span><span class="p">[</span><span class="s2">&quot;env&quot;</span><span class="p">]</span> <span class="o">=</span> <span class="n">kwargs</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="s2">&quot;env&quot;</span><span class="p">)</span> <span class="ow">or</span> <span class="n">os</span><span class="o">.</span><span class="n">getenv</span><span class="p">(</span><span class="s2">&quot;KEDRO_ENV&quot;</span><span class="p">)</span>
    <span class="n">context</span> <span class="o">=</span> <span class="n">context_class</span><span class="p">(</span>
        <span class="n">package_name</span><span class="o">=</span><span class="n">metadata</span><span class="o">.</span><span class="n">package_name</span><span class="p">,</span> <span class="n">project_path</span><span class="o">=</span><span class="n">project_path</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span>
    <span class="p">)</span>
    <span class="k">return</span> <span class="n">context</span>


<div class="viewcode-block" id="KedroContextError"><a class="viewcode-back" href="../../../../kedro.framework.context.KedroContextError.html#kedro.framework.context.KedroContextError">[docs]</a><span class="k">class</span> <span class="nc">KedroContextError</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;Error occurred when loading project and running context pipeline.&quot;&quot;&quot;</span></div>
</pre></div>
