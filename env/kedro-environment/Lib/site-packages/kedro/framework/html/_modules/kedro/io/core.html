...
<head>
  ...
  <title>kedro.io.core &mdash; Kedro 0.17.7 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <h1>Source code for kedro.io.core</h1><div class="highlight"><pre>
<span></span><span class="sd">&quot;&quot;&quot;This module provides a set of classes which underpin the data loading and</span>
<span class="sd">saving functionality provided by ``kedro.io``.</span>
<span class="sd">&quot;&quot;&quot;</span>
...
<span class="kn">from</span> <span class="nn">pathlib</span> <span class="kn">import</span> <span class="n">Path</span><span class="p">,</span> <span class="n">PurePath</span><span class="p">,</span> <span class="n">PurePosixPath</span>
...
<span class="kn">from</span> <span class="nn">cachetools.keys</span> <span class="kn">import</span> <span class="n">hashkey</span>

<span class="kn">from</span> <span class="nn">kedro.utils</span> <span class="kn">import</span> <span class="n">load_obj</span>

<span class="n">warnings</span><span class="o">.</span><span class="n">simplefilter</span><span class="p">(</span><span class="s2">&quot;default&quot;</span><span class="p">,</span> <span class="ne">DeprecationWarning</span><span class="p">)</span>

<span class="n">VERSION_FORMAT</span> <span class="o">=</span> <span class="s2">&quot;%Y-%m-</span><span class="si">%d</span><span class="s2">T%H.%M.%S.</span><span class="si">%f</span><span class="s2">Z&quot;</span>
<span class="n">VERSIONED_FLAG_KEY</span> <span class="o">=</span> <span class="s2">&quot;versioned&quot;</span>
<span class="n">VERSION_KEY</span> <span class="o">=</span> <span class="s2">&quot;version&quot;</span>
<span class="n">HTTP_PROTOCOLS</span> <span class="o">=</span> <span class="p">(</span><span class="s2">&quot;http&quot;</span><span class="p">,</span> <span class="s2">&quot;https&quot;</span><span class="p">)</span>
<span class="n">PROTOCOL_DELIMITER</span> <span class="o">=</span> <span class="s2">&quot;://&quot;</span>
<span class="n">CLOUD_PROTOCOLS</span> <span class="o">=</span> <span class="p">(</span><span class="s2">&quot;s3&quot;</span><span class="p">,</span> <span class="s2">&quot;gcs&quot;</span><span class="p">,</span> <span class="s2">&quot;gs&quot;</span><span class="p">,</span> <span class="s2">&quot;adl&quot;</span><span class="p">,</span> <span class="s2">&quot;abfs&quot;</span><span class="p">)</span>


<span class="k">class</span> <span class="nc">DataSetError</span><span class="p">(</span><span class="ne">Exception</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;``DataSetError`` raised by ``AbstractDataSet`` implementations</span>
<span class="sd">    in case of failure of input/output methods.</span>

<span class="sd">    ``AbstractDataSet`` implementations should provide instructive</span>
<span class="sd">    information in case of failure.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="k">pass</span>


<span class="k">class</span> <span class="nc">DataSetNotFoundError</span><span class="p">(</span><span class="n">DataSetError</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;``DataSetNotFoundError`` raised by ``DataCatalog`` class in case of</span>
<span class="sd">    trying to use a non-existing data set.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="k">pass</span>


<div class="viewcode-block" id="DataSetAlreadyExistsError"><a class="viewcode-back" href="../../../kedro.io.DataSetAlreadyExistsError.html#kedro.io.DataSetAlreadyExistsError">[docs]</a><span class="k">class</span> <span class="nc">DataSetAlreadyExistsError</span><span class="p">(</span><span class="n">DataSetError</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;``DataSetAlreadyExistsError`` raised by ``DataCatalog`` class in case</span>
<span class="sd">    of trying to add a data set which already exists in the ``DataCatalog``.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="k">pass</span></div>


<span class="k">class</span> <span class="nc">VersionNotFoundError</span><span class="p">(</span><span class="n">DataSetError</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;``VersionNotFoundError`` raised by ``AbstractVersionedDataSet`` implementations</span>
<span class="sd">    in case of no load versions available for the data set.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="k">pass</span>


<span class="k">class</span> <span class="nc">AbstractDataSet</span><span class="p">(</span><span class="n">abc</span><span class="o">.</span><span class="n">ABC</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;``AbstractDataSet`` is the base class for all data set implementations.</span>
<span class="sd">    All data set implementations should extend this abstract class</span>
<span class="sd">    and implement the methods marked as abstract.</span>
<span class="sd">    If a specific dataset implementation cannot be used in conjunction with</span>
<span class="sd">    the ``ParallelRunner``, such user-defined dataset should have the</span>
<span class="sd">    attribute `_SINGLE_PROCESS = True`.</span>
<span class="sd">    Example:</span>
<span class="sd">    ::</span>

<span class="sd">        &gt;&gt;&gt; from pathlib import Path, PurePosixPath</span>
<span class="sd">        &gt;&gt;&gt; import pandas as pd</span>
<span class="sd">        &gt;&gt;&gt; from kedro.io import AbstractDataSet</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt; class MyOwnDataSet(AbstractDataSet):</span>
<span class="sd">        &gt;&gt;&gt;     def __init__(self, filepath, param1, param2=True):</span>
<span class="sd">        &gt;&gt;&gt;         self._filepath = PurePosixPath(filepath)</span>
<span class="sd">        &gt;&gt;&gt;         self._param1 = param1</span>
<span class="sd">        &gt;&gt;&gt;         self._param2 = param2</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _load(self) -&gt; pd.DataFrame:</span>
<span class="sd">        &gt;&gt;&gt;         return pd.read_csv(self._filepath)</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _save(self, df: pd.DataFrame) -&gt; None:</span>
<span class="sd">        &gt;&gt;&gt;         df.to_csv(str(self._filepath))</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _exists(self) -&gt; bool:</span>
<span class="sd">        &gt;&gt;&gt;         return Path(self._filepath.as_posix()).exists()</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _describe(self):</span>
<span class="sd">        &gt;&gt;&gt;         return dict(param1=self._param1, param2=self._param2)</span>

<span class="sd">    Example catalog.yml specification:</span>
<span class="sd">    ::</span>

<span class="sd">        my_dataset:</span>
<span class="sd">            type: &lt;path-to-my-own-dataset&gt;.MyOwnDataSet</span>
<span class="sd">            filepath: data/01_raw/my_data.csv</span>
<span class="sd">            param1: &lt;param1-value&gt; # param1 is a required argument</span>
<span class="sd">            # param2 will be True by default</span>
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">from_config</span><span class="p">(</span>
        ...
        <span class="n">load_version</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">save_version</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="s2">&quot;AbstractDataSet&quot;</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Create a data set instance using the configuration provided.</span>

<span class="sd">        Args:</span>
<span class="sd">            name: Data set name.</span>
<span class="sd">            config: Data set config dictionary.</span>
<span class="sd">            load_version: Version string to be used for ``load`` operation if</span>
<span class="sd">                the data set is versioned. Has no effect on the data set</span>
<span class="sd">                if versioning was not enabled.</span>
<span class="sd">            save_version: Version string to be used for ``save`` operation if</span>
<span class="sd">                the data set is versioned. Has no effect on the data set</span>
<span class="sd">                if versioning was not enabled.</span>

<span class="sd">        Returns:</span>
<span class="sd">            An instance of an ``AbstractDataSet`` subclass.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: When the function fails to create the data set</span>
<span class="sd">                from its config.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="n">class_obj</span><span class="p">,</span> <span class="n">config</span> <span class="o">=</span> <span class="n">parse_dataset_definition</span><span class="p">(</span>
                <span class="n">config</span><span class="p">,</span> <span class="n">load_version</span><span class="p">,</span> <span class="n">save_version</span>
            <span class="p">)</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;An exception occurred when parsing config &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;for DataSet `</span><span class="si">{</span><span class="n">name</span><span class="si">}</span><span class="s2">`:</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>

        <span class="k">try</span><span class="p">:</span>
            <span class="n">data_set</span> <span class="o">=</span> <span class="n">class_obj</span><span class="p">(</span><span class="o">**</span><span class="n">config</span><span class="p">)</span>  <span class="c1"># type: ignore</span>
        <span class="k">except</span> <span class="ne">TypeError</span> <span class="k">as</span> <span class="n">err</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;</span><span class="se">\n</span><span class="si">{</span><span class="n">err</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="s2">DataSet &#39;</span><span class="si">{</span><span class="n">name</span><span class="si">}</span><span class="s2">&#39; must only contain arguments valid for the &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;constructor of `</span><span class="si">{</span><span class="n">class_obj</span><span class="o">.</span><span class="vm">__module__</span><span class="si">}</span><span class="s2">.</span><span class="si">{</span><span class="n">class_obj</span><span class="o">.</span><span class="vm">__qualname__</span><span class="si">}</span><span class="s2">`.&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">err</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">err</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;</span><span class="se">\n</span><span class="si">{</span><span class="n">err</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="s2">Failed to instantiate DataSet &#39;</span><span class="si">{</span><span class="n">name</span><span class="si">}</span><span class="s2">&#39; &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;of type `</span><span class="si">{</span><span class="n">class_obj</span><span class="o">.</span><span class="vm">__module__</span><span class="si">}</span><span class="s2">.</span><span class="si">{</span><span class="n">class_obj</span><span class="o">.</span><span class="vm">__qualname__</span><span class="si">}</span><span class="s2">`.&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">err</span>
    ...
    <span class="k">def</span> <span class="nf">load</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Any</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Loads data by delegation to the provided load method.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Data returned by the provided load method.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: When underlying load method raises error.</span>

<span class="sd">        &quot;&quot;&quot;</span>

        <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">debug</span><span class="p">(</span><span class="s2">&quot;Loading </span><span class="si">%s</span><span class="s2">&quot;</span><span class="p">,</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">))</span>
        ...
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="c1"># This exception handling is by design as the composed data sets</span>
            <span class="c1"># can throw any type of exception.</span>
            <span class="n">message</span> <span class="o">=</span> <span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Failed while loading data from data set </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="p">)</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="n">message</span><span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>

    <span class="k">def</span> <span class="nf">save</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">data</span><span class="p">:</span> <span class="n">Any</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Saves data by delegation to the provided save method.</span>

<span class="sd">        Args:</span>
<span class="sd">            data: the value to be saved by provided save method.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: when underlying save method raises error.</span>
<span class="sd">            FileNotFoundError: when save method got file instead of dir, on Windows.</span>
<span class="sd">            NotADirectoryError: when save method got file instead of dir, on Unix.</span>
<span class="sd">        &quot;&quot;&quot;</span>

        <span class="k">if</span> <span class="n">data</span> <span class="ow">is</span> <span class="kc">None</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="s2">&quot;Saving `None` to a `DataSet` is not allowed&quot;</span><span class="p">)</span>

        <span class="k">try</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">debug</span><span class="p">(</span><span class="s2">&quot;Saving </span><span class="si">%s</span><span class="s2">&quot;</span><span class="p">,</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">))</span>
        ...
        <span class="k">except</span> <span class="p">(</span><span class="ne">FileNotFoundError</span><span class="p">,</span> <span class="ne">NotADirectoryError</span><span class="p">):</span>
            <span class="k">raise</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="n">message</span> <span class="o">=</span> <span class="sa">f</span><span class="s2">&quot;Failed while saving data to data set </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="n">message</span><span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>

    <span class="k">def</span> <span class="fm">__str__</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="k">def</span> <span class="nf">_to_str</span><span class="p">(</span><span class="n">obj</span><span class="p">,</span> <span class="n">is_root</span><span class="o">=</span><span class="kc">False</span><span class="p">):</span>
            <span class="sd">&quot;&quot;&quot;Returns a string representation where</span>
<span class="sd">            1. The root level (i.e. the DataSet.__init__ arguments) are</span>
<span class="sd">            formatted like DataSet(key=value).</span>
<span class="sd">            2. Dictionaries have the keys alphabetically sorted recursively.</span>
<span class="sd">            3. None values are not shown.</span>
<span class="sd">            &quot;&quot;&quot;</span>

            <span class="n">fmt</span> <span class="o">=</span> <span class="s2">&quot;</span><span class="si">{}</span><span class="s2">=</span><span class="si">{}</span><span class="s2">&quot;</span> <span class="k">if</span> <span class="n">is_root</span> <span class="k">else</span> <span class="s2">&quot;&#39;</span><span class="si">{}</span><span class="s2">&#39;: </span><span class="si">{}</span><span class="s2">&quot;</span>  <span class="c1"># 1</span>

            <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">obj</span><span class="p">,</span> <span class="nb">dict</span><span class="p">):</span>
                <span class="n">sorted_dict</span> <span class="o">=</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">obj</span><span class="o">.</span><span class="n">items</span><span class="p">(),</span> <span class="n">key</span><span class="o">=</span><span class="k">lambda</span> <span class="n">pair</span><span class="p">:</span> <span class="nb">str</span><span class="p">(</span><span class="n">pair</span><span class="p">[</span><span class="mi">0</span><span class="p">]))</span>  <span class="c1"># 2</span>

                <span class="n">text</span> <span class="o">=</span> <span class="s2">&quot;, &quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span>
                    <span class="n">fmt</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">key</span><span class="p">,</span> <span class="n">_to_str</span><span class="p">(</span><span class="n">value</span><span class="p">))</span>  <span class="c1"># 2</span>
                    <span class="k">for</span> <span class="n">key</span><span class="p">,</span> <span class="n">value</span> <span class="ow">in</span> <span class="n">sorted_dict</span>
                    <span class="k">if</span> <span class="n">value</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span>  <span class="c1"># 3</span>
                <span class="p">)</span>

                <span class="k">return</span> <span class="n">text</span> <span class="k">if</span> <span class="n">is_root</span> <span class="k">else</span> <span class="s2">&quot;{&quot;</span> <span class="o">+</span> <span class="n">text</span> <span class="o">+</span> <span class="s2">&quot;}&quot;</span>  <span class="c1"># 1</span>

            <span class="c1"># not a dictionary</span>
            <span class="k">return</span> <span class="nb">str</span><span class="p">(</span><span class="n">obj</span><span class="p">)</span>

        <span class="k">return</span> <span class="sa">f</span><span class="s2">&quot;</span><span class="si">{</span><span class="nb">type</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="o">.</span><span class="vm">__name__</span><span class="si">}</span><span class="s2">(</span><span class="si">{</span><span class="n">_to_str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_describe</span><span class="p">(),</span> <span class="kc">True</span><span class="p">)</span><span class="si">}</span><span class="s2">)&quot;</span>

    <span class="nd">@abc</span><span class="o">.</span><span class="n">abstractmethod</span>
    <span class="k">def</span> <span class="nf">_load</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Any</span><span class="p">:</span>
        <span class="k">raise</span> <span class="ne">NotImplementedError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;`</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="vm">__class__</span><span class="o">.</span><span class="vm">__name__</span><span class="si">}</span><span class="s2">` is a subclass of AbstractDataSet and &quot;</span>
            <span class="sa">f</span><span class="s2">&quot;it must implement the `_load` method&quot;</span>
        <span class="p">)</span>

    <span class="nd">@abc</span><span class="o">.</span><span class="n">abstractmethod</span>
    <span class="k">def</span> <span class="nf">_save</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">data</span><span class="p">:</span> <span class="n">Any</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="k">raise</span> <span class="ne">NotImplementedError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;`</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="vm">__class__</span><span class="o">.</span><span class="vm">__name__</span><span class="si">}</span><span class="s2">` is a subclass of AbstractDataSet and &quot;</span>
            <span class="sa">f</span><span class="s2">&quot;it must implement the `_save` method&quot;</span>
        <span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">_describe</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
        <span class="k">raise</span> <span class="ne">NotImplementedError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;`</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="vm">__class__</span><span class="o">.</span><span class="vm">__name__</span><span class="si">}</span><span class="s2">` is a subclass of AbstractDataSet and &quot;</span>
            <span class="sa">f</span><span class="s2">&quot;it must implement the `_describe` method&quot;</span>
        <span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">exists</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Checks whether a data set&#39;s output already exists by calling</span>
<span class="sd">        the provided _exists() method.</span>

<span class="sd">        Returns:</span>
<span class="sd">            Flag indicating whether the output already exists.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: when underlying exists method raises error.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">debug</span><span class="p">(</span><span class="s2">&quot;Checking whether target of </span><span class="si">%s</span><span class="s2"> exists&quot;</span><span class="p">,</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">))</span>
            <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_exists</span><span class="p">()</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="n">message</span> <span class="o">=</span> <span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Failed during exists check for data set </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="p">)</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="n">message</span><span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>
    ...
    <span class="k">def</span> <span class="nf">_exists</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">warning</span><span class="p">(</span>
            <span class="s2">&quot;`exists()` not implemented for `</span><span class="si">%s</span><span class="s2">`. Assuming output does not exist.&quot;</span><span class="p">,</span>
            <span class="bp">self</span><span class="o">.</span><span class="vm">__class__</span><span class="o">.</span><span class="vm">__name__</span><span class="p">,</span>
        <span class="p">)</span>
        <span class="k">return</span> <span class="kc">False</span>

    <span class="k">def</span> <span class="nf">release</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Release any cached data.</span>

<span class="sd">        Raises:</span>
<span class="sd">            DataSetError: when underlying release method raises error.</span>

<span class="sd">        &quot;&quot;&quot;</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_logger</span><span class="o">.</span><span class="n">debug</span><span class="p">(</span><span class="s2">&quot;Releasing </span><span class="si">%s</span><span class="s2">&quot;</span><span class="p">,</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">))</span>
            <span class="bp">self</span><span class="o">.</span><span class="n">_release</span><span class="p">()</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="n">message</span> <span class="o">=</span> <span class="sa">f</span><span class="s2">&quot;Failed during release for data set </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="n">message</span><span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>
    ...
    <span class="k">def</span> <span class="nf">_copy</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="o">**</span><span class="n">overwrite_params</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="s2">&quot;AbstractDataSet&quot;</span><span class="p">:</span>
        <span class="n">dataset_copy</span> <span class="o">=</span> <span class="n">copy</span><span class="o">.</span><span class="n">deepcopy</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span>
        <span class="k">for</span> <span class="n">name</span><span class="p">,</span> <span class="n">value</span> <span class="ow">in</span> <span class="n">overwrite_params</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
            <span class="nb">setattr</span><span class="p">(</span><span class="n">dataset_copy</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="n">value</span><span class="p">)</span>
        <span class="k">return</span> <span class="n">dataset_copy</span>
...
<span class="k">def</span> <span class="nf">generate_timestamp</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Generate the timestamp to be used by versioning.</span>

<span class="sd">    Returns:</span>
<span class="sd">        String representation of the current timestamp.</span>

<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">current_ts</span> <span class="o">=</span> <span class="n">datetime</span><span class="o">.</span><span class="n">now</span><span class="p">(</span><span class="n">tz</span><span class="o">=</span><span class="n">timezone</span><span class="o">.</span><span class="n">utc</span><span class="p">)</span><span class="o">.</span><span class="n">strftime</span><span class="p">(</span><span class="n">VERSION_FORMAT</span><span class="p">)</span>
    <span class="k">return</span> <span class="n">current_ts</span><span class="p">[:</span><span class="o">-</span><span class="mi">4</span><span class="p">]</span> <span class="o">+</span> <span class="n">current_ts</span><span class="p">[</span><span class="o">-</span><span class="mi">1</span><span class="p">:]</span>  <span class="c1"># Don&#39;t keep microseconds</span>


<span class="k">class</span> <span class="nc">Version</span><span class="p">(</span><span class="n">namedtuple</span><span class="p">(</span><span class="s2">&quot;Version&quot;</span><span class="p">,</span> <span class="p">[</span><span class="s2">&quot;load&quot;</span><span class="p">,</span> <span class="s2">&quot;save&quot;</span><span class="p">])):</span>
    <span class="sd">&quot;&quot;&quot;This namedtuple is used to provide load and save versions for versioned</span>
<span class="sd">    data sets. If ``Version.load`` is None, then the latest available version</span>
<span class="sd">    is loaded. If ``Version.save`` is None, then save version is formatted as</span>
<span class="sd">    YYYY-MM-DDThh.mm.ss.sssZ of the current timestamp.</span>
<span class="sd">    &quot;&quot;&quot;</span>

    <span class="vm">__slots__</span> <span class="o">=</span> <span class="p">()</span>


<span class="n">_CONSISTENCY_WARNING</span> <span class="o">=</span> <span class="p">(</span>
    <span class="s2">&quot;Save version `</span><span class="si">{}</span><span class="s2">` did not match load version `</span><span class="si">{}</span><span class="s2">` for </span><span class="si">{}</span><span class="s2">. This is strongly &quot;</span>
    <span class="s2">&quot;discouraged due to inconsistencies it may cause between `save` and &quot;</span>
    <span class="s2">&quot;`load` operations. Please refrain from setting exact load version for &quot;</span>
    <span class="s2">&quot;intermediate data sets where possible to avoid this warning.&quot;</span>
<span class="p">)</span>

<span class="n">_DEFAULT_PACKAGES</span> <span class="o">=</span> <span class="p">[</span><span class="s2">&quot;kedro.io.&quot;</span><span class="p">,</span> <span class="s2">&quot;kedro.extras.datasets.&quot;</span><span class="p">,</span> <span class="s2">&quot;&quot;</span><span class="p">]</span>


<span class="k">def</span> <span class="nf">parse_dataset_definition</span><span class="p">(</span>
    <span class="n">config</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">],</span> <span class="n">load_version</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span> <span class="n">save_version</span><span class="p">:</span> <span class="nb">str</span> <span class="o">=</span> <span class="kc">None</span>
<span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Tuple</span><span class="p">[</span><span class="n">Type</span><span class="p">[</span><span class="n">AbstractDataSet</span><span class="p">],</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]]:</span>
    <span class="sd">&quot;&quot;&quot;Parse and instantiate a dataset class using the configuration provided.</span>

<span class="sd">    Args:</span>
<span class="sd">        config: Data set config dictionary. It *must* contain the `type` key</span>
<span class="sd">            with fully qualified class name.</span>
<span class="sd">        load_version: Version string to be used for ``load`` operation if</span>
<span class="sd">                the data set is versioned. Has no effect on the data set</span>
<span class="sd">                if versioning was not enabled.</span>
<span class="sd">        save_version: Version string to be used for ``save`` operation if</span>
...
<span class="sd">    Raises:</span>
<span class="sd">        DataSetError: If the function fails to parse the configuration provided.</span>

<span class="sd">    Returns:</span>
<span class="sd">        2-tuple: (Dataset class object, configuration dictionary)</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">save_version</span> <span class="o">=</span> <span class="n">save_version</span> <span class="ow">or</span> <span class="n">generate_timestamp</span><span class="p">()</span>
    ...
    <span class="k">if</span> <span class="s2">&quot;type&quot;</span> <span class="ow">not</span> <span class="ow">in</span> <span class="n">config</span><span class="p">:</span>
        <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="s2">&quot;`type` is missing from DataSet catalog configuration&quot;</span><span class="p">)</span>

    <span class="n">class_obj</span> <span class="o">=</span> <span class="n">config</span><span class="o">.</span><span class="n">pop</span><span class="p">(</span><span class="s2">&quot;type&quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="nb">isinstance</span><span class="p">(</span><span class="n">class_obj</span><span class="p">,</span> <span class="nb">str</span><span class="p">):</span>
        <span class="k">if</span> <span class="nb">len</span><span class="p">(</span><span class="n">class_obj</span><span class="o">.</span><span class="n">strip</span><span class="p">(</span><span class="s2">&quot;.&quot;</span><span class="p">))</span> <span class="o">!=</span> <span class="nb">len</span><span class="p">(</span><span class="n">class_obj</span><span class="p">):</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="s2">&quot;`type` class path does not support relative &quot;</span>
                <span class="s2">&quot;paths or paths ending with a dot.&quot;</span>
            <span class="p">)</span>
        <span class="n">class_paths</span> <span class="o">=</span> <span class="p">(</span><span class="n">prefix</span> <span class="o">+</span> <span class="n">class_obj</span> <span class="k">for</span> <span class="n">prefix</span> <span class="ow">in</span> <span class="n">_DEFAULT_PACKAGES</span><span class="p">)</span>

        <span class="n">trials</span> <span class="o">=</span> <span class="p">(</span><span class="n">_load_obj</span><span class="p">(</span><span class="n">class_path</span><span class="p">)</span> <span class="k">for</span> <span class="n">class_path</span> <span class="ow">in</span> <span class="n">class_paths</span><span class="p">)</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="n">class_obj</span> <span class="o">=</span> <span class="nb">next</span><span class="p">(</span><span class="n">obj</span> <span class="k">for</span> <span class="n">obj</span> <span class="ow">in</span> <span class="n">trials</span> <span class="k">if</span> <span class="n">obj</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">)</span>
        <span class="k">except</span> <span class="ne">StopIteration</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Class `</span><span class="si">{</span><span class="n">class_obj</span><span class="si">}</span><span class="s2">` not found or one of its dependencies &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;has not been installed.&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>

    <span class="k">if</span> <span class="ow">not</span> <span class="nb">issubclass</span><span class="p">(</span><span class="n">class_obj</span><span class="p">,</span> <span class="n">AbstractDataSet</span><span class="p">):</span>
        <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
            <span class="sa">f</span><span class="s2">&quot;DataSet type `</span><span class="si">{</span><span class="n">class_obj</span><span class="o">.</span><span class="vm">__module__</span><span class="si">}</span><span class="s2">.</span><span class="si">{</span><span class="n">class_obj</span><span class="o">.</span><span class="vm">__qualname__</span><span class="si">}</span><span class="s2">` &quot;</span>
            <span class="sa">f</span><span class="s2">&quot;is invalid: all data set types must extend `AbstractDataSet`.&quot;</span>
        <span class="p">)</span>

    <span class="k">if</span> <span class="n">VERSION_KEY</span> <span class="ow">in</span> <span class="n">config</span><span class="p">:</span>
        <span class="c1"># remove &quot;version&quot; key so that it&#39;s not passed</span>
        <span class="c1"># to the &quot;unversioned&quot; data set constructor</span>
        <span class="n">message</span> <span class="o">=</span> <span class="p">(</span>
            <span class="s2">&quot;`</span><span class="si">%s</span><span class="s2">` attribute removed from data set configuration since it is a &quot;</span>
            <span class="s2">&quot;reserved word and cannot be directly specified&quot;</span>
        <span class="p">)</span>
        <span class="n">logging</span><span class="o">.</span><span class="n">getLogger</span><span class="p">(</span><span class="vm">__name__</span><span class="p">)</span><span class="o">.</span><span class="n">warning</span><span class="p">(</span><span class="n">message</span><span class="p">,</span> <span class="n">VERSION_KEY</span><span class="p">)</span>
        <span class="k">del</span> <span class="n">config</span><span class="p">[</span><span class="n">VERSION_KEY</span><span class="p">]</span>

    <span class="c1"># dataset is either versioned explicitly by the user or versioned is set to true by default</span>
    <span class="c1"># on the dataset</span>
    <span class="k">if</span> <span class="n">config</span><span class="o">.</span><span class="n">pop</span><span class="p">(</span><span class="n">VERSIONED_FLAG_KEY</span><span class="p">,</span> <span class="kc">False</span><span class="p">)</span> <span class="ow">or</span> <span class="nb">getattr</span><span class="p">(</span>
        <span class="n">class_obj</span><span class="p">,</span> <span class="n">VERSIONED_FLAG_KEY</span><span class="p">,</span> <span class="kc">False</span>
    <span class="p">):</span>
        <span class="n">config</span><span class="p">[</span><span class="n">VERSION_KEY</span><span class="p">]</span> <span class="o">=</span> <span class="n">Version</span><span class="p">(</span><span class="n">load_version</span><span class="p">,</span> <span class="n">save_version</span><span class="p">)</span>

    <span class="k">return</span> <span class="n">class_obj</span><span class="p">,</span> <span class="n">config</span>


<span class="k">def</span> <span class="nf">_load_obj</span><span class="p">(</span><span class="n">class_path</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">object</span><span class="p">]:</span>
    <span class="n">mod_path</span><span class="p">,</span> <span class="n">_</span><span class="p">,</span> <span class="n">class_name</span> <span class="o">=</span> <span class="n">class_path</span><span class="o">.</span><span class="n">rpartition</span><span class="p">(</span><span class="s2">&quot;.&quot;</span><span class="p">)</span>
    <span class="k">try</span><span class="p">:</span>
        <span class="n">available_classes</span> <span class="o">=</span> <span class="n">load_obj</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;</span><span class="si">{</span><span class="n">mod_path</span><span class="si">}</span><span class="s2">.__all__&quot;</span><span class="p">)</span>
    <span class="c1"># ModuleNotFoundError: When `load_obj` can&#39;t find `mod_path` (e.g `kedro.io.pandas`)</span>
    <span class="c1">#                      this is because we try a combination of all prefixes.</span>
    <span class="c1"># AttributeError: When `load_obj` manages to load `mod_path` but it doesn&#39;t have an</span>
    <span class="c1">#                 `__all__` attribute -- either because it&#39;s a custom or a kedro.io dataset</span>
    <span class="k">except</span> <span class="p">(</span><span class="ne">ModuleNotFoundError</span><span class="p">,</span> <span class="ne">AttributeError</span><span class="p">,</span> <span class="ne">ValueError</span><span class="p">):</span>
        <span class="n">available_classes</span> <span class="o">=</span> <span class="kc">None</span>

    <span class="k">try</span><span class="p">:</span>
        <span class="n">class_obj</span> <span class="o">=</span> <span class="n">load_obj</span><span class="p">(</span><span class="n">class_path</span><span class="p">)</span>
    ...
    <span class="k">except</span> <span class="ne">AttributeError</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>
        <span class="k">if</span> <span class="n">available_classes</span> <span class="ow">and</span> <span class="n">class_name</span> <span class="ow">in</span> <span class="n">available_classes</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;</span><span class="si">{</span><span class="n">exc</span><span class="si">}</span><span class="s2"> Please see the documentation on how to &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;install relevant dependencies for </span><span class="si">{</span><span class="n">class_path</span><span class="si">}</span><span class="s2">:</span><span class="se">\n</span><span class="s2">&quot;</span>
                <span class="sa">f</span><span class="s2">&quot;https://kedro.readthedocs.io/en/stable/&quot;</span>
                <span class="sa">f</span><span class="s2">&quot;04_kedro_project_setup/01_dependencies.html&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span>
        <span class="k">return</span> <span class="kc">None</span>

    <span class="k">return</span> <span class="n">class_obj</span>


<span class="k">def</span> <span class="nf">_local_exists</span><span class="p">(</span><span class="n">filepath</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>  <span class="c1"># SKIP_IF_NO_SPARK</span>
    ...
    <span class="k">return</span> <span class="n">filepath</span><span class="o">.</span><span class="n">exists</span><span class="p">()</span> <span class="ow">or</span> <span class="nb">any</span><span class="p">(</span><span class="n">par</span><span class="o">.</span><span class="n">is_file</span><span class="p">()</span> <span class="k">for</span> <span class="n">par</span> <span class="ow">in</span> <span class="n">filepath</span><span class="o">.</span><span class="n">parents</span><span class="p">)</span>


<div class="viewcode-block" id="AbstractVersionedDataSet"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet">[docs]</a><span class="k">class</span> <span class="nc">AbstractVersionedDataSet</span><span class="p">(</span><span class="n">AbstractDataSet</span><span class="p">,</span> <span class="n">abc</span><span class="o">.</span><span class="n">ABC</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;</span>
<span class="sd">    ``AbstractVersionedDataSet`` is the base class for all versioned data set</span>
<span class="sd">    implementations. All data sets that implement versioning should extend this</span>
<span class="sd">    abstract class and implement the methods marked as abstract.</span>
...
<span class="sd">        &gt;&gt;&gt; from pathlib import Path, PurePosixPath</span>
<span class="sd">        &gt;&gt;&gt; import pandas as pd</span>
<span class="sd">        &gt;&gt;&gt; from kedro.io import AbstractVersionedDataSet</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt; class MyOwnDataSet(AbstractVersionedDataSet):</span>
<span class="sd">        &gt;&gt;&gt;     def __init__(self, filepath, version, param1, param2=True):</span>
<span class="sd">        &gt;&gt;&gt;         super().__init__(PurePosixPath(filepath), version)</span>
<span class="sd">        &gt;&gt;&gt;         self._param1 = param1</span>
<span class="sd">        &gt;&gt;&gt;         self._param2 = param2</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _load(self) -&gt; pd.DataFrame:</span>
<span class="sd">        &gt;&gt;&gt;         load_path = self._get_load_path()</span>
<span class="sd">        &gt;&gt;&gt;         return pd.read_csv(load_path)</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _save(self, df: pd.DataFrame) -&gt; None:</span>
<span class="sd">        &gt;&gt;&gt;         save_path = self._get_save_path()</span>
<span class="sd">        &gt;&gt;&gt;         df.to_csv(str(save_path))</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _exists(self) -&gt; bool:</span>
<span class="sd">        &gt;&gt;&gt;         path = self._get_load_path()</span>
<span class="sd">        &gt;&gt;&gt;         return Path(path.as_posix()).exists()</span>
<span class="sd">        &gt;&gt;&gt;</span>
<span class="sd">        &gt;&gt;&gt;     def _describe(self):</span>
<span class="sd">        &gt;&gt;&gt;         return dict(version=self._version, param1=self._param1, param2=self._param2)</span>
...
<span class="sd">            type: &lt;path-to-my-own-dataset&gt;.MyOwnDataSet</span>
<span class="sd">            filepath: data/01_raw/my_data.csv</span>
<span class="sd">            versioned: true</span>
<span class="sd">            param1: &lt;param1-value&gt; # param1 is a required argument</span>
<span class="sd">            # param2 will be True by default</span>
<span class="sd">    &quot;&quot;&quot;</span>

<div class="viewcode-block" id="AbstractVersionedDataSet.__init__"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet.__init__">[docs]</a>    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span>
        <span class="bp">self</span><span class="p">,</span>
        <span class="n">filepath</span><span class="p">:</span> <span class="n">PurePosixPath</span><span class="p">,</span>
        <span class="n">version</span><span class="p">:</span> <span class="n">Optional</span><span class="p">[</span><span class="n">Version</span><span class="p">],</span>
        <span class="n">exists_function</span><span class="p">:</span> <span class="n">Callable</span><span class="p">[[</span><span class="nb">str</span><span class="p">],</span> <span class="nb">bool</span><span class="p">]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
        <span class="n">glob_function</span><span class="p">:</span> <span class="n">Callable</span><span class="p">[[</span><span class="nb">str</span><span class="p">],</span> <span class="n">List</span><span class="p">[</span><span class="nb">str</span><span class="p">]]</span> <span class="o">=</span> <span class="kc">None</span><span class="p">,</span>
    <span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Creates a new instance of ``AbstractVersionedDataSet``.</span>

<span class="sd">        Args:</span>
<span class="sd">            filepath: Filepath in POSIX format to a file.</span>
<span class="sd">            version: If specified, should be an instance of</span>
<span class="sd">                ``kedro.io.core.Version``. If its ``load`` attribute is</span>
<span class="sd">                None, the latest version will be loaded. If its ``save``</span>
<span class="sd">                attribute is None, save version will be autogenerated.</span>
<span class="sd">            exists_function: Function that is used for determining whether</span>
<span class="sd">                a path exists in a filesystem.</span>
<span class="sd">            glob_function: Function that is used for finding all paths</span>
<span class="sd">                in a filesystem, which match a given pattern.</span>
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">_exists_function</span> <span class="o">=</span> <span class="n">exists_function</span> <span class="ow">or</span> <span class="n">_local_exists</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_glob_function</span> <span class="o">=</span> <span class="n">glob_function</span> <span class="ow">or</span> <span class="n">iglob</span>
        <span class="c1"># 1 entry for load version, 1 for save version</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_version_cache</span> <span class="o">=</span> <span class="n">Cache</span><span class="p">(</span><span class="n">maxsize</span><span class="o">=</span><span class="mi">2</span><span class="p">)</span></div>

    <span class="c1"># &#39;key&#39; is set to prevent cache key overlapping for load and save:</span>
    <span class="c1"># https://cachetools.readthedocs.io/en/stable/#cachetools.cachedmethod</span>
    <span class="nd">@cachedmethod</span><span class="p">(</span><span class="n">cache</span><span class="o">=</span><span class="n">attrgetter</span><span class="p">(</span><span class="s2">&quot;_version_cache&quot;</span><span class="p">),</span> <span class="n">key</span><span class="o">=</span><span class="n">partial</span><span class="p">(</span><span class="n">hashkey</span><span class="p">,</span> <span class="s2">&quot;load&quot;</span><span class="p">))</span>
    <span class="k">def</span> <span class="nf">_fetch_latest_load_version</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
        <span class="c1"># When load version is unpinned, fetch the most recent existing</span>
        <span class="c1"># version from the given path.</span>
        <span class="n">pattern</span> <span class="o">=</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_get_versioned_path</span><span class="p">(</span><span class="s2">&quot;*&quot;</span><span class="p">))</span>
        <span class="n">version_paths</span> <span class="o">=</span> <span class="nb">sorted</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">_glob_function</span><span class="p">(</span><span class="n">pattern</span><span class="p">),</span> <span class="n">reverse</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
        <span class="n">most_recent</span> <span class="o">=</span> <span class="nb">next</span><span class="p">(</span>
            <span class="p">(</span><span class="n">path</span> <span class="k">for</span> <span class="n">path</span> <span class="ow">in</span> <span class="n">version_paths</span> <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_exists_function</span><span class="p">(</span><span class="n">path</span><span class="p">)),</span> <span class="kc">None</span>
        <span class="p">)</span>

        <span class="k">if</span> <span class="ow">not</span> <span class="n">most_recent</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">VersionNotFoundError</span><span class="p">(</span><span class="sa">f</span><span class="s2">&quot;Did not find any versions for </span><span class="si">{</span><span class="bp">self</span><span class="si">}</span><span class="s2">&quot;</span><span class="p">)</span>

        <span class="k">return</span> <span class="n">PurePath</span><span class="p">(</span><span class="n">most_recent</span><span class="p">)</span><span class="o">.</span><span class="n">parent</span><span class="o">.</span><span class="n">name</span>

    <span class="c1"># &#39;key&#39; is set to prevent cache key overlapping for load and save:</span>
    <span class="c1"># https://cachetools.readthedocs.io/en/stable/#cachetools.cachedmethod</span>
    <span class="nd">@cachedmethod</span><span class="p">(</span><span class="n">cache</span><span class="o">=</span><span class="n">attrgetter</span><span class="p">(</span><span class="s2">&quot;_version_cache&quot;</span><span class="p">),</span> <span class="n">key</span><span class="o">=</span><span class="n">partial</span><span class="p">(</span><span class="n">hashkey</span><span class="p">,</span> <span class="s2">&quot;save&quot;</span><span class="p">))</span>
    <span class="k">def</span> <span class="nf">_fetch_latest_save_version</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>  <span class="c1"># pylint: disable=no-self-use</span>
        <span class="sd">&quot;&quot;&quot;Generate and cache the current save version&quot;&quot;&quot;</span>
        <span class="k">return</span> <span class="n">generate_timestamp</span><span class="p">()</span>

<div class="viewcode-block" id="AbstractVersionedDataSet.resolve_load_version"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet.resolve_load_version">[docs]</a>    <span class="k">def</span> <span class="nf">resolve_load_version</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">str</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Compute the version the dataset should be loaded with.&quot;&quot;&quot;</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="p">:</span>
            <span class="k">return</span> <span class="kc">None</span>
        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="o">.</span><span class="n">load</span><span class="p">:</span>
            <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="o">.</span><span class="n">load</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_fetch_latest_load_version</span><span class="p">()</span></div>

    <span class="k">def</span> <span class="nf">_get_load_path</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">PurePosixPath</span><span class="p">:</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="p">:</span>
            <span class="c1"># When versioning is disabled, load from original filepath</span>
            <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span>

        <span class="n">load_version</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">resolve_load_version</span><span class="p">()</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_versioned_path</span><span class="p">(</span><span class="n">load_version</span><span class="p">)</span>  <span class="c1"># type: ignore</span>

<div class="viewcode-block" id="AbstractVersionedDataSet.resolve_save_version"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet.resolve_save_version">[docs]</a>    <span class="k">def</span> <span class="nf">resolve_save_version</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Optional</span><span class="p">[</span><span class="nb">str</span><span class="p">]:</span>
        <span class="sd">&quot;&quot;&quot;Compute the version the dataset should be saved with.&quot;&quot;&quot;</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="p">:</span>
            <span class="k">return</span> <span class="kc">None</span>
        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="o">.</span><span class="n">save</span><span class="p">:</span>
            <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="o">.</span><span class="n">save</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_fetch_latest_save_version</span><span class="p">()</span></div>

    <span class="k">def</span> <span class="nf">_get_save_path</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">PurePosixPath</span><span class="p">:</span>
        <span class="k">if</span> <span class="ow">not</span> <span class="bp">self</span><span class="o">.</span><span class="n">_version</span><span class="p">:</span>
            <span class="c1"># When versioning is disabled, return original filepath</span>
            <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span>

        <span class="n">save_version</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">resolve_save_version</span><span class="p">()</span>
        <span class="n">versioned_path</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_versioned_path</span><span class="p">(</span><span class="n">save_version</span><span class="p">)</span>  <span class="c1"># type: ignore</span>

        <span class="k">if</span> <span class="bp">self</span><span class="o">.</span><span class="n">_exists_function</span><span class="p">(</span><span class="nb">str</span><span class="p">(</span><span class="n">versioned_path</span><span class="p">)):</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Save path `</span><span class="si">{</span><span class="n">versioned_path</span><span class="si">}</span><span class="s2">` for </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="si">}</span><span class="s2"> must not exist if &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;versioning is enabled.&quot;</span>
            <span class="p">)</span>

        <span class="k">return</span> <span class="n">versioned_path</span>

    <span class="k">def</span> <span class="nf">_get_versioned_path</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">version</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">PurePosixPath</span><span class="p">:</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span> <span class="o">/</span> <span class="n">version</span> <span class="o">/</span> <span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span><span class="o">.</span><span class="n">name</span>

<div class="viewcode-block" id="AbstractVersionedDataSet.load"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet.load">[docs]</a>    <span class="k">def</span> <span class="nf">load</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Any</span><span class="p">:</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">resolve_load_version</span><span class="p">()</span>  <span class="c1"># Make sure last load version is set</span>
...
<div class="viewcode-block" id="AbstractVersionedDataSet.save"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet.save">[docs]</a>    <span class="k">def</span> <span class="nf">save</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">data</span><span class="p">:</span> <span class="n">Any</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_version_cache</span><span class="o">.</span><span class="n">clear</span><span class="p">()</span>
        <span class="n">save_version</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">resolve_save_version</span><span class="p">()</span>  <span class="c1"># Make sure last save version is set</span>
        <span class="k">try</span><span class="p">:</span>
            <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="n">data</span><span class="p">)</span>
        <span class="k">except</span> <span class="p">(</span><span class="ne">FileNotFoundError</span><span class="p">,</span> <span class="ne">NotADirectoryError</span><span class="p">)</span> <span class="k">as</span> <span class="n">err</span><span class="p">:</span>
            <span class="c1"># FileNotFoundError raised in Win, NotADirectoryError raised in Unix</span>
            <span class="n">_default_version</span> <span class="o">=</span> <span class="s2">&quot;YYYY-MM-DDThh.mm.ss.sssZ&quot;</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Cannot save versioned dataset `</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span><span class="o">.</span><span class="n">name</span><span class="si">}</span><span class="s2">` to &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;`</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span><span class="o">.</span><span class="n">parent</span><span class="o">.</span><span class="n">as_posix</span><span class="p">()</span><span class="si">}</span><span class="s2">` because a file with the same &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;name already exists in the directory. This is likely because &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;versioning was enabled on a dataset already saved previously. Either &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;remove `</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span><span class="o">.</span><span class="n">name</span><span class="si">}</span><span class="s2">` from the directory or manually &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;convert it into a versioned dataset by placing it in a versioned &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;directory (e.g. with default versioning format &quot;</span>
                <span class="sa">f</span><span class="s2">&quot;`</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span><span class="o">.</span><span class="n">as_posix</span><span class="p">()</span><span class="si">}</span><span class="s2">/</span><span class="si">{</span><span class="n">_default_version</span><span class="si">}</span><span class="s2">/</span><span class="si">{</span><span class="bp">self</span><span class="o">.</span><span class="n">_filepath</span><span class="o">.</span><span class="n">name</span><span class="si">}</span><span class="s2">&quot;</span>
                <span class="sa">f</span><span class="s2">&quot;`).&quot;</span>
            <span class="p">)</span> <span class="kn">from</span> <span class="nn">err</span>

        <span class="n">load_version</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">resolve_load_version</span><span class="p">()</span>
        <span class="k">if</span> <span class="n">load_version</span> <span class="o">!=</span> <span class="n">save_version</span><span class="p">:</span>
            <span class="n">warnings</span><span class="o">.</span><span class="n">warn</span><span class="p">(</span>
                <span class="n">_CONSISTENCY_WARNING</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">save_version</span><span class="p">,</span> <span class="n">load_version</span><span class="p">,</span> <span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">))</span>
            <span class="p">)</span></div>

<div class="viewcode-block" id="AbstractVersionedDataSet.exists"><a class="viewcode-back" href="../../../kedro.io.AbstractVersionedDataSet.html#kedro.io.AbstractVersionedDataSet.exists">[docs]</a>    <span class="k">def</span> <span class="nf">exists</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
        <span class="sd">&quot;&quot;&quot;Checks whether a data set&#39;s output already exists by calling</span>
<span class="sd">        the provided _exists() method.</span>
...
<span class="sd">        &quot;&quot;&quot;</span>
        ...
        <span class="k">try</span><span class="p">:</span>
            <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">_exists</span><span class="p">()</span>
        <span class="k">except</span> <span class="n">VersionNotFoundError</span><span class="p">:</span>
            <span class="k">return</span> <span class="kc">False</span>
        <span class="k">except</span> <span class="ne">Exception</span> <span class="k">as</span> <span class="n">exc</span><span class="p">:</span>  <span class="c1"># SKIP_IF_NO_SPARK</span>
            <span class="n">message</span> <span class="o">=</span> <span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Failed during exists check for data set </span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span><span class="si">}</span><span class="s2">.</span><span class="se">\n</span><span class="si">{</span><span class="nb">str</span><span class="p">(</span><span class="n">exc</span><span class="p">)</span><span class="si">}</span><span class="s2">&quot;</span>
            <span class="p">)</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span><span class="n">message</span><span class="p">)</span> <span class="kn">from</span> <span class="nn">exc</span></div>

    <span class="k">def</span> <span class="nf">_release</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="n">_release</span><span class="p">()</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">_version_cache</span><span class="o">.</span><span class="n">clear</span><span class="p">()</span></div>


<span class="k">def</span> <span class="nf">_parse_filepath</span><span class="p">(</span><span class="n">filepath</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="nb">str</span><span class="p">]:</span>
    <span class="sd">&quot;&quot;&quot;Split filepath on protocol and path. Based on `fsspec.utils.infer_storage_options`.</span>

<span class="sd">    Args:</span>
<span class="sd">        filepath: Either local absolute file path or URL (s3://bucket/file.csv)</span>

<span class="sd">    Returns:</span>
<span class="sd">        Parsed filepath.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">if</span> <span class="p">(</span>
        <span class="n">re</span><span class="o">.</span><span class="n">match</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;^[a-zA-Z]:[</span><span class="se">\\</span><span class="s2">/]&quot;</span><span class="p">,</span> <span class="n">filepath</span><span class="p">)</span>
        <span class="ow">or</span> <span class="n">re</span><span class="o">.</span><span class="n">match</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;^[a-zA-Z0-9]+://&quot;</span><span class="p">,</span> <span class="n">filepath</span><span class="p">)</span> <span class="ow">is</span> <span class="kc">None</span>
    <span class="p">):</span>
        <span class="k">return</span> <span class="p">{</span><span class="s2">&quot;protocol&quot;</span><span class="p">:</span> <span class="s2">&quot;file&quot;</span><span class="p">,</span> <span class="s2">&quot;path&quot;</span><span class="p">:</span> <span class="n">filepath</span><span class="p">}</span>

    <span class="n">parsed_path</span> <span class="o">=</span> <span class="n">urlsplit</span><span class="p">(</span><span class="n">filepath</span><span class="p">)</span>
    <span class="n">protocol</span> <span class="o">=</span> <span class="n">parsed_path</span><span class="o">.</span><span class="n">scheme</span> <span class="ow">or</span> <span class="s2">&quot;file&quot;</span>

    <span class="k">if</span> <span class="n">protocol</span> <span class="ow">in</span> <span class="n">HTTP_PROTOCOLS</span><span class="p">:</span>
        <span class="k">return</span> <span class="p">{</span><span class="s2">&quot;protocol&quot;</span><span class="p">:</span> <span class="n">protocol</span><span class="p">,</span> <span class="s2">&quot;path&quot;</span><span class="p">:</span> <span class="n">filepath</span><span class="p">}</span>

    <span class="n">path</span> <span class="o">=</span> <span class="n">parsed_path</span><span class="o">.</span><span class="n">path</span>
    <span class="k">if</span> <span class="n">protocol</span> <span class="o">==</span> <span class="s2">&quot;file&quot;</span><span class="p">:</span>
        <span class="n">windows_path</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">match</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;^/([a-zA-Z])[:|]([</span><span class="se">\\</span><span class="s2">/].*)$&quot;</span><span class="p">,</span> <span class="n">path</span><span class="p">)</span>
        <span class="k">if</span> <span class="n">windows_path</span><span class="p">:</span>
            <span class="n">path</span> <span class="o">=</span> <span class="s2">&quot;:&quot;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">windows_path</span><span class="o">.</span><span class="n">groups</span><span class="p">())</span>

    <span class="n">options</span> <span class="o">=</span> <span class="p">{</span><span class="s2">&quot;protocol&quot;</span><span class="p">:</span> <span class="n">protocol</span><span class="p">,</span> <span class="s2">&quot;path&quot;</span><span class="p">:</span> <span class="n">path</span><span class="p">}</span>

    <span class="k">if</span> <span class="n">parsed_path</span><span class="o">.</span><span class="n">netloc</span><span class="p">:</span>
        <span class="k">if</span> <span class="n">protocol</span> <span class="ow">in</span> <span class="n">CLOUD_PROTOCOLS</span><span class="p">:</span>
            <span class="n">host_with_port</span> <span class="o">=</span> <span class="n">parsed_path</span><span class="o">.</span><span class="n">netloc</span><span class="o">.</span><span class="n">rsplit</span><span class="p">(</span><span class="s2">&quot;@&quot;</span><span class="p">,</span> <span class="mi">1</span><span class="p">)[</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>
            <span class="n">host</span> <span class="o">=</span> <span class="n">host_with_port</span><span class="o">.</span><span class="n">rsplit</span><span class="p">(</span><span class="s2">&quot;:&quot;</span><span class="p">,</span> <span class="mi">1</span><span class="p">)[</span><span class="mi">0</span><span class="p">]</span>
            <span class="n">options</span><span class="p">[</span><span class="s2">&quot;path&quot;</span><span class="p">]</span> <span class="o">=</span> <span class="n">host</span> <span class="o">+</span> <span class="n">options</span><span class="p">[</span><span class="s2">&quot;path&quot;</span><span class="p">]</span>

    <span class="k">return</span> <span class="n">options</span>


<span class="k">def</span> <span class="nf">get_protocol_and_path</span><span class="p">(</span><span class="n">filepath</span><span class="p">:</span> <span class="nb">str</span><span class="p">,</span> <span class="n">version</span><span class="p">:</span> <span class="n">Version</span> <span class="o">=</span> <span class="kc">None</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">Tuple</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="nb">str</span><span class="p">]:</span>
    <span class="sd">&quot;&quot;&quot;Parses filepath on protocol and path.</span>

<span class="sd">    Args:</span>
<span class="sd">        filepath: raw filepath e.g.: `gcs://bucket/test.json`.</span>
<span class="sd">        version: instance of ``kedro.io.core.Version`` or None.</span>

<span class="sd">    Returns:</span>
<span class="sd">        Protocol and path.</span>

<span class="sd">    Raises:</span>
<span class="sd">        DataSetError: when protocol is http(s) and version is not None.</span>
<span class="sd">        Note: HTTP(s) dataset doesn&#39;t support versioning.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">options_dict</span> <span class="o">=</span> <span class="n">_parse_filepath</span><span class="p">(</span><span class="n">filepath</span><span class="p">)</span>
    <span class="n">path</span> <span class="o">=</span> <span class="n">options_dict</span><span class="p">[</span><span class="s2">&quot;path&quot;</span><span class="p">]</span>
    <span class="n">protocol</span> <span class="o">=</span> <span class="n">options_dict</span><span class="p">[</span><span class="s2">&quot;protocol&quot;</span><span class="p">]</span>
    ...
    <span class="k">if</span> <span class="n">protocol</span> <span class="ow">in</span> <span class="n">HTTP_PROTOCOLS</span><span class="p">:</span>
        <span class="k">if</span> <span class="n">version</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="s2">&quot;HTTP(s) DataSet doesn&#39;t support versioning. &quot;</span>
                <span class="s2">&quot;Please remove version flag from the dataset configuration.&quot;</span>
            <span class="p">)</span>
        <span class="n">path</span> <span class="o">=</span> <span class="n">path</span><span class="o">.</span><span class="n">split</span><span class="p">(</span><span class="n">PROTOCOL_DELIMITER</span><span class="p">,</span> <span class="mi">1</span><span class="p">)[</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>

    <span class="k">return</span> <span class="n">protocol</span><span class="p">,</span> <span class="n">path</span>


<span class="k">def</span> <span class="nf">get_filepath_str</span><span class="p">(</span><span class="n">path</span><span class="p">:</span> <span class="n">PurePath</span><span class="p">,</span> <span class="n">protocol</span><span class="p">:</span> <span class="nb">str</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Returns filepath. Returns full filepath (with protocol) if protocol is HTTP(s).</span>

<span class="sd">    Args:</span>
<span class="sd">        path: filepath without protocol.</span>
<span class="sd">        protocol: protocol.</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">if</span> <span class="n">protocol</span> <span class="ow">in</span> <span class="n">HTTP_PROTOCOLS</span><span class="p">:</span>
        <span class="n">path</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span><span class="o">.</span><span class="n">join</span><span class="p">((</span><span class="n">protocol</span><span class="p">,</span> <span class="n">PROTOCOL_DELIMITER</span><span class="p">,</span> <span class="n">path</span><span class="p">))</span>
    <span class="k">return</span> <span class="n">path</span>


<span class="k">def</span> <span class="nf">validate_on_forbidden_chars</span><span class="p">(</span><span class="o">**</span><span class="n">kwargs</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;Validate that string values do not include white-spaces or ;&quot;&quot;&quot;</span>
    <span class="k">for</span> <span class="n">key</span><span class="p">,</span> <span class="n">value</span> <span class="ow">in</span> <span class="n">kwargs</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
        <span class="k">if</span> <span class="s2">&quot; &quot;</span> <span class="ow">in</span> <span class="n">value</span> <span class="ow">or</span> <span class="s2">&quot;;&quot;</span> <span class="ow">in</span> <span class="n">value</span><span class="p">:</span>
            <span class="k">raise</span> <span class="n">DataSetError</span><span class="p">(</span>
                <span class="sa">f</span><span class="s2">&quot;Neither white-space nor semicolon are allowed in `</span><span class="si">{</span><span class="n">key</span><span class="si">}</span><span class="s2">`.&quot;</span>
            <span class="p">)</span>
</pre></div>
