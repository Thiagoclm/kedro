...
<head>
  ...
  <title>The Data Catalog &mdash; Kedro 0.17.7 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/css/theme-overrides.css" type="text/css" />
    ...
    <link rel="next" title="Kedro IO" href="02_kedro_io.html" />
    <link rel="prev" title="The mini-kedro Kedro starter" href="../04_kedro_project_setup/04_mini_kedro.html" />
...
<ul class="current">
<li class="toctree-l1 current"><a class="current reference internal" href="#">The Data Catalog</a><ul>
<li class="toctree-l2"><a class="reference internal" href="#using-the-data-catalog-within-kedro-configuration">Using the Data Catalog within Kedro configuration</a></li>
<li class="toctree-l2"><a class="reference internal" href="#specifying-the-location-of-the-dataset">Specifying the location of the dataset</a></li>
<li class="toctree-l2"><a class="reference internal" href="#data-catalog-args-parameters">Data Catalog <code class="docutils literal notranslate"><span class="pre">*_args</span></code> parameters</a></li>
<li class="toctree-l2"><a class="reference internal" href="#using-the-data-catalog-with-the-yaml-api">Using the Data Catalog with the YAML API</a></li>
<li class="toctree-l2"><a class="reference internal" href="#creating-a-data-catalog-yaml-configuration-file-via-cli">Creating a Data Catalog YAML configuration file via CLI</a></li>
<li class="toctree-l2"><a class="reference internal" href="#adding-parameters">Adding parameters</a></li>
<li class="toctree-l2"><a class="reference internal" href="#feeding-in-credentials">Feeding in credentials</a></li>
<li class="toctree-l2"><a class="reference internal" href="#loading-multiple-datasets-that-have-similar-configuration">Loading multiple datasets that have similar configuration</a></li>
<li class="toctree-l2"><a class="reference internal" href="#transcoding-datasets">Transcoding datasets</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#a-typical-example-of-transcoding">A typical example of transcoding</a></li>
<li class="toctree-l3"><a class="reference internal" href="#how-does-transcoding-work">How does transcoding work?</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="#transforming-datasets">Transforming datasets</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#applying-built-in-transformers">Applying built-in transformers</a></li>
<li class="toctree-l3"><a class="reference internal" href="#transformer-scope">Transformer scope</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="#versioning-datasets-and-ml-models">Versioning datasets and ML models</a></li>
<li class="toctree-l2"><a class="reference internal" href="#using-the-data-catalog-with-the-code-api">Using the Data Catalog with the Code API</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#configuring-a-data-catalog">Configuring a Data Catalog</a></li>
<li class="toctree-l3"><a class="reference internal" href="#loading-datasets">Loading datasets</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#behind-the-scenes">Behind the scenes</a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#viewing-the-available-data-sources">Viewing the available data sources</a></li>
<li class="toctree-l3"><a class="reference internal" href="#saving-data">Saving data</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#saving-data-to-memory">Saving data to memory</a></li>
<li class="toctree-l4"><a class="reference internal" href="#saving-data-to-a-sql-database-for-querying">Saving data to a SQL database for querying</a></li>
<li class="toctree-l4"><a class="reference internal" href="#saving-data-in-parquet">Saving data in Parquet</a></li>
</ul>
</li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="02_kedro_io.html">Kedro IO</a><ul>
<li class="toctree-l2"><a class="reference internal" href="02_kedro_io.html#error-handling">Error handling</a></li>
<li class="toctree-l2"><a class="reference internal" href="02_kedro_io.html#abstractdataset">AbstractDataSet</a></li>
<li class="toctree-l2"><a class="reference internal" href="02_kedro_io.html#versioning">Versioning</a><ul>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#version-namedtuple"><code class="docutils literal notranslate"><span class="pre">version</span></code> namedtuple</a></li>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#versioning-using-the-yaml-api">Versioning using the YAML API</a></li>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#versioning-using-the-code-api">Versioning using the Code API</a></li>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#supported-datasets">Supported datasets</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="02_kedro_io.html#partitioned-dataset">Partitioned dataset</a><ul>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#partitioned-dataset-definition">Partitioned dataset definition</a><ul>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#dataset-definition">Dataset definition</a></li>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#partitioned-dataset-credentials">Partitioned dataset credentials</a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#partitioned-dataset-load">Partitioned dataset load</a></li>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#partitioned-dataset-save">Partitioned dataset save</a></li>
<li class="toctree-l3"><a class="reference internal" href="02_kedro_io.html#incremental-loads-with-incrementaldataset">Incremental loads with <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code></a><ul>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#incremental-dataset-load">Incremental dataset load</a></li>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#incremental-dataset-save">Incremental dataset save</a></li>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#incremental-dataset-confirm">Incremental dataset confirm</a></li>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#checkpoint-configuration">Checkpoint configuration</a></li>
<li class="toctree-l4"><a class="reference internal" href="02_kedro_io.html#special-checkpoint-config-keys">Special checkpoint config keys</a></li>
</ul>
</li>
</ul>
</li>
...
<h1>The Data Catalog<a class="headerlink" href="#the-data-catalog" title="Permalink to this headline">¶</a></h1>
<p>This section introduces <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code>, the project-shareable Data Catalog. The file is located in <code class="docutils literal notranslate"><span class="pre">conf/base</span></code> and is a registry of all data sources available for use by a project; it manages loading and saving of data.</p>
<p>All supported data connectors are available in <a class="reference internal" href="../kedro.extras.datasets.html"><span class="doc">kedro.extras.datasets</span></a>.</p>
<div class="section" id="using-the-data-catalog-within-kedro-configuration">
<h2>Using the Data Catalog within Kedro configuration<a class="headerlink" href="#using-the-data-catalog-within-kedro-configuration" title="Permalink to this headline">¶</a></h2>
<p>Kedro uses configuration to make your code reproducible when it has to reference datasets in different locations and/or in different environments.</p>
<p>You can copy this file and reference additional locations for the same datasets. For instance, you can use the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> file in <code class="docutils literal notranslate"><span class="pre">conf/base/</span></code> to register the locations of datasets that would run in production while copying and updating a second version of <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> in <code class="docutils literal notranslate"><span class="pre">conf/local/</span></code> to register the locations of sample datasets that you are using for prototyping your data pipeline(s).</p>
<p>There is built-in functionality for <code class="docutils literal notranslate"><span class="pre">conf/local/</span></code> to overwrite <code class="docutils literal notranslate"><span class="pre">conf/base/</span></code> detailed <a class="reference internal" href="../04_kedro_project_setup/02_configuration.html"><span class="doc">here</span></a>. This means that a dataset called <code class="docutils literal notranslate"><span class="pre">cars</span></code> could exist in the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> files in <code class="docutils literal notranslate"><span class="pre">conf/base/</span></code> and <code class="docutils literal notranslate"><span class="pre">conf/local/</span></code>. In code, in <code class="docutils literal notranslate"><span class="pre">src</span></code>, you would only call a dataset named <code class="docutils literal notranslate"><span class="pre">cars</span></code> and Kedro would detect which definition of <code class="docutils literal notranslate"><span class="pre">cars</span></code> dataset to use to run your pipeline - <code class="docutils literal notranslate"><span class="pre">cars</span></code> definition from <code class="docutils literal notranslate"><span class="pre">conf/local/catalog.yml</span></code> would take precedence in this case.</p>
<p>The Data Catalog also works with the <code class="docutils literal notranslate"><span class="pre">credentials.yml</span></code> in <code class="docutils literal notranslate"><span class="pre">conf/local/</span></code>, allowing you to specify usernames and passwords that are required to load certain datasets.</p>
<p>The are two ways of defining a Data Catalog through the use of YAML configuration, or programmatically using an API. Both methods allow you to specify:</p>
<ul class="simple">
<li><p>Dataset name</p></li>
<li><p>Dataset type</p></li>
<li><p>Location of the dataset using <code class="docutils literal notranslate"><span class="pre">fsspec</span></code>, detailed in the next section</p></li>
<li><p>Credentials needed in order to access the dataset</p></li>
<li><p>Load and saving arguments</p></li>
<li><p>Whether or not you want a <a class="reference internal" href="02_kedro_io.html#versioning"><span class="std std-ref">dataset or ML model to be versioned</span></a> when you run your data pipeline</p></li>
</ul>
</div>
<div class="section" id="specifying-the-location-of-the-dataset">
<h2>Specifying the location of the dataset<a class="headerlink" href="#specifying-the-location-of-the-dataset" title="Permalink to this headline">¶</a></h2>
<p>Kedro relies on <a class="reference external" href="https://filesystem-spec.readthedocs.io/en/latest/"><code class="docutils literal notranslate"><span class="pre">fsspec</span></code></a> for reading and saving data from a variety of data stores including local file systems, network file systems, cloud object stores, and Hadoop. When specifying a storage location in <code class="docutils literal notranslate"><span class="pre">filepath:</span></code>, you should provide a URL using the general form <code class="docutils literal notranslate"><span class="pre">protocol://path/to/data</span></code>.  If no protocol is provided, the local file system is assumed (same as <code class="docutils literal notranslate"><span class="pre">file://</span></code>).</p>
<p>The following prepends are available:</p>
<ul class="simple">
<li><p><strong>Local or Network File System</strong>: <code class="docutils literal notranslate"><span class="pre">file://</span></code> - the local file system is default in the absence of any protocol, it also permits relative paths.</p></li>
<li><p><strong>Hadoop File System (HDFS)</strong>: <code class="docutils literal notranslate"><span class="pre">hdfs://user&#64;server:port/path/to/data</span></code> - Hadoop Distributed File System, for resilient, replicated files within a cluster.</p></li>
<li><p><strong>Amazon S3</strong>: <code class="docutils literal notranslate"><span class="pre">s3://my-bucket-name/path/to/data</span></code> - Amazon S3 remote binary store, often used with Amazon EC2,
using the library s3fs.</p></li>
<li><p><strong>S3 Compatible Storage</strong>: <code class="docutils literal notranslate"><span class="pre">s3://my-bucket-name/path/_to/data</span></code> - e.g. Minio, using the s3fs library.</p></li>
<li><p><strong>Google Cloud Storage</strong>: <code class="docutils literal notranslate"><span class="pre">gcs://</span></code> - Google Cloud Storage, typically used with Google Compute
resource using gcsfs (in development).</p></li>
<li><p><strong>Azure Blob Storage / Azure Data Lake Storage Gen2</strong>: <code class="docutils literal notranslate"><span class="pre">abfs://</span></code> - Azure Blob Storage, typically used when working on an Azure environment.</p></li>
...
<p><code class="docutils literal notranslate"><span class="pre">fsspec</span></code> also provides other file systems, such as SSH, FTP and WebHDFS. See the <a class="reference external" href="https://filesystem-spec.readthedocs.io/en/latest/api.html#implementations">documentation</a> for more information.</p>
</div>
<div class="section" id="data-catalog-args-parameters">
<h2>Data Catalog <code class="docutils literal notranslate"><span class="pre">*_args</span></code> parameters<a class="headerlink" href="#data-catalog-args-parameters" title="Permalink to this headline">¶</a></h2>
<p>Data Catalog accepts two different groups of <code class="docutils literal notranslate"><span class="pre">*_args</span></code> parameters that serve different purposes:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">fs_args</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">load_args</span></code> and <code class="docutils literal notranslate"><span class="pre">save_args</span></code></p></li>
</ul>
<p>The <code class="docutils literal notranslate"><span class="pre">fs_args</span></code> is used to configure the interaction with a filesystem.
All the top-level parameters of <code class="docutils literal notranslate"><span class="pre">fs_args</span></code> (except <code class="docutils literal notranslate"><span class="pre">open_args_load</span></code> and <code class="docutils literal notranslate"><span class="pre">open_args_save</span></code>) will be passed in an underlying filesystem class.</p>
<p>Example 1: Provide the <code class="docutils literal notranslate"><span class="pre">project</span></code> value to the underlying filesystem class (<code class="docutils literal notranslate"><span class="pre">GCSFileSystem</span></code>) to interact with Google Cloud Storage (GCS)</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">test_dataset</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">fs_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">project</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">test_project</span><span class="w"></span>
</pre></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">open_args_load</span></code> and <code class="docutils literal notranslate"><span class="pre">open_args_save</span></code> parameters are passed to the filesystem’s <code class="docutils literal notranslate"><span class="pre">open</span></code> method to configure how a dataset file (on a specific filesystem) is opened during a load or save operation, respectively.</p>
<p>Example 2: Load data from a local binary file using <code class="docutils literal notranslate"><span class="pre">utf-8</span></code> encoding</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">test_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">...</span><span class="w"></span>
<span class="w">  </span><span class="nt">fs_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">open_args_load</span><span class="p">:</span><span class="w"></span>
<span class="w">      </span><span class="nt">mode</span><span class="p">:</span><span class="w"> </span><span class="s">&quot;rb&quot;</span><span class="w"></span>
<span class="w">      </span><span class="nt">encoding</span><span class="p">:</span><span class="w"> </span><span class="s">&quot;utf-8&quot;</span><span class="w"></span>
</pre></div>
</div>
<p><code class="docutils literal notranslate"><span class="pre">load_args</span></code> and <code class="docutils literal notranslate"><span class="pre">save_args</span></code> configure how a third-party library (e.g. <code class="docutils literal notranslate"><span class="pre">pandas</span></code> for <code class="docutils literal notranslate"><span class="pre">CSVDataSet</span></code>) loads/saves data from/to a file.</p>
<p>Example 3: Save data to a CSV file without row names (index) using <code class="docutils literal notranslate"><span class="pre">utf-8</span></code> encoding</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">test_dataset</span><span class="p">:</span><span class="w"></span>
...
<div class="section" id="using-the-data-catalog-with-the-yaml-api">
<h2>Using the Data Catalog with the YAML API<a class="headerlink" href="#using-the-data-catalog-with-the-yaml-api" title="Permalink to this headline">¶</a></h2>
<p>The YAML API allows you to configure your datasets in a YAML configuration file, <code class="docutils literal notranslate"><span class="pre">conf/base/catalog.yml</span></code> or <code class="docutils literal notranslate"><span class="pre">conf/local/catalog.yml</span></code>.</p>
<p>Here are some examples of data configuration in a <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code>:</p>
<p>Example 1: Loads / saves a CSV file from / to a local file system</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">bikes</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/01_raw/bikes.csv</span><span class="w"></span>
</pre></div>
</div>
<p>Example 2: Loads and saves a CSV on a local file system, using specified load and save arguments</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">cars</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/01_raw/company/cars.csv</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">save_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">index</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">False</span><span class="w"></span>
<span class="w">    </span><span class="nt">date_format</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;%Y-%m-%d</span><span class="nv"> </span><span class="s">%H:%M&#39;</span><span class="w"></span>
<span class="w">    </span><span class="nt">decimal</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">.</span><span class="w"></span>
</pre></div>
</div>
<p>Example 3: Loads and saves a compressed CSV on a local file system</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">boats</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/01_raw/company/boats.csv.gz</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">sep</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;,&#39;</span><span class="w"></span>
<span class="w">    </span><span class="nt">compression</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;gzip&#39;</span><span class="w"></span>
<span class="w">  </span><span class="nt">fs_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">open_args_load</span><span class="p">:</span><span class="w"></span>
<span class="w">      </span><span class="nt">mode</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;rb&#39;</span><span class="w"></span>
</pre></div>
</div>
<p>Example 4: Loads a CSV file from a specific S3 bucket, using credentials and load arguments</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">motorbikes</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://your_bucket/data/02_intermediate/company/motorbikes.csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">dev_s3</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">sep</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;,&#39;</span><span class="w"></span>
<span class="w">    </span><span class="nt">skiprows</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">5</span><span class="w"></span>
<span class="w">    </span><span class="nt">skipfooter</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">1</span><span class="w"></span>
<span class="w">    </span><span class="nt">na_values</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="s">&#39;#NA&#39;</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">NA</span><span class="p p-Indicator">]</span><span class="w"></span>
</pre></div>
</div>
<p>Example 5: Loads / saves a pickle file from / to a local file system</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">airplanes</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/06_models/airplanes.pkl</span><span class="w"></span>
<span class="w">  </span><span class="nt">backend</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pickle</span><span class="w"></span>
</pre></div>
</div>
<p>Example 6: Loads an excel file from Google Cloud Storage</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">rockets</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.ExcelDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">gcs://your_bucket/data/02_intermediate/company/motorbikes.xlsx</span><span class="w"></span>
<span class="w">  </span><span class="nt">fs_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">project</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">my-project</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">my_gcp_credentials</span><span class="w"></span>
<span class="w">  </span><span class="nt">save_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">sheet_name</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">Sheet1</span><span class="w"></span>
</pre></div>
</div>
<p>Example 7: Save an image created with Matplotlib on Google Cloud Storage</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">results_plot</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">matplotlib.MatplotlibWriter</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">gcs://your_bucket/data/08_results/plots/output_1.jpeg</span><span class="w"></span>
<span class="w">  </span><span class="nt">fs_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">project</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">my-project</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">my_gcp_credentials</span><span class="w"></span>
</pre></div>
</div>
<p>Example 8: Loads / saves an HDF file on local file system storage, using specified load and save arguments</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">skateboards</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.HDFDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/02_intermediate/skateboards.hdf</span><span class="w"></span>
<span class="w">  </span><span class="nt">key</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">name</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">columns</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="nv">brand</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">length</span><span class="p p-Indicator">]</span><span class="w"></span>
<span class="w">  </span><span class="nt">save_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">mode</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">w</span><span class="w">  </span><span class="c1"># Overwrite even when the file already exists</span><span class="w"></span>
<span class="w">    </span><span class="nt">dropna</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
</pre></div>
</div>
<p>Example 9: Loads / saves a parquet file on local file system storage, using specified load and save arguments</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">trucks</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/02_intermediate/trucks.parquet</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">columns</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="nv">name</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">gear</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">disp</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">wt</span><span class="p p-Indicator">]</span><span class="w"></span>
<span class="w">    </span><span class="nt">categories</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">list</span><span class="w"></span>
<span class="w">    </span><span class="nt">index</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">name</span><span class="w"></span>
<span class="w">  </span><span class="nt">save_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">compression</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">GZIP</span><span class="w"></span>
<span class="w">    </span><span class="nt">file_scheme</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">hive</span><span class="w"></span>
<span class="w">    </span><span class="nt">has_nulls</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">False</span><span class="w"></span>
<span class="w">    </span><span class="nt">partition_on</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="nv">name</span><span class="p p-Indicator">]</span><span class="w"></span>
</pre></div>
</div>
<p>Example 10: Load / saves a Spark table on S3, using specified load and save arguments</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">weather</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">spark.SparkDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3a://your_bucket/data/01_raw/weather*</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">dev_s3</span><span class="w"></span>
<span class="w">  </span><span class="nt">file_format</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">header</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
<span class="w">    </span><span class="nt">inferSchema</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
<span class="w">  </span><span class="nt">save_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">sep</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;|&#39;</span><span class="w"></span>
<span class="w">    </span><span class="nt">header</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
</pre></div>
</div>
<p>Example 11: Loads / saves a SQL table using credentials, a database connection, using specified load and save arguments</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">scooters</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.SQLTableDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">scooters_credentials</span><span class="w"></span>
<span class="w">  </span><span class="nt">table_name</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">scooters</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">index_col</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="nv">name</span><span class="p p-Indicator">]</span><span class="w"></span>
<span class="w">    </span><span class="nt">columns</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="nv">name</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">gear</span><span class="p p-Indicator">]</span><span class="w"></span>
<span class="w">  </span><span class="nt">save_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">if_exists</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">replace</span><span class="w"></span>
</pre></div>
</div>
<p>Example 12: Load a SQL table with credentials, a database connection, and applies a SQL query to the table</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">scooters_query</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.SQLQueryDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">scooters_credentials</span><span class="w"></span>
<span class="w">  </span><span class="nt">sql</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">select * from cars where gear=4</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">index_col</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="nv">name</span><span class="p p-Indicator">]</span><span class="w"></span>
</pre></div>
</div>
<p>When using <a class="reference internal" href="../kedro.extras.datasets.pandas.SQLTableDataSet.html"><span class="doc">pandas.SQLTableDataSet</span></a> or <a class="reference internal" href="../kedro.extras.datasets.pandas.SQLQueryDataSet.html"><span class="doc">pandas.SQLQueryDataSet</span></a> you must provide a database connection string. In the example above we pass it using <code class="docutils literal notranslate"><span class="pre">scooters_credentials</span></code> key from the credentials (see the details in <a class="reference external" href="#feeding-in-credentials">Feeding in credentials</a> section below). <code class="docutils literal notranslate"><span class="pre">scooters_credentials</span></code> must have a top-level key <code class="docutils literal notranslate"><span class="pre">con</span></code> containing <a class="reference external" href="https://docs.sqlalchemy.org/en/13/core/engines.html#database-urls">SQLAlchemy compatible</a> connection string. As an alternative to credentials, you could explicitly put <code class="docutils literal notranslate"><span class="pre">con</span></code> into <code class="docutils literal notranslate"><span class="pre">load_args</span></code> and <code class="docutils literal notranslate"><span class="pre">save_args</span></code> (<code class="docutils literal notranslate"><span class="pre">pandas.SQLTableDataSet</span></code> only).</p>
<p>Example 13: Load data from an API endpoint, example US corn yield data from USDA</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">us_corn_yield_data</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">api.APIDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">url</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">https://quickstats.nass.usda.gov</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">usda_credentials</span><span class="w"></span>
<span class="w">  </span><span class="nt">params</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">key</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">SOME_TOKEN</span><span class="w"></span>
<span class="w">    </span><span class="nt">format</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">JSON</span><span class="w"></span>
<span class="w">    </span><span class="nt">commodity_desc</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">CORN</span><span class="w"></span>
<span class="w">    </span><span class="nt">statisticcat_des</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">YIELD</span><span class="w"></span>
<span class="w">    </span><span class="nt">agg_level_desc</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">STATE</span><span class="w"></span>
<span class="w">    </span><span class="nt">year</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">2000</span><span class="w"></span>
</pre></div>
</div>
<p>Note that <code class="docutils literal notranslate"><span class="pre">usda_credientials</span></code> will be passed as the <code class="docutils literal notranslate"><span class="pre">auth</span></code> argument in the <code class="docutils literal notranslate"><span class="pre">requests</span></code> library. Specify the username and password as a list in your <code class="docutils literal notranslate"><span class="pre">credentials.yml</span></code> as follows:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">usda_credentials</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">username</span><span class="w"></span>
<span class="w">  </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">password</span><span class="w"></span>
</pre></div>
</div>
<p>Example 14: Loading data from Minio (S3 API Compatible Storage)</p>
...
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://your_bucket/test.csv</span><span class="w"> </span><span class="c1"># assume `test.csv` is uploaded to the Minio server.</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">dev_minio</span><span class="w"></span>
</pre></div>
</div>
<p>In <code class="docutils literal notranslate"><span class="pre">credentials.yml</span></code>, define the <code class="docutils literal notranslate"><span class="pre">key</span></code>, <code class="docutils literal notranslate"><span class="pre">secret</span></code> and the <code class="docutils literal notranslate"><span class="pre">endpoint_url</span></code> as follows:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">dev_minio</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">secret</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">key</span><span class="w"></span>
<span class="w">  </span><span class="nt">client_kwargs</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">endpoint_url </span><span class="p">:</span><span class="w"> </span><span class="s">&#39;http://localhost:9000&#39;</span><span class="w"></span>
</pre></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The easiest way to setup MinIO is to run a Docker image. After the following command, you can access to Minio server with <code class="docutils literal notranslate"><span class="pre">http://localhost:9000</span></code> and create a bucket and add files as if it is on S3.</p>
</div>
<p><code class="docutils literal notranslate"><span class="pre">docker</span> <span class="pre">run</span> <span class="pre">-p</span> <span class="pre">9000:9000</span> <span class="pre">-e</span> <span class="pre">&quot;MINIO_ACCESS_KEY=token&quot;</span> <span class="pre">-e</span> <span class="pre">&quot;MINIO_SECRET_KEY=key&quot;</span> <span class="pre">minio/minio</span> <span class="pre">server</span> <span class="pre">/data</span></code></p>
<p>Example 15: Loading a model saved as a pickle from Azure Blob Storage</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">ml_model</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pickle.PickleDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="s">&quot;abfs://models/ml_models.pickle&quot;</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">dev_abs</span><span class="w"></span>
</pre></div>
</div>
<p>In <code class="docutils literal notranslate"><span class="pre">credentials.yml</span></code>, define the <code class="docutils literal notranslate"><span class="pre">account_name</span></code> and <code class="docutils literal notranslate"><span class="pre">account_key</span></code> as follows:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">dev_abs</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">account_name</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">accountname</span><span class="w"></span>
<span class="w">  </span><span class="nt">account_key</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">key</span><span class="w"></span>
</pre></div>
</div>
<p>Example 16: Loading a CSV file stored in a remote location through SSH</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>This example requires <a class="reference external" href="https://www.paramiko.org">Paramiko</a> to be installed (<code class="docutils literal notranslate"><span class="pre">pip</span> <span class="pre">install</span> <span class="pre">paramiko</span></code>).</p>
</div>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">cool_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="s">&quot;sftp:///path/to/remote_cluster/cool_data.csv&quot;</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">cluster_credentials</span><span class="w"></span>
</pre></div>
</div>
<p>All parameters required to establish the SFTP connection can be defined through <code class="docutils literal notranslate"><span class="pre">fs_args</span></code> or in <code class="docutils literal notranslate"><span class="pre">credentials.yml</span></code> as follows:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">cluster_credentials</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">host</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">host_address</span><span class="w"></span>
...
<p>The list of all available parameters is given in the <a class="reference external" href="https://docs.paramiko.org/en/2.4/api/client.html#paramiko.client.SSHClient.connect">Paramiko documentation</a>.</p>
</div>
<div class="section" id="creating-a-data-catalog-yaml-configuration-file-via-cli">
<h2>Creating a Data Catalog YAML configuration file via CLI<a class="headerlink" href="#creating-a-data-catalog-yaml-configuration-file-via-cli" title="Permalink to this headline">¶</a></h2>
<p>You can use <a class="reference internal" href="../09_development/03_commands_reference.html#create-a-data-catalog-yaml-configuration-file"><span class="std std-ref">kedro catalog create command</span></a> to create a Data Catalog YAML configuration.</p>
<p>It creates a <code class="docutils literal notranslate"><span class="pre">&lt;conf_root&gt;/&lt;env&gt;/catalog/&lt;pipeline_name&gt;.yml</span></code> configuration file with <code class="docutils literal notranslate"><span class="pre">MemoryDataSet</span></code> datasets for each dataset in a registered pipeline if it is missing from the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code>.</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="c1"># &lt;conf_root&gt;/&lt;env&gt;/catalog/&lt;pipeline_name&gt;.yml</span><span class="w"></span>
<span class="nt">rockets</span><span class="p">:</span><span class="w"></span>
...
<span class="nt">scooters</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">MemoryDataSet</span><span class="w"></span>
</pre></div>
</div>
</div>
...
<p>You can <a class="reference internal" href="../04_kedro_project_setup/02_configuration.html#load-parameters"><span class="std std-ref">configure parameters</span></a> for your project and <a class="reference internal" href="../04_kedro_project_setup/02_configuration.html#use-parameters"><span class="std std-ref">reference them</span></a> in your nodes. Do this using the <code class="docutils literal notranslate"><span class="pre">add_feed_dict()</span></code> method (<a class="reference internal" href="../kedro.io.DataCatalog.html"><span class="doc">API documentation</span></a>). You can use this method to add any other entry / metadata you wish on the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code>.</p>
</div>
<div class="section" id="feeding-in-credentials">
<h2>Feeding in credentials<a class="headerlink" href="#feeding-in-credentials" title="Permalink to this headline">¶</a></h2>
<p>Before instantiating the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> Kedro will first attempt to read the credentials from <a class="reference internal" href="../04_kedro_project_setup/02_configuration.html#aws-credentials"><span class="std std-ref">the project configuration</span></a>. The resulting dictionary is then passed into <code class="docutils literal notranslate"><span class="pre">DataCatalog.from_config()</span></code> as the <code class="docutils literal notranslate"><span class="pre">credentials</span></code> argument.</p>
<p>Let’s assume that the project contains the file <code class="docutils literal notranslate"><span class="pre">conf/local/credentials.yml</span></code> with the following contents:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">dev_s3</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">client_kwargs</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">aws_access_key_id</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">key</span><span class="w"></span>
<span class="w">    </span><span class="nt">aws_secret_access_key</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">secret</span><span class="w"></span>

<span class="nt">scooters_credentials</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">con</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">sqlite:///kedro.db</span><span class="w"></span>

<span class="nt">my_gcp_credentials</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">id_token</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">key</span><span class="w"></span>
</pre></div>
</div>
<p>In the example above <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> contains references to credentials keys <code class="docutils literal notranslate"><span class="pre">dev_s3</span></code> and <code class="docutils literal notranslate"><span class="pre">scooters_credentials</span></code>. It means that when instantiating <code class="docutils literal notranslate"><span class="pre">motorbikes</span></code> dataset, for example, the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> will attempt to read top-level key <code class="docutils literal notranslate"><span class="pre">dev_s3</span></code> from the received <code class="docutils literal notranslate"><span class="pre">credentials</span></code> dictionary, and then will pass its values into the dataset <code class="docutils literal notranslate"><span class="pre">__init__</span></code> as <code class="docutils literal notranslate"><span class="pre">credentials</span></code> argument. This is essentially equivalent to calling this:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">CSVDataSet</span><span class="p">(</span>
    <span class="n">filepath</span><span class="o">=</span><span class="s2">&quot;s3://test_bucket/data/02_intermediate/company/motorbikes.csv&quot;</span><span class="p">,</span>
    <span class="n">load_args</span><span class="o">=</span><span class="nb">dict</span><span class="p">(</span><span class="n">sep</span><span class="o">=</span><span class="s2">&quot;,&quot;</span><span class="p">,</span> <span class="n">skiprows</span><span class="o">=</span><span class="mi">5</span><span class="p">,</span> <span class="n">skipfooter</span><span class="o">=</span><span class="mi">1</span><span class="p">,</span> <span class="n">na_values</span><span class="o">=</span><span class="p">[</span><span class="s2">&quot;#NA&quot;</span><span class="p">,</span> <span class="s2">&quot;NA&quot;</span><span class="p">]),</span>
    <span class="n">credentials</span><span class="o">=</span><span class="nb">dict</span><span class="p">(</span><span class="n">key</span><span class="o">=</span><span class="s2">&quot;token&quot;</span><span class="p">,</span> <span class="n">secret</span><span class="o">=</span><span class="s2">&quot;key&quot;</span><span class="p">),</span>
<span class="p">)</span>
</pre></div>
</div>
</div>
<div class="section" id="loading-multiple-datasets-that-have-similar-configuration">
<h2>Loading multiple datasets that have similar configuration<a class="headerlink" href="#loading-multiple-datasets-that-have-similar-configuration" title="Permalink to this headline">¶</a></h2>
<p>You may encounter situations where your datasets use the same file format, load and save arguments, and are stored in the same folder. YAML has a <a class="reference external" href="https://yaml.org/spec/1.2.1/#Syntax">built-in syntax</a> for factorising parts of a YAML file, which means that you can decide what is generalisable across your datasets so that you do not have to spend time copying and pasting dataset configurations in <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code>.</p>
<p>You can see this in the following example:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">_csv</span><span class="p">:</span><span class="w"> </span><span class="nl">&amp;csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">spark.SparkDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">file_format</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">sep</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;,&#39;</span><span class="w"></span>
<span class="w">    </span><span class="nt">na_values</span><span class="p">:</span><span class="w"> </span><span class="p p-Indicator">[</span><span class="s">&#39;#NA&#39;</span><span class="p p-Indicator">,</span><span class="w"> </span><span class="nv">NA</span><span class="p p-Indicator">]</span><span class="w"></span>
<span class="w">    </span><span class="nt">header</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
<span class="w">    </span><span class="nt">inferSchema</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">False</span><span class="w"></span>

<span class="nt">cars</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">&lt;&lt;</span><span class="p">:</span><span class="w"> </span><span class="nv">*csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3a://data/01_raw/cars.csv</span><span class="w"></span>

<span class="nt">trucks</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">&lt;&lt;</span><span class="p">:</span><span class="w"> </span><span class="nv">*csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3a://data/01_raw/trucks.csv</span><span class="w"></span>

<span class="nt">bikes</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">&lt;&lt;</span><span class="p">:</span><span class="w"> </span><span class="nv">*csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3a://data/01_raw/bikes.csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">header</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">False</span><span class="w"></span>
</pre></div>
</div>
<p>The syntax <code class="docutils literal notranslate"><span class="pre">&amp;csv</span></code> names the following block <code class="docutils literal notranslate"><span class="pre">csv</span></code> and the syntax <code class="docutils literal notranslate"><span class="pre">&lt;&lt;:</span> <span class="pre">*csv</span></code> inserts the contents of the block named <code class="docutils literal notranslate"><span class="pre">csv</span></code>. Locally declared keys entirely override inserted ones as seen in <code class="docutils literal notranslate"><span class="pre">bikes</span></code>.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>It’s important that the name of the template entry starts with a <code class="docutils literal notranslate"><span class="pre">_</span></code> so Kedro knows not to try and instantiate it as a dataset.</p>
</div>
<p>You can also nest reuseable YAML syntax:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">_csv</span><span class="p">:</span><span class="w"> </span><span class="nl">&amp;csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">spark.SparkDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">file_format</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"> </span><span class="nl">&amp;csv_load_args</span><span class="w"></span>
<span class="w">    </span><span class="nt">header</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
<span class="w">    </span><span class="nt">inferSchema</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">False</span><span class="w"></span>

<span class="nt">airplanes</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">&lt;&lt;</span><span class="p">:</span><span class="w"> </span><span class="nv">*csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3a://data/01_raw/airplanes.csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">&lt;&lt;</span><span class="p">:</span><span class="w"> </span><span class="nv">*csv_load_args</span><span class="w"></span>
<span class="w">    </span><span class="nt">sep</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">;</span><span class="w"></span>
</pre></div>
</div>
<p>In this example the default <code class="docutils literal notranslate"><span class="pre">csv</span></code> configuration is inserted into <code class="docutils literal notranslate"><span class="pre">airplanes</span></code> and then the <code class="docutils literal notranslate"><span class="pre">load_args</span></code> block is overridden. Normally that would replace the whole dictionary. In order to extend <code class="docutils literal notranslate"><span class="pre">load_args</span></code> the defaults for that block are then re-inserted.</p>
</div>
<div class="section" id="transcoding-datasets">
<h2>Transcoding datasets<a class="headerlink" href="#transcoding-datasets" title="Permalink to this headline">¶</a></h2>
<p>You may come across a situation where you would like to read the same file using two different dataset implementations. Use transcoding when you want to load and save the same file, via its specified <code class="docutils literal notranslate"><span class="pre">filepath</span></code>, using different <code class="docutils literal notranslate"><span class="pre">DataSet</span></code> implementations.</p>
<div class="section" id="a-typical-example-of-transcoding">
<h3>A typical example of transcoding<a class="headerlink" href="#a-typical-example-of-transcoding" title="Permalink to this headline">¶</a></h3>
<p>For instance, parquet files can not only be loaded via the <code class="docutils literal notranslate"><span class="pre">ParquetDataSet</span></code> using <code class="docutils literal notranslate"><span class="pre">pandas</span></code>, but also directly by <code class="docutils literal notranslate"><span class="pre">SparkDataSet</span></code>. This conversion is typical when coordinating a <code class="docutils literal notranslate"><span class="pre">Spark</span></code> to <code class="docutils literal notranslate"><span class="pre">pandas</span></code> workflow.</p>
<p>To enable transcoding, define two <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> entries for the same dataset in a common format (Parquet, JSON, CSV, etc.) in your <code class="docutils literal notranslate"><span class="pre">conf/base/catalog.yml</span></code>:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">my_dataframe@spark</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">spark.SparkDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/02_intermediate/data.parquet</span><span class="w"></span>
<span class="w">  </span><span class="nt">file_format</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">parquet</span><span class="w"></span>

<span class="nt">my_dataframe@pandas</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.ParquetDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/02_intermediate/data.parquet</span><span class="w"></span>
</pre></div>
</div>
<p>These entries are used in the pipeline like this:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">Pipeline</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="n">node</span><span class="p">(</span><span class="n">func</span><span class="o">=</span><span class="n">my_func1</span><span class="p">,</span> <span class="n">inputs</span><span class="o">=</span><span class="s2">&quot;spark_input&quot;</span><span class="p">,</span> <span class="n">outputs</span><span class="o">=</span><span class="s2">&quot;my_dataframe@spark&quot;</span><span class="p">),</span>
        <span class="n">node</span><span class="p">(</span><span class="n">func</span><span class="o">=</span><span class="n">my_func2</span><span class="p">,</span> <span class="n">inputs</span><span class="o">=</span><span class="s2">&quot;my_dataframe@pandas&quot;</span><span class="p">,</span> <span class="n">outputs</span><span class="o">=</span><span class="s2">&quot;pipeline_output&quot;</span><span class="p">),</span>
    <span class="p">]</span>
<span class="p">)</span>
</pre></div>
</div>
</div>
<div class="section" id="how-does-transcoding-work">
<h3>How does transcoding work?<a class="headerlink" href="#how-does-transcoding-work" title="Permalink to this headline">¶</a></h3>
<p>In this example, Kedro understands that <code class="docutils literal notranslate"><span class="pre">my_dataframe</span></code> is the same dataset in its <code class="docutils literal notranslate"><span class="pre">spark.SparkDataSet</span></code> and <code class="docutils literal notranslate"><span class="pre">pandas.ParquetDataSet</span></code> formats and helps resolve the node execution order.</p>
<p>In the pipeline, Kedro uses the <code class="docutils literal notranslate"><span class="pre">spark.SparkDataSet</span></code> implementation for saving and <code class="docutils literal notranslate"><span class="pre">pandas.ParquetDataSet</span></code>
for loading, so the first node should output a <code class="docutils literal notranslate"><span class="pre">pyspark.sql.DataFrame</span></code>, while the second node would receive a <code class="docutils literal notranslate"><span class="pre">pandas.Dataframe</span></code>.</p>
</div>
</div>
...
<p>Transformers are used to intercept the load and save operations on Kedro <code class="docutils literal notranslate"><span class="pre">DataSet</span></code>s. Use cases for transformers include:</p>
<ul class="simple">
<li><p>Data validation</p></li>
<li><p>Tracking operation performance</p></li>
<li><p>Data format conversion (although we would recommend <a class="reference external" href="#transcoding-datasets">Transcoding</a> for this)</p></li>
</ul>
<div class="section" id="applying-built-in-transformers">
<h3>Applying built-in transformers<a class="headerlink" href="#applying-built-in-transformers" title="Permalink to this headline">¶</a></h3>
<p>Here we cover the use case of <em>tracking operation performance</em> by applying built-in transformers to monitor the latency of load and save operations.</p>
<p>Transformers are applied at the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> level. To apply the built-in <code class="docutils literal notranslate"><span class="pre">ProfileTimeTransformer</span></code>, you need to:</p>
<ol class="simple">
<li><p>Navigate to <code class="docutils literal notranslate"><span class="pre">src/&lt;package_name&gt;/hooks.py</span></code></p></li>
<li><p>Apply <code class="docutils literal notranslate"><span class="pre">ProfileTimeTransformer</span></code> in the hook implementation <code class="docutils literal notranslate"><span class="pre">TransformerHooks.after_catalog_created</span></code></p></li>
<li><p>Register the hook in your <code class="docutils literal notranslate"><span class="pre">src/&lt;package_name&gt;/settings.py</span></code></p></li>
</ol>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="c1"># src/&lt;package_name&gt;/hooks.py</span>

<span class="kn">from</span> <span class="nn">kedro.extras.transformers</span> <span class="kn">import</span> <span class="n">ProfileTimeTransformer</span>  <span class="c1"># new import</span>
<span class="kn">from</span> <span class="nn">kedro.framework.hooks</span> <span class="kn">import</span> <span class="n">hook_impl</span>  <span class="c1"># new import</span>
<span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">DataCatalog</span>  <span class="c1"># new import</span>


<span class="k">class</span> <span class="nc">TransformerHooks</span><span class="p">:</span>
    <span class="nd">@hook_impl</span>
    <span class="k">def</span> <span class="nf">after_catalog_created</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">catalog</span><span class="p">:</span> <span class="n">DataCatalog</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="n">catalog</span><span class="o">.</span><span class="n">add_transformer</span><span class="p">(</span><span class="n">ProfileTimeTransformer</span><span class="p">())</span>
</pre></div>
</div>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="c1"># src/&lt;package_name&gt;/settings.py</span>
<span class="kn">from</span> <span class="o">&lt;</span><span class="n">package_name</span><span class="o">&gt;.</span><span class="n">hooks</span> <span class="kn">import</span> <span class="nn">TransformerHooks</span>

<span class="n">HOOKS</span> <span class="o">=</span> <span class="p">(</span><span class="n">TransformerHooks</span><span class="p">(),)</span>
</pre></div>
</div>
<p>Once complete, rerun the pipeline from the terminal and you should see the following logging output:</p>
<div class="highlight-console notranslate"><div class="highlight"><pre><span></span><span class="gp">$ </span>kedro run

<span class="go">...</span>
<span class="go">2019-11-13 15:09:01,784 - kedro.io.data_catalog - INFO - Loading data from `companies` (CSVDataSet)...</span>
<span class="go">2019-11-13 15:09:01,827 - ProfileTimeTransformer - INFO - Loading companies took 0.043 seconds</span>
<span class="go">2019-11-13 15:09:01,828 - kedro.pipeline.node - INFO - Running node: preprocessing_companies: preprocess_companies([companies]) -&gt; [preprocessed_companies]</span>
<span class="go">2019-11-13 15:09:01,880 - kedro_tutorial.nodes.data_engineering - INFO - Running &#39;preprocess_companies&#39; took 0.05 seconds</span>
<span class="go">2019-11-13 15:09:01,880 - kedro_tutorial.nodes.data_engineering - INFO - Running &#39;preprocess_companies&#39; took 0.05 seconds</span>
<span class="go">2019-11-13 15:09:01,880 - kedro.io.data_catalog - INFO - Saving data to `preprocessed_companies` (CSVDataSet)...</span>
<span class="go">2019-11-13 15:09:02,112 - ProfileTimeTransformer - INFO - Saving preprocessed_companies took 0.232 seconds</span>
<span class="go">2019-11-13 15:09:02,113 - kedro.runner.sequential_runner - INFO - Completed 1 out of 6 tasks</span>
<span class="go">...</span>
</pre></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">ProfileTimeTransformer</span> <span class="pre">-</span> <span class="pre">INFO</span></code> log messages report the latency of dataset load and save operations.</p>
</div>
<div class="section" id="transformer-scope">
<h3>Transformer scope<a class="headerlink" href="#transformer-scope" title="Permalink to this headline">¶</a></h3>
<p>You can refine the scope of the transformer by specifying an optional list of the datasets it is applied to in <code class="docutils literal notranslate"><span class="pre">add_transformer</span></code>.</p>
<p>For example, the command <code class="docutils literal notranslate"><span class="pre">catalog.add_transformer(profile_time,</span> <span class="pre">[&quot;dataset1&quot;,</span> <span class="pre">&quot;dataset2&quot;])</span></code> applies the <code class="docutils literal notranslate"><span class="pre">profile_time</span></code> transformer <em>only</em> to the datasets named <code class="docutils literal notranslate"><span class="pre">dataset1</span></code> and <code class="docutils literal notranslate"><span class="pre">dataset2</span></code>.</p>
<p>This is useful when you need to apply a transformer to just a subset of datasets.</p>
</div>
</div>
<div class="section" id="versioning-datasets-and-ml-models">
<h2>Versioning datasets and ML models<a class="headerlink" href="#versioning-datasets-and-ml-models" title="Permalink to this headline">¶</a></h2>
<p>Making a simple addition to your Data Catalog allows you to perform versioning of datasets and machine learning models.</p>
<p>Consider the following versioned dataset defined in the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code>:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">cars.csv</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/01_raw/company/cars.csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">versioned</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">True</span><span class="w"></span>
</pre></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> will create a versioned <code class="docutils literal notranslate"><span class="pre">CSVDataSet</span></code> called <code class="docutils literal notranslate"><span class="pre">cars.csv</span></code>. The actual csv file location will look like <code class="docutils literal notranslate"><span class="pre">data/01_raw/company/cars.csv/&lt;version&gt;/cars.csv</span></code>, where <code class="docutils literal notranslate"><span class="pre">&lt;version&gt;</span></code> corresponds to a global save version string formatted as <code class="docutils literal notranslate"><span class="pre">YYYY-MM-DDThh.mm.ss.sssZ</span></code>.</p>
<p>You can run the pipeline with a particular versioned data set with <code class="docutils literal notranslate"><span class="pre">--load-version</span></code> flag as follows:</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span>kedro run --load-version<span class="o">=</span><span class="s2">&quot;cars.csv:YYYY-MM-DDThh.mm.ss.sssZ&quot;</span>
</pre></div>
</div>
<p>where <code class="docutils literal notranslate"><span class="pre">--load-version</span></code> is dataset name and version timestamp separated by <code class="docutils literal notranslate"><span class="pre">:</span></code>.</p>
<p>This section shows just the very basics of versioning, which is described further in the documentation about <a class="reference internal" href="02_kedro_io.html#versioning"><span class="std std-ref">Kedro IO</span></a>.</p>
</div>
<div class="section" id="using-the-data-catalog-with-the-code-api">
<h2>Using the Data Catalog with the Code API<a class="headerlink" href="#using-the-data-catalog-with-the-code-api" title="Permalink to this headline">¶</a></h2>
<p>The code API allows you to:</p>
<ul class="simple">
<li><p>configure data sources in code</p></li>
<li><p>operate the IO module within notebooks</p></li>
</ul>
<div class="section" id="configuring-a-data-catalog">
<h3>Configuring a Data Catalog<a class="headerlink" href="#configuring-a-data-catalog" title="Permalink to this headline">¶</a></h3>
<p>In a file like <code class="docutils literal notranslate"><span class="pre">catalog.py</span></code>, you can construct a <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> object programmatically. In the following, we are using a number of pre-built data loaders documented in the <a class="reference internal" href="../kedro.extras.datasets.html"><span class="doc">API reference documentation</span></a>.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">DataCatalog</span>
<span class="kn">from</span> <span class="nn">kedro.extras.datasets.pandas</span> <span class="kn">import</span> <span class="p">(</span>
    <span class="n">CSVDataSet</span><span class="p">,</span>
    <span class="n">SQLTableDataSet</span><span class="p">,</span>
    <span class="n">SQLQueryDataSet</span><span class="p">,</span>
    <span class="n">ParquetDataSet</span><span class="p">,</span>
<span class="p">)</span>

<span class="n">io</span> <span class="o">=</span> <span class="n">DataCatalog</span><span class="p">(</span>
    <span class="p">{</span>
        <span class="s2">&quot;bikes&quot;</span><span class="p">:</span> <span class="n">CSVDataSet</span><span class="p">(</span><span class="n">filepath</span><span class="o">=</span><span class="s2">&quot;../data/01_raw/bikes.csv&quot;</span><span class="p">),</span>
        <span class="s2">&quot;cars&quot;</span><span class="p">:</span> <span class="n">CSVDataSet</span><span class="p">(</span><span class="n">filepath</span><span class="o">=</span><span class="s2">&quot;../data/01_raw/cars.csv&quot;</span><span class="p">,</span> <span class="n">load_args</span><span class="o">=</span><span class="nb">dict</span><span class="p">(</span><span class="n">sep</span><span class="o">=</span><span class="s2">&quot;,&quot;</span><span class="p">)),</span>
        <span class="s2">&quot;cars_table&quot;</span><span class="p">:</span> <span class="n">SQLTableDataSet</span><span class="p">(</span>
            <span class="n">table_name</span><span class="o">=</span><span class="s2">&quot;cars&quot;</span><span class="p">,</span> <span class="n">credentials</span><span class="o">=</span><span class="nb">dict</span><span class="p">(</span><span class="n">con</span><span class="o">=</span><span class="s2">&quot;sqlite:///kedro.db&quot;</span><span class="p">)</span>
        <span class="p">),</span>
        <span class="s2">&quot;scooters_query&quot;</span><span class="p">:</span> <span class="n">SQLQueryDataSet</span><span class="p">(</span>
            <span class="n">sql</span><span class="o">=</span><span class="s2">&quot;select * from cars where gear=4&quot;</span><span class="p">,</span>
            <span class="n">credentials</span><span class="o">=</span><span class="nb">dict</span><span class="p">(</span><span class="n">con</span><span class="o">=</span><span class="s2">&quot;sqlite:///kedro.db&quot;</span><span class="p">),</span>
        <span class="p">),</span>
        <span class="s2">&quot;ranked&quot;</span><span class="p">:</span> <span class="n">ParquetDataSet</span><span class="p">(</span><span class="n">filepath</span><span class="o">=</span><span class="s2">&quot;ranked.parquet&quot;</span><span class="p">),</span>
    <span class="p">}</span>
<span class="p">)</span>
</pre></div>
</div>
<p>When using <code class="docutils literal notranslate"><span class="pre">SQLTableDataSet</span></code> or <code class="docutils literal notranslate"><span class="pre">SQLQueryDataSet</span></code> you must provide a <code class="docutils literal notranslate"><span class="pre">con</span></code> key containing <a class="reference external" href="https://docs.sqlalchemy.org/en/13/core/engines.html#database-urls">SQLAlchemy compatible</a> database connection string. In the example above we pass it as part of <code class="docutils literal notranslate"><span class="pre">credentials</span></code> argument. Alternative to <code class="docutils literal notranslate"><span class="pre">credentials</span></code> is to put <code class="docutils literal notranslate"><span class="pre">con</span></code> into <code class="docutils literal notranslate"><span class="pre">load_args</span></code> and <code class="docutils literal notranslate"><span class="pre">save_args</span></code> (<code class="docutils literal notranslate"><span class="pre">SQLTableDataSet</span></code> only).</p>
</div>
<div class="section" id="loading-datasets">
<h3>Loading datasets<a class="headerlink" href="#loading-datasets" title="Permalink to this headline">¶</a></h3>
<p>You can access each dataset by its name.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">cars</span> <span class="o">=</span> <span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;cars&quot;</span><span class="p">)</span>  <span class="c1"># data is now loaded as a DataFrame in &#39;cars&#39;</span>
<span class="n">gear</span> <span class="o">=</span> <span class="n">cars</span><span class="p">[</span><span class="s2">&quot;gear&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">values</span>
</pre></div>
</div>
<div class="section" id="behind-the-scenes">
<h4>Behind the scenes<a class="headerlink" href="#behind-the-scenes" title="Permalink to this headline">¶</a></h4>
<p>The following steps happened behind the scenes when <code class="docutils literal notranslate"><span class="pre">load</span></code> was called:</p>
<ul class="simple">
<li><p>The value <code class="docutils literal notranslate"><span class="pre">cars</span></code> was located in the Data Catalog</p></li>
<li><p>The corresponding <code class="docutils literal notranslate"><span class="pre">AbstractDataSet</span></code> object was retrieved</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">load</span></code> method of this dataset was called</p></li>
<li><p>This <code class="docutils literal notranslate"><span class="pre">load</span></code> method delegated the loading to the underlying pandas <code class="docutils literal notranslate"><span class="pre">read_csv</span></code> function</p></li>
</ul>
</div>
</div>
<div class="section" id="viewing-the-available-data-sources">
<h3>Viewing the available data sources<a class="headerlink" href="#viewing-the-available-data-sources" title="Permalink to this headline">¶</a></h3>
<p>If you forget what data was assigned, you can always review the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code>.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">io</span><span class="o">.</span><span class="n">list</span><span class="p">()</span>
</pre></div>
</div>
</div>
<div class="section" id="saving-data">
<h3>Saving data<a class="headerlink" href="#saving-data" title="Permalink to this headline">¶</a></h3>
<p>You can save data using an API similar to that used to load data.</p>
<div class="admonition caution">
<p class="admonition-title">Caution</p>
<p>This use is not recommended unless you are prototyping in notebooks.</p>
</div>
<div class="section" id="saving-data-to-memory">
<h4>Saving data to memory<a class="headerlink" href="#saving-data-to-memory" title="Permalink to this headline">¶</a></h4>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">MemoryDataSet</span>

<span class="n">memory</span> <span class="o">=</span> <span class="n">MemoryDataSet</span><span class="p">(</span><span class="n">data</span><span class="o">=</span><span class="kc">None</span><span class="p">)</span>
<span class="n">io</span><span class="o">.</span><span class="n">add</span><span class="p">(</span><span class="s2">&quot;cars_cache&quot;</span><span class="p">,</span> <span class="n">memory</span><span class="p">)</span>
<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;cars_cache&quot;</span><span class="p">,</span> <span class="s2">&quot;Memory can store anything.&quot;</span><span class="p">)</span>
<span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;car_cache&quot;</span><span class="p">)</span>
</pre></div>
</div>
</div>
<div class="section" id="saving-data-to-a-sql-database-for-querying">
<h4>Saving data to a SQL database for querying<a class="headerlink" href="#saving-data-to-a-sql-database-for-querying" title="Permalink to this headline">¶</a></h4>
<p>At this point we may want to put the data in a SQLite database to run queries on it. Let’s use that to rank scooters by their mpg.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">os</span>

<span class="c1"># This cleans up the database in case it exists at this point</span>
<span class="k">try</span><span class="p">:</span>
    <span class="n">os</span><span class="o">.</span><span class="n">remove</span><span class="p">(</span><span class="s2">&quot;kedro.db&quot;</span><span class="p">)</span>
<span class="k">except</span> <span class="ne">FileNotFoundError</span><span class="p">:</span>
    <span class="k">pass</span>

<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;cars_table&quot;</span><span class="p">,</span> <span class="n">cars</span><span class="p">)</span>
<span class="n">ranked</span> <span class="o">=</span> <span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;scooters_query&quot;</span><span class="p">)[[</span><span class="s2">&quot;brand&quot;</span><span class="p">,</span> <span class="s2">&quot;mpg&quot;</span><span class="p">]]</span>
</pre></div>
</div>
</div>
<div class="section" id="saving-data-in-parquet">
<h4>Saving data in Parquet<a class="headerlink" href="#saving-data-in-parquet" title="Permalink to this headline">¶</a></h4>
<p>Finally we can save the processed data in Parquet format.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;ranked&quot;</span><span class="p">,</span> <span class="n">ranked</span><span class="p">)</span>
</pre></div>
</div>
<div class="admonition attention">
<p class="admonition-title">Attention</p>
<p>Saving <code class="docutils literal notranslate"><span class="pre">None</span></code> to a dataset is not allowed!</p>
</div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="02_kedro_io.html" class="btn btn-neutral float-right" title="Kedro IO" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="../04_kedro_project_setup/04_mini_kedro.html" class="btn btn-neutral" title="The mini-kedro Kedro starter" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left"></span> Previous</a>
