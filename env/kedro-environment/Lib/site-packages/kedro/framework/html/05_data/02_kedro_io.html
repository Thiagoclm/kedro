...
<head>
  ...
  <title>Kedro IO &mdash; Kedro 0.17.7 documentation</title>
  ...
  <link rel="stylesheet" href="../_static/css/theme-overrides.css" type="text/css" />
    ...
    <link rel="next" title="Nodes" href="../06_nodes_and_pipelines/01_nodes.html" />
    <link rel="prev" title="The Data Catalog" href="01_data_catalog.html" />
...
<ul class="current">
<li class="toctree-l1"><a class="reference internal" href="01_data_catalog.html">The Data Catalog</a><ul>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#using-the-data-catalog-within-kedro-configuration">Using the Data Catalog within Kedro configuration</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#specifying-the-location-of-the-dataset">Specifying the location of the dataset</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#data-catalog-args-parameters">Data Catalog <code class="docutils literal notranslate"><span class="pre">*_args</span></code> parameters</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#using-the-data-catalog-with-the-yaml-api">Using the Data Catalog with the YAML API</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#creating-a-data-catalog-yaml-configuration-file-via-cli">Creating a Data Catalog YAML configuration file via CLI</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#adding-parameters">Adding parameters</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#feeding-in-credentials">Feeding in credentials</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#loading-multiple-datasets-that-have-similar-configuration">Loading multiple datasets that have similar configuration</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#transcoding-datasets">Transcoding datasets</a><ul>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#a-typical-example-of-transcoding">A typical example of transcoding</a></li>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#how-does-transcoding-work">How does transcoding work?</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#transforming-datasets">Transforming datasets</a><ul>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#applying-built-in-transformers">Applying built-in transformers</a></li>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#transformer-scope">Transformer scope</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#versioning-datasets-and-ml-models">Versioning datasets and ML models</a></li>
<li class="toctree-l2"><a class="reference internal" href="01_data_catalog.html#using-the-data-catalog-with-the-code-api">Using the Data Catalog with the Code API</a><ul>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#configuring-a-data-catalog">Configuring a Data Catalog</a></li>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#loading-datasets">Loading datasets</a><ul>
<li class="toctree-l4"><a class="reference internal" href="01_data_catalog.html#behind-the-scenes">Behind the scenes</a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#viewing-the-available-data-sources">Viewing the available data sources</a></li>
<li class="toctree-l3"><a class="reference internal" href="01_data_catalog.html#saving-data">Saving data</a><ul>
<li class="toctree-l4"><a class="reference internal" href="01_data_catalog.html#saving-data-to-memory">Saving data to memory</a></li>
<li class="toctree-l4"><a class="reference internal" href="01_data_catalog.html#saving-data-to-a-sql-database-for-querying">Saving data to a SQL database for querying</a></li>
<li class="toctree-l4"><a class="reference internal" href="01_data_catalog.html#saving-data-in-parquet">Saving data in Parquet</a></li>
</ul>
</li>
</ul>
</li>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Kedro IO</a><ul>
<li class="toctree-l2"><a class="reference internal" href="#error-handling">Error handling</a></li>
<li class="toctree-l2"><a class="reference internal" href="#abstractdataset">AbstractDataSet</a></li>
<li class="toctree-l2"><a class="reference internal" href="#versioning">Versioning</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#version-namedtuple"><code class="docutils literal notranslate"><span class="pre">version</span></code> namedtuple</a></li>
<li class="toctree-l3"><a class="reference internal" href="#versioning-using-the-yaml-api">Versioning using the YAML API</a></li>
<li class="toctree-l3"><a class="reference internal" href="#versioning-using-the-code-api">Versioning using the Code API</a></li>
<li class="toctree-l3"><a class="reference internal" href="#supported-datasets">Supported datasets</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="#partitioned-dataset">Partitioned dataset</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#partitioned-dataset-definition">Partitioned dataset definition</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#dataset-definition">Dataset definition</a></li>
<li class="toctree-l4"><a class="reference internal" href="#partitioned-dataset-credentials">Partitioned dataset credentials</a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#partitioned-dataset-load">Partitioned dataset load</a></li>
<li class="toctree-l3"><a class="reference internal" href="#partitioned-dataset-save">Partitioned dataset save</a></li>
<li class="toctree-l3"><a class="reference internal" href="#incremental-loads-with-incrementaldataset">Incremental loads with <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code></a><ul>
<li class="toctree-l4"><a class="reference internal" href="#incremental-dataset-load">Incremental dataset load</a></li>
<li class="toctree-l4"><a class="reference internal" href="#incremental-dataset-save">Incremental dataset save</a></li>
<li class="toctree-l4"><a class="reference internal" href="#incremental-dataset-confirm">Incremental dataset confirm</a></li>
<li class="toctree-l4"><a class="reference internal" href="#checkpoint-configuration">Checkpoint configuration</a></li>
<li class="toctree-l4"><a class="reference internal" href="#special-checkpoint-config-keys">Special checkpoint config keys</a></li>
</ul>
</li>
</ul>
</li>
...
<div class="section" id="kedro-io">
<h1>Kedro IO<a class="headerlink" href="#kedro-io" title="Permalink to this headline">¶</a></h1>
<p>In this tutorial, we cover advanced uses of the <a class="reference internal" href="../kedro.io.html"><span class="std std-ref">Kedro IO</span></a> module to understand the underlying implementation. The relevant API documentation is <a class="reference internal" href="../kedro.io.AbstractDataSet.html"><span class="doc">kedro.io.AbstractDataSet</span></a> and <a class="reference internal" href="../kedro.io.DataSetError.html"><span class="doc">kedro.io.DataSetError</span></a>.</p>
<div class="section" id="error-handling">
<h2>Error handling<a class="headerlink" href="#error-handling" title="Permalink to this headline">¶</a></h2>
<p>We have custom exceptions for the main classes of errors that you can handle to deal with failures.</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="o">*</span>
</pre></div>
</div>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">io</span> <span class="o">=</span> <span class="n">DataCatalog</span><span class="p">(</span><span class="n">data_sets</span><span class="o">=</span><span class="nb">dict</span><span class="p">())</span>  <span class="c1"># empty catalog</span>

<span class="k">try</span><span class="p">:</span>
    <span class="n">cars_df</span> <span class="o">=</span> <span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;cars&quot;</span><span class="p">)</span>
...
<div class="section" id="abstractdataset">
<h2>AbstractDataSet<a class="headerlink" href="#abstractdataset" title="Permalink to this headline">¶</a></h2>
<p>To understand what is going on behind the scenes, you should study the <a class="reference internal" href="../kedro.io.AbstractDataSet.html"><span class="doc">AbstractDataSet interface</span></a>. <code class="docutils literal notranslate"><span class="pre">AbstractDataSet</span></code> is the underlying interface that all datasets extend. It requires subclasses to override the <code class="docutils literal notranslate"><span class="pre">_load</span></code> and <code class="docutils literal notranslate"><span class="pre">_save</span></code> and provides <code class="docutils literal notranslate"><span class="pre">load</span></code> and <code class="docutils literal notranslate"><span class="pre">save</span></code> methods that enrich the corresponding private methods with uniform error handling. It also requires subclasses to override <code class="docutils literal notranslate"><span class="pre">_describe</span></code>, which is used in logging the internal information about the instances of your custom <code class="docutils literal notranslate"><span class="pre">AbstractDataSet</span></code> implementation.</p>
<p>If you have a dataset called <code class="docutils literal notranslate"><span class="pre">parts</span></code>, you can make direct calls to it like so:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">parts_df</span> <span class="o">=</span> <span class="n">parts</span><span class="o">.</span><span class="n">load</span><span class="p">()</span>
</pre></div>
</div>
<p>However, we recommend using a <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> instead (for more details, see <a class="reference internal" href="01_data_catalog.html"><span class="doc">this section</span></a> in the User Guide) as it has been designed to make all datasets available to project members.</p>
<p>For contributors, if you would like to submit a new dataset, you will have to extend <code class="docutils literal notranslate"><span class="pre">AbstractDataSet</span></code>. For a complete guide, please read <a class="reference internal" href="../07_extend_kedro/03_custom_datasets.html"><span class="doc">Creating a new dataset</span></a>.</p>
</div>
<div class="section" id="versioning">
<h2>Versioning<a class="headerlink" href="#versioning" title="Permalink to this headline">¶</a></h2>
<p>In order to enable versioning, you need to update the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> config file and set the <code class="docutils literal notranslate"><span class="pre">versioned</span></code> attribute to <code class="docutils literal notranslate"><span class="pre">true</span></code> for the given dataset. If this is a custom dataset, the implementation must also:</p>
<ol class="simple">
<li><p>extend <code class="docutils literal notranslate"><span class="pre">kedro.io.core.AbstractVersionedDataSet</span></code> AND</p></li>
<li><p>add <code class="docutils literal notranslate"><span class="pre">version</span></code> namedtuple as an argument to its <code class="docutils literal notranslate"><span class="pre">__init__</span></code> method AND</p></li>
<li><p>call <code class="docutils literal notranslate"><span class="pre">super().__init__()</span></code> with positional arguments <code class="docutils literal notranslate"><span class="pre">filepath</span></code>, <code class="docutils literal notranslate"><span class="pre">version</span></code>, and, optionally, with <code class="docutils literal notranslate"><span class="pre">glob</span></code> and <code class="docutils literal notranslate"><span class="pre">exists</span></code> functions if it uses a non-local filesystem (see <a class="reference internal" href="../kedro.extras.datasets.pandas.CSVDataSet.html"><span class="doc">kedro.extras.datasets.pandas.CSVDataSet</span></a> as an example) AND</p></li>
<li><p>modify its <code class="docutils literal notranslate"><span class="pre">_describe</span></code>, <code class="docutils literal notranslate"><span class="pre">_load</span></code> and <code class="docutils literal notranslate"><span class="pre">_save</span></code> methods respectively to support versioning (see <a class="reference internal" href="../kedro.extras.datasets.pandas.CSVDataSet.html"><span class="doc">kedro.extras.datasets.pandas.CSVDataSet</span></a> for an example implementation)</p></li>
</ol>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If a new version of a dataset is created mid-run, for instance by an external system adding new files, it will not interfere in the current run, i.e. the load version stays the same throughout subsequent loads.</p>
</div>
<p>An example dataset could look similar to the below:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">pathlib</span> <span class="kn">import</span> <span class="n">Path</span><span class="p">,</span> <span class="n">PurePosixPath</span>

<span class="kn">import</span> <span class="nn">pandas</span> <span class="k">as</span> <span class="nn">pd</span>

<span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">AbstractVersionedDataSet</span>


<span class="k">class</span> <span class="nc">MyOwnDataSet</span><span class="p">(</span><span class="n">AbstractVersionedDataSet</span><span class="p">):</span>
    <span class="k">def</span> <span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">filepath</span><span class="p">,</span> <span class="n">version</span><span class="p">,</span> <span class="n">param1</span><span class="p">,</span> <span class="n">param2</span><span class="o">=</span><span class="kc">True</span><span class="p">):</span>
        <span class="nb">super</span><span class="p">()</span><span class="o">.</span><span class="fm">__init__</span><span class="p">(</span><span class="n">PurePosixPath</span><span class="p">(</span><span class="n">filepath</span><span class="p">),</span> <span class="n">version</span><span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">_load</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">:</span>
        <span class="n">load_path</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_load_path</span><span class="p">()</span>
        <span class="k">return</span> <span class="n">pd</span><span class="o">.</span><span class="n">read_csv</span><span class="p">(</span><span class="n">load_path</span><span class="p">)</span>

    <span class="k">def</span> <span class="nf">_save</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">df</span><span class="p">:</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kc">None</span><span class="p">:</span>
        <span class="n">save_path</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_save_path</span><span class="p">()</span>
    ...
    <span class="k">def</span> <span class="nf">_exists</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">bool</span><span class="p">:</span>
        <span class="n">path</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">_get_load_path</span><span class="p">()</span>
    ...
    <span class="k">def</span> <span class="nf">_describe</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
<p>With <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> specifying:</p>
...
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">&lt;path-to-my-own-dataset&gt;.MyOwnDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/01_raw/my_data.csv</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">param1</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">&lt;param1-value&gt;</span><span class="w"> </span><span class="c1"># param1 is a required argument</span><span class="w"></span>
<span class="w">  </span><span class="c1"># param2 will be True by default</span><span class="w"></span>
</pre></div>
</div>
<div class="section" id="version-namedtuple">
<h3><code class="docutils literal notranslate"><span class="pre">version</span></code> namedtuple<a class="headerlink" href="#version-namedtuple" title="Permalink to this headline">¶</a></h3>
<p>Versioned dataset <code class="docutils literal notranslate"><span class="pre">__init__</span></code> method must have an optional argument called <code class="docutils literal notranslate"><span class="pre">version</span></code> with a default value of <code class="docutils literal notranslate"><span class="pre">None</span></code>. If provided, this argument must be an instance of <a class="reference internal" href="../kedro.io.Version.html"><span class="doc">kedro.io.core.Version</span></a>. Its <code class="docutils literal notranslate"><span class="pre">load</span></code> and <code class="docutils literal notranslate"><span class="pre">save</span></code> attributes must either be <code class="docutils literal notranslate"><span class="pre">None</span></code> or contain string values representing exact load and save versions:</p>
<ul class="simple">
<li><p>If <code class="docutils literal notranslate"><span class="pre">version</span></code> is <code class="docutils literal notranslate"><span class="pre">None</span></code> then the dataset is considered <em>not versioned</em>.</p></li>
<li><p>If <code class="docutils literal notranslate"><span class="pre">version.load</span></code> is <code class="docutils literal notranslate"><span class="pre">None</span></code> then the latest available version will be used to load the dataset, otherwise a string representing exact load version must be provided.</p></li>
<li><p>If <code class="docutils literal notranslate"><span class="pre">version.save</span></code> is <code class="docutils literal notranslate"><span class="pre">None</span></code> then a new save version string will be generated by calling <code class="docutils literal notranslate"><span class="pre">kedro.io.core.generate_timestamp()</span></code>, otherwise a string representing exact save version must be provided.</p></li>
</ul>
</div>
<div class="section" id="versioning-using-the-yaml-api">
<h3>Versioning using the YAML API<a class="headerlink" href="#versioning-using-the-yaml-api" title="Permalink to this headline">¶</a></h3>
<p>The easiest way to version a specific dataset is to change the corresponding entry in the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code>. For example, if the following dataset was defined in the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code>:</p>
...
<span class="w">  </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">data/01_raw/company/car_data.csv</span><span class="w"></span>
<span class="w">  </span><span class="nt">versioned</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">true</span><span class="w"></span>
</pre></div>
</div>
<p>The <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> will create a versioned <code class="docutils literal notranslate"><span class="pre">CSVDataSet</span></code> called <code class="docutils literal notranslate"><span class="pre">cars</span></code>. The actual csv file location will look like <code class="docutils literal notranslate"><span class="pre">data/01_raw/company/car_data.csv/&lt;version&gt;/car_data.csv</span></code>, where <code class="docutils literal notranslate"><span class="pre">&lt;version&gt;</span></code> corresponds to a global save version string formatted as <code class="docutils literal notranslate"><span class="pre">YYYY-MM-DDThh.mm.ss.sssZ</span></code>. Every time the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> is instantiated, it generates a new global save version, which is propagated to all versioned datasets it contains.</p>
<p><code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> only allows you to version your datasets but it does not allow you to choose which version to load or save. This is deliberate because we have chosen to separate the data catalog from any runtime configuration. If you need to pin a dataset version, you can either <a class="reference internal" href="../04_kedro_project_setup/02_configuration.html#configure-kedro-run-arguments"><span class="std std-ref">specify the versions in a separate yml file and call it at runtime</span></a> or <a class="reference external" href="#versioning-using-the-code-api">instantiate your versioned datasets using Code API and define a version parameter explicitly</a>.</p>
<p>By default, the <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> will load the latest version of the dataset. However, it is also possible to specify an exact load version. In order to do that, you can pass a dictionary with exact load versions to <code class="docutils literal notranslate"><span class="pre">DataCatalog.from_config</span></code>:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">load_versions</span> <span class="o">=</span> <span class="p">{</span><span class="s2">&quot;cars&quot;</span><span class="p">:</span> <span class="s2">&quot;2019-02-13T14.35.36.518Z&quot;</span><span class="p">}</span>
<span class="n">io</span> <span class="o">=</span> <span class="n">DataCatalog</span><span class="o">.</span><span class="n">from_config</span><span class="p">(</span><span class="n">catalog_config</span><span class="p">,</span> <span class="n">credentials</span><span class="p">,</span> <span class="n">load_versions</span><span class="o">=</span><span class="n">load_versions</span><span class="p">)</span>
<span class="n">cars</span> <span class="o">=</span> <span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;cars&quot;</span><span class="p">)</span>
</pre></div>
</div>
<p>The last row in the example above would attempt to load a CSV file from <code class="docutils literal notranslate"><span class="pre">data/01_raw/company/car_data.csv/2019-02-13T14.35.36.518Z/car_data.csv</span></code>:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">load_versions</span></code> configuration has an effect only if a dataset versioning has been enabled in the catalog config file - see the example above.</p></li>
<li><p>We recommend that you do not override <code class="docutils literal notranslate"><span class="pre">save_version</span></code> argument in <code class="docutils literal notranslate"><span class="pre">DataCatalog.from_config</span></code> unless strongly required to do so, since it may lead to inconsistencies between loaded and saved versions of the versioned datasets.</p></li>
</ul>
<div class="admonition attention">
<p class="admonition-title">Attention</p>
<p>The <code class="docutils literal notranslate"><span class="pre">DataCatalog</span></code> does not re-generate save versions between instantiations. Therefore, if you call <code class="docutils literal notranslate"><span class="pre">catalog.save('cars',</span> <span class="pre">some_data)</span></code> twice, then the second call will fail, since it tries to overwrite a versioned dataset using the same save version. To mitigate this, reload your data catalog by calling <code class="docutils literal notranslate"><span class="pre">%reload_kedro</span></code> line magic. This limitation does not apply to <code class="docutils literal notranslate"><span class="pre">load</span></code> operation.</p>
</div>
</div>
<div class="section" id="versioning-using-the-code-api">
<h3>Versioning using the Code API<a class="headerlink" href="#versioning-using-the-code-api" title="Permalink to this headline">¶</a></h3>
<p>Although we recommend enabling versioning using the <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> config file as described in the section above, you may require more control over load and save versions of a specific dataset. To achieve this you can instantiate <code class="docutils literal notranslate"><span class="pre">Version</span></code> and pass it as a parameter to the dataset initialisation:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">DataCatalog</span><span class="p">,</span> <span class="n">Version</span>
...
<span class="n">data1</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">({</span><span class="s2">&quot;col1&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">],</span> <span class="s2">&quot;col2&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">4</span><span class="p">,</span> <span class="mi">5</span><span class="p">],</span> <span class="s2">&quot;col3&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">5</span><span class="p">,</span> <span class="mi">6</span><span class="p">]})</span>
<span class="n">data2</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">({</span><span class="s2">&quot;col1&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">7</span><span class="p">],</span> <span class="s2">&quot;col2&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">8</span><span class="p">],</span> <span class="s2">&quot;col3&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">9</span><span class="p">]})</span>
<span class="n">version</span> <span class="o">=</span> <span class="n">Version</span><span class="p">(</span>
    <span class="n">load</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>  <span class="c1"># load the latest available version</span>
    <span class="n">save</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>  <span class="c1"># generate save version automatically on each save operation</span>
<span class="p">)</span>

<span class="n">test_data_set</span> <span class="o">=</span> <span class="n">CSVDataSet</span><span class="p">(</span>
    <span class="n">filepath</span><span class="o">=</span><span class="s2">&quot;data/01_raw/test.csv&quot;</span><span class="p">,</span> <span class="n">save_args</span><span class="o">=</span><span class="p">{</span><span class="s2">&quot;index&quot;</span><span class="p">:</span> <span class="kc">False</span><span class="p">},</span> <span class="n">version</span><span class="o">=</span><span class="n">version</span>
<span class="p">)</span>
<span class="n">io</span> <span class="o">=</span> <span class="n">DataCatalog</span><span class="p">({</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">:</span> <span class="n">test_data_set</span><span class="p">})</span>

<span class="c1"># save the dataset to data/01_raw/test.csv/&lt;version&gt;/test.csv</span>
<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">,</span> <span class="n">data1</span><span class="p">)</span>
<span class="c1"># save the dataset into a new file data/01_raw/test.csv/&lt;version&gt;/test.csv</span>
<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">,</span> <span class="n">data2</span><span class="p">)</span>

<span class="c1"># load the latest version from data/test.csv/*/test.csv</span>
<span class="n">reloaded</span> <span class="o">=</span> <span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">)</span>
<span class="k">assert</span> <span class="n">data2</span><span class="o">.</span><span class="n">equals</span><span class="p">(</span><span class="n">reloaded</span><span class="p">)</span>
</pre></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>In the example above we did not fix any versions. If we do, then the behaviour of load and save operations becomes slightly different:</p>
</div>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">version</span> <span class="o">=</span> <span class="n">Version</span><span class="p">(</span>
    <span class="n">load</span><span class="o">=</span><span class="s2">&quot;my_exact_version&quot;</span><span class="p">,</span>  <span class="c1"># load exact version</span>
    <span class="n">save</span><span class="o">=</span><span class="s2">&quot;my_exact_version&quot;</span><span class="p">,</span>  <span class="c1"># save to exact version</span>
<span class="p">)</span>
...
<span class="c1"># save the dataset to data/01_raw/test.csv/my_exact_version/test.csv</span>
<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">,</span> <span class="n">data1</span><span class="p">)</span>
<span class="c1"># load from data/01_raw/test.csv/my_exact_version/test.csv</span>
<span class="n">reloaded</span> <span class="o">=</span> <span class="n">io</span><span class="o">.</span><span class="n">load</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">)</span>
<span class="k">assert</span> <span class="n">data1</span><span class="o">.</span><span class="n">equals</span><span class="p">(</span><span class="n">reloaded</span><span class="p">)</span>

<span class="c1"># raises DataSetError since the path</span>
<span class="c1"># data/01_raw/test.csv/my_exact_version/test.csv already exists</span>
<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">,</span> <span class="n">data2</span><span class="p">)</span>
</pre></div>
</div>
<div class="admonition attention">
<p class="admonition-title">Attention</p>
<p>Passing exact load and/or save versions to the dataset instantiation is not recommended, since it may lead to inconsistencies between operations. For example, if versions for load and save operations do not match, save operation would result in a <code class="docutils literal notranslate"><span class="pre">UserWarning</span></code> indicating that save a load versions do not match. Load after save may also return an error if the corresponding load version is not found:</p>
</div>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="n">version</span> <span class="o">=</span> <span class="n">Version</span><span class="p">(</span>
    <span class="n">load</span><span class="o">=</span><span class="s2">&quot;exact_load_version&quot;</span><span class="p">,</span>  <span class="c1"># load exact version</span>
    <span class="n">save</span><span class="o">=</span><span class="s2">&quot;exact_save_version&quot;</span><span class="p">,</span>  <span class="c1"># save to exact version</span>
<span class="p">)</span>
...
<span class="n">io</span><span class="o">.</span><span class="n">save</span><span class="p">(</span><span class="s2">&quot;test_data_set&quot;</span><span class="p">,</span> <span class="n">data1</span><span class="p">)</span>  <span class="c1"># emits a UserWarning due to version inconsistency</span>

<span class="c1"># raises DataSetError since the data/01_raw/test.csv/exact_load_version/test.csv</span>
...
<p>Currently the following datasets support versioning:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.matplotlib.MatplotlibWriter</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.holoviews.HoloviewsWriter</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.networkx.NetworkXDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.CSVDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.ExcelDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.FeatherDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.HDFDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.JSONDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.ParquetDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pickle.PickleDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pillow.ImageDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.text.TextDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.spark.SparkDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.yaml.YAMLDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.api.APIDataSet</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.tensorflow.TensorFlowModelDataset</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.json.JSONDataSet</span></code></p></li>
</ul>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Although, HTTPs is a supported file system in the dataset implementations, it does not support versioning.</p>
</div>
</div>
</div>
<div class="section" id="partitioned-dataset">
<h2>Partitioned dataset<a class="headerlink" href="#partitioned-dataset" title="Permalink to this headline">¶</a></h2>
<p>These days distributed systems play an increasingly important role in ETL data pipelines. They significantly increase the processing throughput, enabling us to work with much larger volumes of input data. However, these benefits sometimes come at a cost. When dealing with the input data generated by such distributed systems, you may encounter a situation where your Kedro node needs to read the data from a directory full of uniform files of the same type (e.g. JSON, CSV, Parquet, etc.) rather than from a single file. Tools like <code class="docutils literal notranslate"><span class="pre">PySpark</span></code> and the corresponding <a class="reference internal" href="../kedro.extras.datasets.spark.SparkDataSet.html"><span class="doc">SparkDataSet</span></a> cater for such use cases, but the use of Spark is not always feasible.</p>
<p>This is the reason why Kedro provides a built-in <a class="reference internal" href="../kedro.io.PartitionedDataSet.html"><span class="doc">PartitionedDataSet</span></a>, which has the following features:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> can recursively load all or specific files from a given location.</p></li>
<li><p>Is platform agnostic and can work with any filesystem implementation supported by <a class="reference external" href="https://filesystem-spec.readthedocs.io/">fsspec</a> including local, S3, GCS, and many more.</p></li>
<li><p>Implements a <a class="reference external" href="https://en.wikipedia.org/wiki/Lazy_loading">lazy loading</a> approach and does not attempt to load any partition data until a processing node explicitly requests it.</p></li>
</ul>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>In this section each individual file inside a given location is called a partition.</p>
</div>
<div class="section" id="partitioned-dataset-definition">
<h3>Partitioned dataset definition<a class="headerlink" href="#partitioned-dataset-definition" title="Permalink to this headline">¶</a></h3>
<p><code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> definition can be put in your <code class="docutils literal notranslate"><span class="pre">catalog.yml</span></code> like any other regular dataset definition; the definition represents the following structure:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="c1"># conf/base/catalog.yml</span><span class="w"></span>

<span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w">  </span><span class="c1"># path to the location of partitions</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w">  </span><span class="c1"># shorthand notation for the dataset which will handle individual partitions</span><span class="w"></span>
<span class="w">  </span><span class="nt">credentials</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">my_credentials</span><span class="w"></span>
<span class="w">  </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">load_arg1</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">value1</span><span class="w"></span>
<span class="w">    </span><span class="nt">load_arg2</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">value2</span><span class="w"></span>
</pre></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>As any other dataset <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> can also be instantiated programmatically in Python:</p>
</div>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.extras.datasets.pandas</span> <span class="kn">import</span> <span class="n">CSVDataSet</span>
<span class="kn">from</span> <span class="nn">kedro.io</span> <span class="kn">import</span> <span class="n">PartitionedDataSet</span>

<span class="n">my_credentials</span> <span class="o">=</span> <span class="p">{</span><span class="o">...</span><span class="p">}</span>  <span class="c1"># credentials dictionary</span>

<span class="n">my_partitioned_dataset</span> <span class="o">=</span> <span class="n">PartitionedDataSet</span><span class="p">(</span>
    <span class="n">path</span><span class="o">=</span><span class="s2">&quot;s3://my-bucket-name/path/to/folder&quot;</span><span class="p">,</span>
    ...
    <span class="n">load_args</span><span class="o">=</span><span class="p">{</span><span class="s2">&quot;load_arg1&quot;</span><span class="p">:</span> <span class="s2">&quot;value1&quot;</span><span class="p">,</span> <span class="s2">&quot;load_arg2&quot;</span><span class="p">:</span> <span class="s2">&quot;value2&quot;</span><span class="p">},</span>
<span class="p">)</span>
</pre></div>
</div>
<p>Alternatively, if you need more granular configuration of the underlying dataset, its definition can be provided in full:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="c1"># conf/base/catalog.yml</span><span class="w"></span>

<span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">PartitionedDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w">  </span><span class="c1"># full dataset config notation</span><span class="w"></span>
<span class="w">    </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">    </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
...
<span class="w">    </span><span class="nt">load_arg1</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">value1</span><span class="w"></span>
<span class="w">    </span><span class="nt">load_arg2</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">value2</span><span class="w"></span>
<span class="w">  </span><span class="nt">filepath_arg</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">filepath</span><span class="w">  </span><span class="c1"># the argument of the dataset to pass the filepath to</span><span class="w"></span>
...
<p>Here is an exhaustive list of the arguments supported by <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code>:</p>
...
<td><p>Yes</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">str</span></code></p></td>
<td><p>Path to the folder containing partitioned data. If path starts with the protocol (e.g., <code class="code docutils literal notranslate"><span class="pre">s3://</span></code>) then the corresponding <code class="code docutils literal notranslate"><span class="pre">fsspec</span></code> concrete filesystem implementation will be used. If protocol is not specified, local filesystem will be used</p></td>
</tr>
<tr class="row-odd"><td><p><code class="code docutils literal notranslate"><span class="pre">dataset</span></code></p></td>
<td><p>Yes</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">str</span></code>,  <code class="code docutils literal notranslate"><span class="pre">Type[AbstractDataSet]</span></code>,
<code class="code docutils literal notranslate"><span class="pre">Dict[str,</span> <span class="pre">Any]</span></code></p></td>
<td><p>Underlying dataset definition, for more details see the section below</p></td>
</tr>
<tr class="row-even"><td><p><code class="code docutils literal notranslate"><span class="pre">credentials</span></code></p></td>
<td><p>No</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">Dict[str,</span> <span class="pre">Any]</span></code></p></td>
<td><p>Protocol-specific options that will be passed to <code class="code docutils literal notranslate"><span class="pre">fsspec.filesystemcall</span></code>, for more details see the section below</p></td>
</tr>
<tr class="row-odd"><td><p><code class="code docutils literal notranslate"><span class="pre">load_args</span></code></p></td>
<td><p>No</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">Dict[str,</span> <span class="pre">Any]</span></code></p></td>
<td><p>Keyword arguments to be passed into <code class="code docutils literal notranslate"><span class="pre">find()</span></code> method of the corresponding filesystem implementation</p></td>
</tr>
<tr class="row-even"><td><p><code class="code docutils literal notranslate"><span class="pre">filepath_arg</span></code></p></td>
<td><p>No
(defaults to <code class="code docutils literal notranslate"><span class="pre">filepath</span></code>)</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">str</span></code></p></td>
<td><p>Argument name of the underlying dataset initializer that will contain a path to an individual partition</p></td>
</tr>
<tr class="row-odd"><td><p><code class="code docutils literal notranslate"><span class="pre">filename_suffix</span></code></p></td>
<td><p>No
(defaults to an empty string)</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">str</span></code></p></td>
<td><p>If specified, partitions that don’t end with this string will be ignored</p></td>
</tr>
</tbody>
</table>
<div class="section" id="dataset-definition">
<h4>Dataset definition<a class="headerlink" href="#dataset-definition" title="Permalink to this headline">¶</a></h4>
<p>Dataset definition should be passed into the <code class="docutils literal notranslate"><span class="pre">dataset</span></code> argument of the <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code>. The dataset definition is used to instantiate a new dataset object for each individual partition, and use that dataset object for load and save operations. Dataset definition supports shorthand and full notations.</p>
<div class="section" id="shorthand-notation">
<h5>Shorthand notation<a class="headerlink" href="#shorthand-notation" title="Permalink to this headline">¶</a></h5>
<p>Requires you to only specify a class of the underlying dataset either as a string (e.g. <code class="docutils literal notranslate"><span class="pre">pandas.CSVDataSet</span></code> or a fully qualified class path like <code class="docutils literal notranslate"><span class="pre">kedro.extras.datasets.pandas.CSVDataSet</span></code>) or as a class object that is a subclass of the <a class="reference internal" href="../kedro.io.AbstractDataSet.html"><span class="doc">AbstractDataSet</span></a>.</p>
</div>
<div class="section" id="full-notation">
<h5>Full notation<a class="headerlink" href="#full-notation" title="Permalink to this headline">¶</a></h5>
<p>Full notation allows you to specify a dictionary with the full underlying dataset definition <em>except</em> the following arguments:</p>
<ul class="simple">
<li><p>The argument that receives the partition path (<code class="docutils literal notranslate"><span class="pre">filepath</span></code> by default) - if specified, a <code class="docutils literal notranslate"><span class="pre">UserWarning</span></code> will be emitted stating that this value will be overridden by individual partition paths</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">credentials</span></code> key - specifying it will result in <code class="docutils literal notranslate"><span class="pre">DataSetError</span></code> being raised; dataset credentials should be passed into <code class="docutils literal notranslate"><span class="pre">credentials</span></code> argument of the <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> rather than underlying dataset definition - see <a class="reference external" href="#partitioned-dataset-credentials">the section below</a> for details</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">versioned</span></code> flag - specifying it will result in <code class="docutils literal notranslate"><span class="pre">DataSetError</span></code> being raised; versioning cannot be enabled for the underlying datasets</p></li>
</ul>
</div>
</div>
<div class="section" id="partitioned-dataset-credentials">
<h4>Partitioned dataset credentials<a class="headerlink" href="#partitioned-dataset-credentials" title="Permalink to this headline">¶</a></h4>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Support for <code class="docutils literal notranslate"><span class="pre">dataset_credentials</span></code> key in the credentials for <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> is now deprecated. The dataset credentials should be specified explicitly inside the dataset config.</p>
</div>
<p>Credentials management for <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> is somewhat special in a sense that it may contain credentials for both <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> itself <em>and</em> the underlying dataset that is used for partition load and save. Top-level credentials are passed to the underlying dataset config (unless such config already has credentials configured), but not the other way around - dataset credentials are never propagated to the filesystem.</p>
<p>Here is the full list of possible scenarios:</p>
<table class="docutils align-default">
<colgroup>
<col style="width: 10%" />
<col style="width: 11%" />
...
<thead>
<tr class="row-odd"><th class="head"><p>Top-level
credentials</p></th>
<th class="head"><p>Underlying dataset
credentials</p></th>
<th class="head"><p>Example <code class="code docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> definition</p></th>
<th class="head"><p>Description</p></th>
</tr>
</thead>
<tbody>
...
<td><p>Undefined</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">PartitionedDataSet(path=&quot;s3://bucket-name/path/to/folder&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">dataset=&quot;CSVDataSet&quot;)</span></code></p></td>
<td><p>Credentials are not passed to the underlying dataset or the filesystem</p></td>
</tr>
<tr class="row-odd"><td><p>Undefined</p></td>
<td><p>Specified</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">PartitionedDataSet(path=&quot;s3://bucket-name/path/to/folder&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">dataset={&quot;type&quot;:</span> <span class="pre">&quot;CSVDataSet&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">&quot;credentials&quot;:</span> <span class="pre">{&quot;secret&quot;:</span> <span class="pre">True}})</span></code></p></td>
<td><p>Underlying dataset credentials are passed to the <code class="code docutils literal notranslate"><span class="pre">CSVDataSet</span></code>
constructor, filesystem is instantiated without credentials</p></td>
</tr>
<tr class="row-even"><td><p>Specified</p></td>
<td><p>Undefined</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">PartitionedDataSet(path=&quot;s3://bucket-name/path/to/folder&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">dataset=&quot;CSVDataSet&quot;,</span> <span class="pre">credentials={&quot;secret&quot;:</span> <span class="pre">True})</span></code></p></td>
<td><p>Top-level credentials are passed to the underlying <code class="code docutils literal notranslate"><span class="pre">CSVDataSet</span></code>
constructor and the filesystem</p></td>
</tr>
<tr class="row-odd"><td><p>Specified</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">None</span></code></p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">PartitionedDataSet(path=&quot;s3://bucket-name/path/to/folder&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">dataset={&quot;type&quot;:</span> <span class="pre">&quot;CSVDataSet&quot;,</span> <span class="pre">&quot;credentials&quot;:</span> <span class="pre">None},</span></code>
<code class="code docutils literal notranslate"><span class="pre">credentials={&quot;dataset_secret&quot;:</span> <span class="pre">True})</span></code></p></td>
<td><p>Top-level credentials are passed to the filesystem, <code class="code docutils literal notranslate"><span class="pre">CSVDataSet</span></code> is
instantiated without credentials - this way you can stop the top-level
credentials from propagating into the dataset config</p></td>
</tr>
<tr class="row-even"><td><p>Specified</p></td>
<td><p>Specified</p></td>
<td><p><code class="code docutils literal notranslate"><span class="pre">PartitionedDataSet(path=&quot;s3://bucket-name/path/to/folder&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">dataset={&quot;type&quot;:</span> <span class="pre">&quot;CSVDataSet&quot;,</span></code>
<code class="code docutils literal notranslate"><span class="pre">&quot;credentials&quot;:{&quot;dataset_secret&quot;:</span> <span class="pre">True}},</span></code>
<code class="code docutils literal notranslate"><span class="pre">credentials={&quot;secret&quot;:</span> <span class="pre">True})</span></code></p></td>
<td><p>Top-level credentials are passed to the filesystem, underlying dataset
credentials are passed to the <code class="code docutils literal notranslate"><span class="pre">CSVDataSet</span></code> constructor</p></td>
</tr>
</tbody>
</table>
</div>
</div>
<div class="section" id="partitioned-dataset-load">
<h3>Partitioned dataset load<a class="headerlink" href="#partitioned-dataset-load" title="Permalink to this headline">¶</a></h3>
<p>Let’s assume that the Kedro pipeline that you are working with contains the node defined as follows:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.pipeline</span> <span class="kn">import</span> <span class="n">node</span>

<span class="n">node</span><span class="p">(</span><span class="n">concat_partitions</span><span class="p">,</span> <span class="n">inputs</span><span class="o">=</span><span class="s2">&quot;my_partitioned_dataset&quot;</span><span class="p">,</span> <span class="n">outputs</span><span class="o">=</span><span class="s2">&quot;concatenated_result&quot;</span><span class="p">)</span>
</pre></div>
</div>
<p>The underlying node function <code class="docutils literal notranslate"><span class="pre">concat_partitions</span></code> may look like this:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">Callable</span><span class="p">,</span> <span class="n">Dict</span>
<span class="kn">import</span> <span class="nn">pandas</span> <span class="k">as</span> <span class="nn">pd</span>


<span class="k">def</span> <span class="nf">concat_partitions</span><span class="p">(</span><span class="n">partitioned_input</span><span class="p">:</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Callable</span><span class="p">[[],</span> <span class="n">Any</span><span class="p">]])</span> <span class="o">-&gt;</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">:</span>
    <span class="sd">&quot;&quot;&quot;Concatenate input partitions into one pandas DataFrame.</span>

<span class="sd">    Args:</span>
<span class="sd">        partitioned_input: A dictionary with partition ids as keys and load functions as values.</span>

<span class="sd">    Returns:</span>
<span class="sd">        Pandas DataFrame representing a concatenation of all loaded partitions.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">for</span> <span class="n">partition_key</span><span class="p">,</span> <span class="n">partition_load_func</span> <span class="ow">in</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">partitioned_input</span><span class="o">.</span><span class="n">items</span><span class="p">()):</span>
        <span class="n">partition_data</span> <span class="o">=</span> <span class="n">partition_load_func</span><span class="p">()</span>  <span class="c1"># load the actual partition data</span>
        <span class="c1"># concat with existing result</span>
        <span class="n">result</span> <span class="o">=</span> <span class="n">pd</span><span class="o">.</span><span class="n">concat</span><span class="p">([</span><span class="n">result</span><span class="p">,</span> <span class="n">partition_data</span><span class="p">],</span> <span class="n">ignore_index</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">sort</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>

    <span class="k">return</span> <span class="n">result</span>
</pre></div>
</div>
<p>As you can see from the example above, on load <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> <em>does not</em> automatically load the data from the located partitions. Instead, <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> returns a dictionary with partition IDs as keys and the corresponding load functions as values. It allows the node that consumes the <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> to implement the logic that defines what partitions need to be loaded and how this data is going to be processed.</p>
<p>Partition ID <em>does not</em> represent the whole partition path, but only a part of it that is unique for a given partition <em>and</em> filename suffix:</p>
<ul class="simple">
<li><p>Example 1: if <code class="docutils literal notranslate"><span class="pre">path=s3://my-bucket-name/folder</span></code> and partition is stored in <code class="docutils literal notranslate"><span class="pre">s3://my-bucket-name/folder/2019-12-04/data.csv</span></code> then its Partition ID is <code class="docutils literal notranslate"><span class="pre">2019-12-04/data.csv</span></code>.</p></li>
<li><p>Example 2: if <code class="docutils literal notranslate"><span class="pre">path=s3://my-bucket-name/folder</span></code> and <code class="docutils literal notranslate"><span class="pre">filename_suffix=&quot;.csv&quot;</span></code> and partition is stored in <code class="docutils literal notranslate"><span class="pre">s3://my-bucket-name/folder/2019-12-04/data.csv</span></code> then its Partition ID is <code class="docutils literal notranslate"><span class="pre">2019-12-04/data</span></code>.</p></li>
</ul>
<p><code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> implements caching on load operation, which means that if multiple nodes consume the same <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code>, they will all receive the same partition dictionary even if some new partitions were added to the folder after the first load has been completed. This is done deliberately to guarantee the consistency of load operations between the nodes and avoid race conditions. You can reset the cache by calling <code class="docutils literal notranslate"><span class="pre">release()</span></code> method of the partitioned dataset object.</p>
</div>
<div class="section" id="partitioned-dataset-save">
<h3>Partitioned dataset save<a class="headerlink" href="#partitioned-dataset-save" title="Permalink to this headline">¶</a></h3>
<p><code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> also supports a save operation. Let’s assume the following configuration:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="c1"># conf/base/catalog.yml</span><span class="w"></span>

<span class="nt">new_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">PartitionedDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">filename_suffix</span><span class="p">:</span><span class="w"> </span><span class="s">&quot;.csv&quot;</span><span class="w"></span>
</pre></div>
</div>
<p>node definition:</p>
...
<span class="n">node</span><span class="p">(</span><span class="n">create_partitions</span><span class="p">,</span> <span class="n">inputs</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">outputs</span><span class="o">=</span><span class="s2">&quot;new_partitioned_dataset&quot;</span><span class="p">)</span>
</pre></div>
</div>
<p>and underlying node function <code class="docutils literal notranslate"><span class="pre">create_partitions</span></code>:</p>
...
<span class="k">def</span> <span class="nf">create_partitions</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Any</span><span class="p">]:</span>
    <span class="sd">&quot;&quot;&quot;Create new partitions and save using PartitionedDataSet.</span>

<span class="sd">    Returns:</span>
<span class="sd">        Dictionary with the partitions to create.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">return</span> <span class="p">{</span>
        <span class="c1"># create a file &quot;s3://my-bucket-name/part/foo.csv&quot;</span>
        <span class="s2">&quot;part/foo&quot;</span><span class="p">:</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">({</span><span class="s2">&quot;data&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">]}),</span>
        <span class="c1"># create a file &quot;s3://my-bucket-name/part/bar.csv.csv&quot;</span>
        <span class="s2">&quot;part/bar.csv&quot;</span><span class="p">:</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">({</span><span class="s2">&quot;data&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">]}),</span>
    <span class="p">}</span>
</pre></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Writing to an existing partition may result in its data being overwritten, if this case is not specifically handled by the underlying dataset implementation. You should implement your own checks to ensure that no existing data is lost when writing to a <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code>. The simplest safety mechanism could be to use partition IDs that have a high chance of uniqueness: for example, the current timestamp.</p>
</div>
<p><code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code> also supports lazy saving, where the partition’s data is not materialized until it’s time to write.
To use this, simply return <code class="docutils literal notranslate"><span class="pre">Callable</span></code> types in the dictionary:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">typing</span> <span class="kn">import</span> <span class="n">Any</span><span class="p">,</span> <span class="n">Dict</span><span class="p">,</span> <span class="n">Callable</span>
<span class="kn">import</span> <span class="nn">pandas</span> <span class="k">as</span> <span class="nn">pd</span>


<span class="k">def</span> <span class="nf">create_partitions</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="n">Dict</span><span class="p">[</span><span class="nb">str</span><span class="p">,</span> <span class="n">Callable</span><span class="p">[[],</span> <span class="n">Any</span><span class="p">]]:</span>
    <span class="sd">&quot;&quot;&quot;Create new partitions and save using PartitionedDataSet.</span>

<span class="sd">    Returns:</span>
<span class="sd">        Dictionary of the partitions to create to a function that creates them.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">return</span> <span class="p">{</span>
        <span class="c1"># create a file &quot;s3://my-bucket-name/part/foo.csv&quot;</span>
        <span class="s2">&quot;part/foo&quot;</span><span class="p">:</span> <span class="k">lambda</span><span class="p">:</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">({</span><span class="s2">&quot;data&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">]}),</span>
        <span class="c1"># create a file &quot;s3://my-bucket-name/part/bar.csv&quot;</span>
        <span class="s2">&quot;part/bar&quot;</span><span class="p">:</span> <span class="k">lambda</span><span class="p">:</span> <span class="n">pd</span><span class="o">.</span><span class="n">DataFrame</span><span class="p">({</span><span class="s2">&quot;data&quot;</span><span class="p">:</span> <span class="p">[</span><span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">]}),</span>
    <span class="p">}</span>
</pre></div>
</div>
<blockquote>
<div><p><em>Note:</em> When using lazy saving the dataset will be written <em>after</em> the <code class="docutils literal notranslate"><span class="pre">after_node_run</span></code> <a class="reference internal" href="../07_extend_kedro/02_hooks.html"><span class="doc">hook</span></a>.</p>
</div></blockquote>
</div>
<div class="section" id="incremental-loads-with-incrementaldataset">
<h3>Incremental loads with <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code><a class="headerlink" href="#incremental-loads-with-incrementaldataset" title="Permalink to this headline">¶</a></h3>
<p><a class="reference internal" href="../kedro.io.IncrementalDataSet.html"><span class="doc">IncrementalDataSet</span></a> is a subclass of <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code>, which stores the information about the last processed partition in the so-called <code class="docutils literal notranslate"><span class="pre">checkpoint</span></code>. <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> addresses the use case when partitions have to be processed incrementally, i.e. each subsequent pipeline run should only process the partitions which were not processed by the previous runs.</p>
<p>This checkpoint, by default, is persisted to the location of the data partitions. For example, for <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> instantiated with path <code class="docutils literal notranslate"><span class="pre">s3://my-bucket-name/path/to/folder</span></code> the checkpoint will be saved to <code class="docutils literal notranslate"><span class="pre">s3://my-bucket-name/path/to/folder/CHECKPOINT</span></code>, unless the checkpoint configuration is <a class="reference external" href="#checkpoint-configuration">explicitly overwritten</a>.</p>
<p>The checkpoint file is only created <em>after</em> the partitioned dataset is explicitly <a class="reference external" href="#incremental-dataset-confirm">confirmed</a>.</p>
<div class="section" id="incremental-dataset-load">
<h4>Incremental dataset load<a class="headerlink" href="#incremental-dataset-load" title="Permalink to this headline">¶</a></h4>
<p>Loading <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> works similarly to <a class="reference external" href="#partitioned-dataset-load"><code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code></a> with several exceptions:</p>
<ol class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> loads the data <em>eagerly</em>, so the values in the returned dictionary represent the actual data stored in the corresponding partition, rather than a pointer to the load function. <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> considers a partition relevant for processing if its ID satisfies the comparison function, given the checkpoint value.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> <em>does not</em> raise a <code class="docutils literal notranslate"><span class="pre">DataSetError</span></code> if load finds no partitions to return - an empty dictionary is returned instead. An empty list of available partitions is part of a normal workflow for <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code>.</p></li>
</ol>
</div>
<div class="section" id="incremental-dataset-save">
<h4>Incremental dataset save<a class="headerlink" href="#incremental-dataset-save" title="Permalink to this headline">¶</a></h4>
<p><code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> save operation is identical to the <a class="reference external" href="#partitioned-dataset-save">save operation</a> of the <code class="docutils literal notranslate"><span class="pre">PartitionedDataSet</span></code>.</p>
</div>
<div class="section" id="incremental-dataset-confirm">
<h4>Incremental dataset confirm<a class="headerlink" href="#incremental-dataset-confirm" title="Permalink to this headline">¶</a></h4>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The checkpoint value <em>is not</em> automatically updated by the fact that a new set of partitions was successfully loaded or saved.</p>
</div>
<p>Partitioned dataset checkpoint update is triggered by an explicit <code class="docutils literal notranslate"><span class="pre">confirms</span></code> instruction in one of the nodes downstream. It can be the same node, which processes the partitioned dataset:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.pipeline</span> <span class="kn">import</span> <span class="n">node</span>

<span class="c1"># process and then confirm `IncrementalDataSet` within the same node</span>
<span class="n">node</span><span class="p">(</span>
    <span class="n">process_partitions</span><span class="p">,</span>
    <span class="n">inputs</span><span class="o">=</span><span class="s2">&quot;my_partitioned_dataset&quot;</span><span class="p">,</span>
    <span class="n">outputs</span><span class="o">=</span><span class="s2">&quot;my_processed_dataset&quot;</span><span class="p">,</span>
    <span class="n">confirms</span><span class="o">=</span><span class="s2">&quot;my_partitioned_dataset&quot;</span><span class="p">,</span>
<span class="p">)</span>
</pre></div>
</div>
<p>Alternatively, confirmation can be deferred to one of the nodes downstream, allowing you to implement extra validations before the loaded partitions are considered successfully processed:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">kedro.pipeline</span> <span class="kn">import</span> <span class="n">Pipeline</span><span class="p">,</span> <span class="n">node</span>

<span class="n">Pipeline</span><span class="p">(</span>
    <span class="p">[</span>
        <span class="n">node</span><span class="p">(</span>
            <span class="n">func</span><span class="o">=</span><span class="n">process_partitions</span><span class="p">,</span>
            <span class="n">inputs</span><span class="o">=</span><span class="s2">&quot;my_partitioned_dataset&quot;</span><span class="p">,</span>
            <span class="n">outputs</span><span class="o">=</span><span class="s2">&quot;my_processed_dataset&quot;</span><span class="p">,</span>
        <span class="p">),</span>
        <span class="c1"># do something else</span>
        <span class="n">node</span><span class="p">(</span>
            <span class="n">func</span><span class="o">=</span><span class="n">confirm_partitions</span><span class="p">,</span>
            <span class="c1"># note that the node may not require &#39;my_partitioned_dataset&#39; as an input</span>
            <span class="n">inputs</span><span class="o">=</span><span class="s2">&quot;my_processed_dataset&quot;</span><span class="p">,</span>
            <span class="n">outputs</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>
            <span class="n">confirms</span><span class="o">=</span><span class="s2">&quot;my_partitioned_dataset&quot;</span><span class="p">,</span>
        <span class="p">),</span>
        <span class="c1"># ...</span>
        <span class="n">node</span><span class="p">(</span>
            <span class="n">func</span><span class="o">=</span><span class="n">do_something_else_with_partitions</span><span class="p">,</span>
            <span class="c1"># will return the same partitions even though they were already confirmed</span>
            <span class="n">inputs</span><span class="o">=</span><span class="p">[</span><span class="s2">&quot;my_partitioned_dataset&quot;</span><span class="p">,</span> <span class="s2">&quot;my_processed_dataset&quot;</span><span class="p">],</span>
            <span class="n">outputs</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span>
        <span class="p">),</span>
    <span class="p">]</span>
<span class="p">)</span>
...
<p>Important notes about the confirmation operation:</p>
<ul class="simple">
<li><p>Confirming a partitioned dataset does not affect any subsequent loads within the same run. All downstream nodes that input the same partitioned dataset as input will all receive the <em>same</em> partitions. Partitions that are created externally during the run will also not affect the dataset loads and won’t appear in the list of loaded partitions until the next run or until the <a class="reference internal" href="../kedro.io.IncrementalDataSet.html"><span class="doc">release()</span></a> method is called on the dataset object.</p></li>
<li><p>A pipeline cannot contain more than one node confirming the same dataset.</p></li>
</ul>
</div>
<div class="section" id="checkpoint-configuration">
<h4>Checkpoint configuration<a class="headerlink" href="#checkpoint-configuration" title="Permalink to this headline">¶</a></h4>
<p><code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> does not require explicit configuration of the checkpoint unless there is a need to deviate from the defaults. To update the checkpoint configuration, add a <code class="docutils literal notranslate"><span class="pre">checkpoint</span></code> key containing the valid dataset configuration. This may be required if, say, the pipeline has read-only permissions to the location of partitions (or write operations are undesirable for any other reason), in such case <code class="docutils literal notranslate"><span class="pre">IncrementalDataSet</span></code> can be configured to save the checkpoint elsewhere. <code class="docutils literal notranslate"><span class="pre">checkpoint</span></code> key also supports partial config updates where only some checkpoint attributes are overwritten, while the defaults are kept for the rest:</p>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
...
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">checkpoint</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="c1"># update the filepath and load_args, but keep the dataset type unchanged</span><span class="w"></span>
<span class="w">    </span><span class="nt">filepath</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">gcs://other-bucket/CHECKPOINT</span><span class="w"></span>
<span class="w">    </span><span class="nt">load_args</span><span class="p">:</span><span class="w"></span>
<span class="w">      </span><span class="nt">k1</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">v1</span><span class="w"></span>
</pre></div>
</div>
</div>
<div class="section" id="special-checkpoint-config-keys">
<h4>Special checkpoint config keys<a class="headerlink" href="#special-checkpoint-config-keys" title="Permalink to this headline">¶</a></h4>
<p>Along with the standard dataset attributes, <code class="docutils literal notranslate"><span class="pre">checkpoint</span></code> config also accepts 2 special optional keys:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">comparison_func</span></code> (defaults to <code class="docutils literal notranslate"><span class="pre">operator.gt</span></code>) - fully qualified import path to the function that will be used to compare a partition ID with the checkpoint value, to determine if a partition should be processed. Such function must accept 2 positional string arguments - partition ID and checkpoint value, and return <code class="docutils literal notranslate"><span class="pre">True</span></code> if such partition is considered to be past the checkpoint. Specifying your own <code class="docutils literal notranslate"><span class="pre">comparison_func</span></code> may be useful if you need to customise the checkpoint filtration mechanism - for example, you may want to implement windowed loading, where you always want to load the partitions representing the last calendar month. See the example config specifying a custom comparison function:</p></li>
</ul>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">IncrementalDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">checkpoint</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">comparison_func</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">my_module.path.to.custom_comparison_function</span><span class="w">  </span><span class="c1"># the path must be importable</span><span class="w"></span>
</pre></div>
</div>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">force_checkpoint</span></code> - if set, partitioned dataset will use this value as the checkpoint instead of loading the corresponding checkpoint file. This might be useful if you need to rollback the processing steps and reprocess some (or all) of the available partitions. See the example config forcing the checkpoint value:</p></li>
</ul>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">IncrementalDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">checkpoint</span><span class="p">:</span><span class="w"></span>
<span class="w">    </span><span class="nt">force_checkpoint</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">2020-01-01/data.csv</span><span class="w"></span>
</pre></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Specification of <code class="docutils literal notranslate"><span class="pre">force_checkpoint</span></code> is also supported via the shorthand notation as follows:</p>
</div>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">IncrementalDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">checkpoint</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">2020-01-01/data.csv</span><span class="w"></span>
</pre></div>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you need to force the partitioned dataset to load all available partitions, set <code class="docutils literal notranslate"><span class="pre">checkpoint</span></code> to an empty string:</p>
</div>
<div class="highlight-yaml notranslate"><div class="highlight"><pre><span></span><span class="nt">my_partitioned_dataset</span><span class="p">:</span><span class="w"></span>
<span class="w">  </span><span class="nt">type</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">IncrementalDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">path</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">s3://my-bucket-name/path/to/folder</span><span class="w"></span>
<span class="w">  </span><span class="nt">dataset</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">pandas.CSVDataSet</span><span class="w"></span>
<span class="w">  </span><span class="nt">checkpoint</span><span class="p">:</span><span class="w"> </span><span class="s">&quot;&quot;</span><span class="w"></span>
</pre></div>
</div>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="../06_nodes_and_pipelines/01_nodes.html" class="btn btn-neutral float-right" title="Nodes" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="01_data_catalog.html" class="btn btn-neutral" title="The Data Catalog" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left"></span> Previous</a>
